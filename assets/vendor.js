...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.25.16 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */
...
let{top:n,left:i}=Bt(e)
const o=Ar(e.ownerDocument)
return n=z(n,o.top-t-o.height,o.bottom+o.height),i=z(i,o.left-r-o.width,o.right+o.width),{height:t,width:r,top:n,left:i,transform:"",...ot(e,["marginTop","marginLeft"])}}var In={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t=this.$el){const r=this.animation
...
return S(a)?s in r&&o===r[s]||!o&&s&&!(s in r)&&!r[""]:n===a&&i===l}function Kn(e){return Nt("a,button",e)||e}var Xn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():ni(this.$el)&&(this.$el.loading="lazy",Jn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:fn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...Ne(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
...
qi.util=Jr,qi.options={},qi.version="3.25.16"
...
r.ariaControls=i,r.ariaLabel=r.ariaLabel||n}},slides(e){e.forEach((e,t)=>ne(e,{role:this.nav.length?"tabpanel":"group","aria-label":this.t("slideLabel",t+1,this.length),"aria-roledescription":this.nav.length?null:"slide"})),this.padNavitems()}},connected(){this.$el.role=this.role,this.$el.ariaRoleDescription="carousel"},update:[{write(){this.navItems.concat(this.nav).forEach(e=>e&&(e.hidden=!this.maxIndex)),this.updateNav()},events:["resize"]}],events:[{name:"click keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){!e.target.closest("a,button")||"click"!==e.type&&e.keyCode!==Bn||(Dn(e),this.show(se(e.current,this.attrItem)))}},{name:"itemshow",handler(){this.updateNav()}},{name:"keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){const{current:t,keyCode:r}=e
...
if(this.mime&&!ls(this.mime,n.type))return void this.fail(this.t("invalidMime",this.mime))}this.multiple||(e=e.slice(0,1)),this.beforeAll(this,e)
...
await r(t.shift())}}}
function ls(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function us(e){e.preventDefault(),e.stopPropagation()}var cs=Object.freeze({__proto__:null,Countdown:rn,Filter:Yn,Lightbox:fo,LightboxPanel:lo,Notification:vo,Parallax:Bo,Slider:Zo,SliderParallax:Ko,Slideshow:es,SlideshowParallax:Ko,Sortable:ts,Tooltip:ss,Upload:as})
function ds(e){Ze(document,"uikit:init",e),document.body&&jt(document.body,ps),new MutationObserver(hs).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function hs(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)jt(t,ps)
for(const t of n)jt(t,fs)
const e=o&&ms(o)
e&&(ie(i,o)?Gi(e,i):null==(t=Zi(i,e))||t.$destroy())}}function ps(e){const t=Qi(e)
for(const r in t)Bi(t[r])
for(const r of e.getAttributeNames()){const t=ms(r)
t&&Gi(t,e)}}function fs(e){const t=Qi(e)
for(const r in t)Hi(t[r])}function ms(e){l(e,"data-")&&(e=e.slice(5))
const t=Wi[e]
...
r&&Hi(t),Fi(t,"destroy"),function(e,t){var r
null==(r=e[Vi])||delete r[t.$options.name],T(e[Vi])&&delete e[Vi]}(r,t),e&&Ot(t.$el)},e.prototype.$create=Gi,e.prototype.$emit=function(e){hn(this,e)},e.prototype.$update=function(e=this.$el,t){Ki(e,t)},e.prototype.$reset=function(){Hi(this),Bi(this)},e.prototype.$getComponent=Zi,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(qi)
var gs={mixins:[en,ai],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:".uk-accordion-title",content:".uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>It(e,t),toggles({toggle:e}){return this.items.map(t=>Nt(e,t))},contents({content:e}){return this.items.map(t=>{var r
...
vs(t,!e)}this.$emit()}},observe:gn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,handler(e){if("keydown"===e.type&&e.keyCode!==Bn)return
...
await ht.cancel(a),vs(r,!1)
const u=F(["marginTop","marginBottom"],e=>ot(r,e))+$t(r).height,c=l/u
n=u?(i*u+n)*(t?1-c:c):0,ot(a,"height",l),await ht.start(a,{height:t?u:0},n,o),Pt(r),delete e._wrapper,t||vs(r,!0)}(e,r,this)
vs(Nt(this.content,e),!r)})))}}}
function vs(e,t){e&&(e.hidden=t)}var bs={mixins:[en,ai],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,ys),this.$destroy(!0)}}}
function ys(e,t,{duration:r,transition:n,velocity:i}){const o=R(ot(e,"height"))
return ot(e,"height",o),ht.start(e,{height:0,marginTop:0,marginBottom:0,paddingTop:0,paddingBottom:0,borderTop:0,borderBottom:0,opacity:0},i*o+r,n)}var ws={args:"autoplay",props:{automute:Boolean,autoplay:Boolean,restart:Boolean,hoverTarget:Boolean},data:{automute:!1,autoplay:!0,restart:!1,hoverTarget:!1},beforeConnect(){const e=bt(this.$el,"video")
...
!rt(e)||((t=this.$el).paused||t.ended)?mr(this.$el):_s(this.$el,this.restart)}},{name:`${me} focusout`,el:({hoverTarget:e,$el:t})=>je(e,t)||t,filter:({autoplay:e})=>"hover"===e,handler(e){rt(e)||_s(this.$el,this.restart)}}],observe:[fn({filter:({$el:e})=>"none"===e.preload,handler([{target:e}]){e.preload="",this.$reset()}}),fn({filter:({$el:e,autoplay:t})=>"hover"!==t&&"none"!==e.preload,handler([{isIntersecting:e,target:t}]){document.fullscreenElement||(e?this.autoplay&&mr(t):_s(t,this.restart))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:ke(e).closest(":not(a)")})})]}
function _s(e,t){gr(e),t&&bt(e,"video")&&(e.currentTime=0)}var xs={mixins:[ws],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=bt(this.$el,"img","video")},observe:pn({target:({$el:e})=>Es(e)||ke(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
const{$el:e,width:t=e.clientWidth,height:r=e.clientHeight}=this,n=Es(e)||ke(e),i=G.cover({width:t,height:r},{width:n.offsetWidth,height:n.offsetHeight})
return!(!i.width||!i.height)&&i},write({height:e,width:t}){ot(this.$el,{height:e,width:t})},events:["resize"]}}
function Es(e){for(;e=ke(e);)if("static"!==ot(e,"position"))return e}let Cs
var ks={mixins:[en,si,is,ai],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryX:Boolean,boundaryY:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,stretch:Boolean,delayShow:Number,delayHide:Number,autoUpdate:Boolean,animateOut:Boolean,bgScroll:Boolean,closeOnScroll:Boolean},data:{mode:["click","hover"],toggle:"- *",boundary:!1,boundaryX:!1,boundaryY:!1,target:!1,targetX:!1,targetY:!1,stretch:!1,delayShow:0,delayHide:800,autoUpdate:!0,animateOut:!1,bgScroll:!0,animation:["uk-animation-fade"],cls:"uk-open",container:!1,closeOnScroll:!1,selClose:".uk-drop-close"},computed:{boundary:({boundary:e,boundaryX:t,boundaryY:r},n)=>[je(t||e,n)||window,je(r||e,n)||window],target({target:e,targetX:t,targetY:r},n){return t||(t=e||this.targetEl),r||(r=e||this.targetEl),[!0===t?window:je(t,n),!0===r?window:je(r,n)]}},created(){this.tracker=new lr},connected(){K(this.$el,"uk-drop"),this.toggle&&!this.targetEl&&(this.targetEl=function(e){const t=je(e.toggle,e.$el)
t&&(e.$create("toggle",t,{target:e.$el,mode:e.mode}),t.ariaHasPopup=!0)
return t}(this)),ne(this.targetEl,"aria-expanded",!1),this._style=H(this.$el.style,["width","height"])},disconnected(){this.isActive()&&(this.hide(!1),Cs=null),ot(this.$el,this._style)},events:[{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.hide(!1)}},{name:"click",delegate:()=>'a[href*="#"]',handler({defaultPrevented:e,current:t}){const{hash:r}=t
!e&&r&&Re(t)&&!this.$el.contains(Nt(r))&&this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),Te(this.$el,":focus,:hover")||this.hide()}},{name:`${fe} focusin`,filter:({mode:e})=>c(e,"hover"),handler(e){rt(e)||this.clearTimers()}},{name:`${me} focusout`,filter:({mode:e})=>c(e,"hover"),handler(e){!rt(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){Cs=this,this.tracker.init(),ne(this.targetEl,"aria-expanded",!0)
const e=[Os(this),Ss(this),Ms(this),this.autoUpdate&&Ts(this),this.closeOnScroll&&Ps(this)]
Qe(this.$el,"hide",()=>e.forEach(e=>e&&e()),{self:!0}),this.bgScroll||Qe(this.$el,"hidden",oi(this.$el),{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler({target:e}){this.$el===e?(Cs=this.isActive()?null:Cs,this.tracker.cancel(),ne(this.targetEl,"aria-expanded",!1)):Cs=null===Cs&&this.$el.contains(e)&&this.isToggled()?this:Cs}}],update:{write(){this.isToggled()&&!ee(this.$el,this.clsEnter)&&this.position()}},methods:{show(e=this.targetEl,t=!0){if(this.isToggled()&&e&&this.targetEl&&e!==this.targetEl&&this.hide(!1,!1),this.targetEl=e,this.clearTimers(),!this.isActive()){if(Cs){if(t&&Cs.isDelaying())return void(this.showTimer=setTimeout(()=>Te(e,":hover")&&this.show(),10))
let r
for(;Cs&&r!==Cs&&!Cs.$el.contains(this.$el);)r=Cs,Cs.hide(!1,!1)
...
function Os(e){const t=()=>e.$emit(),r=[hr(t),dr(Rr(e.$el).concat(e.target),t)]
return()=>r.map(e=>e.disconnect())}function Ts(e,t=()=>e.$emit()){return Ye([document,...Rr(e.$el)],"scroll",t,{passive:!0})}function Ss(e){return Ye(document,"keydown",t=>{t.keyCode===Fn&&e.hide(!1)})}function Ps(e){return Ts(e,()=>e.hide(!1))}function Ms(e){return Ye(document,de,({target:t})=>{e.$el.contains(t)||Qe(document,`${pe} ${ge} scroll`,({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==pe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)},!0)})}var Rs={mixins:[en,si],props:{align:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:le?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,flip:!0,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>je(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||je(e,this.$el)||Nt(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=Nt("<div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=It(`.${e}`,t)
...
return null==(t=Nt(Ee,e.target))?void 0:t.focus()}))}As(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
...
const t=It(Ee,r)
return void t[Q(s,t,d(t,e=>Te(e,":focus")))].focus()}As(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
return c(this.dropdowns,null==(e=Cs)?void 0:e.$el)&&Cs},async transitionTo(e,t){const{dropbar:r}=this,n=zt(r)
...
let l=-1
a===zn?l=0:a===Hn?l="last":a===Un?l="previous":a===Vn?l="next":a===Ln&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Q(l,t,t.indexOf(r.targetEl||s))].focus())}var js={mixins:[en],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>Nt(_e,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&ke(this.input)===t&&this.input.nextElementSibling||Nt(e,t))}},update(){var e
...
if(n=Math.max(0,Yt(n)),!(r||n||i)||Is(t)||t[0].some((e,r)=>t.some(t=>t[r]&&t[r].offsetWidth!==e.offsetWidth)))return e.translates=e.scrollColumns=!1
...
Ds(n,d,e[a]),Ds(i,d,[(d-a)*u*(le?-1:1),o[d]-s]),o[d]+=c+t,l=Math.max(l,c)}s+=l+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
...
function Is(e){return e.flat().some(e=>"absolute"===ot(e,"position"))}function Ds(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var Ls={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>It(e,t)},observe:pn({target:({$el:e,elements:t})=>t.reduce((e,t)=>e.concat(t,...t.children),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?xn(this.elements):[this.elements]).map($s)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach((e,r)=>ot(e,"minHeight",t[r]))},events:["resize"]}}
function $s(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Fs)
const r=Math.max(...t)
return{heights:e.map((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r),elements:e}}function Fs(e){const t=H(e.style,["display","minHeight"])
we(e)||ot(e,"display","block","important"),ot(e,"minHeight","")
const r=$t(e).height-Vt(e,"height","content-box")
return ot(e,t),r}var Bs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>je(e,t),observe:({target:e})=>e}},observe:pn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){ot(this.$el,"minHeight",e)},events:["resize"]}},Hs={mixins:[bo],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[vn({filter:({expand:e})=>e}),pn({target:({$el:e})=>Pr(e)})],update:{read(){if(!we(this.$el))return!1
...
return 1!==this.ratio&&ot(Nt("circle",e),"strokeWidth",1/this.ratio),e}}},ta={extends:Ks,mixins:[Ei],beforeConnect(){const e=this.$el.closest("a,button")
ne(e,"role",null!==this.role&&bt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!ie(e,"aria-label")&&ne(e,"aria-label",t)}},ra={extends:ta,beforeConnect(){K(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=ee(this.$el,"uk-slidenav-large")?`${e}-large`:e}},na={extends:ta,i18n:{label:"Open menu"},beforeConnect(){const e=this.$el.closest("a,button")
e&&(e.ariaExpanded=!1)}},ia={extends:ta,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(ee(this.$el,"uk-close-large")?"large":"icon")}},oa={extends:ta,i18n:{label:"Open"}},sa={extends:ta,i18n:{label:"Back to top"}},aa={extends:ta,i18n:{label:"Next page"},data:{role:null}},la={extends:ta,i18n:{label:"Previous page"},data:{role:null}},ua={}
const ca={twitter:"x"}
...
for(const e of j(this.target)){let t=!this.selActive||Te(e,this.selActive)?ha(e):""
!1!==t&&J(e,"uk-light uk-dark",t)}}}}
function ha(e){const t=$t(e),r=$t(window)
if(!q(t,r))return!1
...
for(const r of t){if(e.contains(r)||!pa(r)||r.closest('[class*="-leave"]')&&t.some(e=>r!==e&&Te(e,'[class*="-enter"]')))continue
const n=ot(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function pa(e){if("visible"!==ot(e,"visibility"))return!1
for(;e;){if("0"===ot(e,"opacity"))return!1
e=ke(e)}return!0}var fa={mixins:[en,bo],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||ot(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=St(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){Pt(this.wrapper.childNodes)},observe:pn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){te(this.wrapper,this.clsHide,r),ne(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},ma={install:function({modal:e}){function t(t,r,n=U,i=U){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
...
var ga={extends:gs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const va="uk-navbar-transparent"
var ba={extends:Rs,props:{dropbarTransparentMode:Boolean},data:{flip:!1,autoUpdate:!1,delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=ee(this.$el,"uk-navbar-justify"),t=It(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){ot(r,"flexGrow",e?It(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&ee(this.navbarContainer,va)&&(X(this.navbarContainer,va),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await kn(),!this._transparent||Cs&&this.dropContainer.contains(Cs.$el)||(K(this.navbarContainer,va),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
...
return t+("behind"===this.dropbarTransparentMode?0:r+e)}}},ya={mixins:[hi],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean,swiping:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1,swiping:!0},computed:{clsFlip:({flip:e,clsFlip:t})=>e?t:"",clsOverlay:({overlay:e,clsOverlay:t})=>e?t:"",clsMode:({mode:e,clsMode:t})=>`${t}-${e}`,clsSidebarAnimation:({mode:e,clsSidebarAnimation:t})=>"none"===e||"reveal"===e?"":t,clsContainerAnimation:({mode:e,clsContainerAnimation:t})=>"push"!==e&&"reveal"!==e?"":t,transitionElement({mode:e}){return"reveal"===e?ke(this.panel):this.panel}},observe:yn({filter:({swiping:e})=>e}),update:{read(){this.isToggled()&&!we(this.$el)&&this.hide()},events:["resize"]},events:[{name:"touchmove",self:!0,passive:!1,filter:({overlay:e})=>e,handler(e){e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||ee(ke(this.panel),this.clsMode)||K(Tt(this.panel,"<div>"),this.clsMode)
const{body:e,scrollingElement:t}=document
K(e,this.clsContainer,this.clsFlip),ot(e,"touchAction","pan-y pinch-zoom"),ot(this.$el,"display","block"),ot(this.panel,"maxWidth",t.clientWidth),K(this.$el,this.clsOverlay),K(this.panel,this.clsSidebarAnimation,"reveal"===this.mode?"":this.clsMode),zt(e),K(e,this.clsContainerAnimation),this.clsContainerAnimation&&(wa().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){X(document.body,this.clsContainerAnimation),ot(document.body,"touchAction","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=wa()
...
function wa(){return Nt('meta[name="viewport"]',document.head)||xt(document.head,'<meta name="viewport">')}var _a={mixins:[en],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:pn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&we(this.$el))&&{max:Math.max(this.minHeight,zt(this.container)-($t(this.content).height-zt(this.$el)))}},write({max:e}){ot(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},xa={data:{threshold:5,fadeDuration:.05},events:[{name:"scroll",self:!0,passive:!0,handler(){this.$emit()}},{name:de,handler:function(e){const{target:t,button:r,defaultPrevented:n}=e
...
var Ea={props:["width","height"],connected(){K(this.$el,"uk-responsive-width"),ot(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},Ca={props:{offset:Number},data:{offset:0},connected(){(function(e){ka.size||Ye(document,"click",Oa)
ka.add(e)})(this)},disconnected(){var e
e=this,ka.delete(e),ka.size||Ge(document,"click",Oa)},methods:{async scrollTo(e){e=e&&Nt(e)||document.body,Ze(this.$el,"beforescroll",[this,e])&&(await Tr(e,{offset:this.offset}),Ze(this.$el,"scrolled",[this,e]))}}}
const ka=new Set
function Oa(e){if(!e.defaultPrevented)for(const t of ka)t.$el.contains(e.target)&&Re(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(Ae(t.$el)))}const Ta="uk-scrollspy-inview"
var Sa={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?It(e,t):[t]},watch:{elements(e){this.hidden&&ot(Oe(e,`:not(.${Ta})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())X(e,Ta,t.cls||"")
...
r&&Ze(this.$el,"active",[e,t[e]])},events:["scroll","resize"]}]},Ma={mixins:[en,bo],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&Nt(e,t)||t},connected(){this.start=Aa(this.start||this.top),this.end=Aa(this.end||this.bottom),this.placeholder=Nt("+ .uk-sticky-placeholder",this.$el)||Nt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),X(this.target,this.clsInactive)),ja(this.$el),Ot(this.placeholder),this.placeholder=null},observe:[vn(),bn({target:()=>document.scrollingElement}),pn({target:({$el:e})=>[e,Da(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some(({target:e})=>e===Da(this.$el))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,async handler(){const{scrollingElement:e}=document
...
a&&(Ia(this.target),this.hide()),this.active||(({height:e,width:t}=$t(this.$el)),r=ot(this.$el,"margin")),a&&this.show()
...
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=Ft(c).top-new DOMMatrix(ot(c,"transform")).m42,g=$t(this.$el).height,v=(!1===this.start?m:Ra(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,Ra(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,Ra(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==ot(Da(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:Ht(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&ja(this.$el),this.inactive)return
...
vt.out(this.$el,this.animation).then(()=>this.hide(),U)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),vt.in(this.$el,this.animation).catch(U)):(Ia(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),X(this.$el,this.clsFixed,this.clsBelow),t?ot(this.$el,"top",e):ja(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
...
this.active=e,e?(J(this.target,this.clsInactive,this.clsActive),t!==e&&Ze(this.$el,"active")):(J(this.target,this.clsActive,this.clsInactive),t!==e&&(Ia(this.target),Ze(this.$el,"inactive")))}}}
function Ra(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Yt(e,"height",t,!0)
{const r=!0===e?Da(t):je(e,t)
return Ft(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(ot(r,"paddingBottom"))+R(ot(r,"borderBottomWidth")):0)}}function Aa(e){return"true"===e||"false"!==e&&e}function ja(e){ot(e,{position:"",top:"",marginTop:"",width:""})}const Na="uk-transition-disable"
async function Ia(e){ee(e,Na)||(K(e,Na),await Cn(),X(e,Na))}function Da(e){for(;e=ke(e);)if(we(e))return e}var La={mixins:[Us],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[mn({async handler(){const e=await this.svg
e&&$a.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&($a.call(this,e),this.strokeAnimation&&function(e){const t=yo(e)
t&&ot(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return bt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise(e=>Qe(this.$el,"load",e)),Ws(await Fa(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function $a(e){const{$el:t}=this
...
await this.toggleElement(t,!1,n)&&await this.toggleElement(e[r],!0,n)})}}},za={mixins:[en],extends:Ha,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=ee(this.$el,"uk-tab-left")?"uk-tab-left":!!ee(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}},Ua={mixins:[bo,ai],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ne(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(Ce(this.$el)||(this.$el.tabIndex=0),!this.cls&&bt(this.$el,"a")&&(this.$el.role="button"))},observe:gn({targets:({target:e})=>e}),events:[{name:de,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!rt(e)||E(this._showState)||this.$el.disabled||(Ze(this.$el,"focus"),Qe(document,de,()=>Ze(this.$el,"blur"),!0,e=>!this.$el.contains(e.target)),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`${fe} ${me} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(rt(e)||this.$el.disabled||"loading"===document.readyState)return
...
return $(Object.freeze({__proto__:null,Accordion:gs,AccordionIcon:Ks,Alert:bs,Close:ia,Cover:xs,Drop:ks,DropParentIcon:Ks,Dropdown:ks,Dropnav:Rs,FormCustom:js,Grid:Ns,HeightMatch:Ls,HeightPlaceholder:Bs,HeightViewport:Hs,Icon:Zs,Img:Xn,Inverse:da,Leader:fa,Margin:_n,Marker:oa,Modal:ma,Nav:ga,NavParentIcon:Xs,Navbar:ba,NavbarParentIcon:Ks,NavbarToggleIcon:na,Offcanvas:ya,OverflowAuto:_a,OverflowFade:xa,OverlayIcon:Ks,PaginationNext:aa,PaginationPrevious:la,Responsive:Ea,Scroll:Ca,Scrollspy:Sa,ScrollspyNav:Pa,SearchIcon:Js,SlidenavNext:ra,SlidenavPrevious:ra,Spinner:ea,Sticky:Ma,Svg:La,Switcher:Ha,Tab:za,Toggle:Ua,Totop:sa,Video:ws}),(e,t)=>qi.component(t,e)),function(e){ae&&window.MutationObserver&&(document.body?requestAnimationFrame(()=>ds(e)):new MutationObserver((t,r)=>{document.body&&(ds(e),r.disconnect())}).observe(document.documentElement,{childList:!0}))}(qi),$(cs,(e,t)=>qi.component(t,e)),qi}),/*! UIkit 3.25.16 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */
