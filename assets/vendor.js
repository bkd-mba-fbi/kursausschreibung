...
Ze(this.$el,"hidden",(()=>e.forEach((e=>e&&e()))),{self:!0}),X(document.documentElement,this.clsPage),vi(this.target,!0)}},{name:"shown",self:!0,handler(){ke(this.$el)||(this.$el.tabIndex=-1),Se(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(di,this)&&di.splice(di.indexOf(this),1),st(this.$el,"zIndex","")
const{target:e}=this
di.some((e=>e.clsPage===this.clsPage))||(J(document.documentElement,this.clsPage),queueMicrotask((()=>ke(e)&&e.focus()))),vi(e,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&Oe(this.$el)!==this.container?(Et(this.container,this.$el),new Promise((e=>requestAnimationFrame((()=>this.show().then(e)))))):this.toggleElement(this.$el,!0,pi)},hide(){return this.toggleElement(this.$el,!1,pi)}}}
...
Wi.util=Jr,Wi.options={},Wi.version="3.23.10"
