...
return a.CONSTANT_TAG},e.tagForProperty=D,e.tracked=bt,e.trySet=function(e,t,r){return Oe(e,t,r,!0)}
var y=":change"
...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter((function(){return 0===c})),t.default=function(){return c++,t.fetch.apply(e,arguments).then((function(e){return e.clone().blob().then(d,d),e}),(function(e){throw d(e),e}))}):t.default=t.fetch,s.forEach((function(e){delete t[e]}))}))})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.23.9 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
...
const e=It("a,button",r=n)||r
yt(e,"a")&&(e.role="button")}var r},children(e,t){t&&this.updateState()}},events:{name:"click keydown",delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){"keydown"===e.type&&e.keyCode!==Fn||e.target.closest("a,button")&&(Dn(e),this.apply(e.current))}},methods:{apply(e){const t=this.getState(),r=Gn(e,this.attrItem,this.getState())
var n,i
...
return S(a)?s in r&&o===r[s]||!o&&s&&!(s in r)&&!r[""]:n===a&&i===l}var Zn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():ti(this.$el)&&(this.$el.loading="lazy",Kn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:fn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...Ie(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
const e=ti(this.$el)?this.$el:function(e,t,r){const n=new Image
return ei(n,r),Jn(e,n),n.onload=()=>Kn(e,n.currentSrc),n.src=t,n}(this.$el,this.dataSrc,this.sources)
return se(e,"loading"),Kn(this.$el,e.currentSrc),this.img=e}}}
function Kn(e,t){if(ti(e)){const t=Oe(e);(yt(t,"picture")?Me(t):[e]).forEach((e=>Jn(e,e)))}else if(t){!c(e.style.backgroundImage,t)&&(st(e,"backgroundImage",`url(${Ye(t)})`),Ke(e,Xe("load",!1)))}}const Xn=["data-src","data-srcset","sizes"]
function Jn(e,t){for(const r of Xn){const n=ae(e,r)
n&&ie(t,r.replace(/data-/g,""),n)}}function ei(e,t){if((t=function(e){if(!e)return[]
...
ie(t,e),Et(r,t)}Et(r,e)}}function ti(e){return yt(e,"img")}let ri
function ni(e){const t=Ge(e,"touchstart",(t=>{if(1!==t.targetTouches.length||Se(t.target,'input[type="range"'))return
let r=it(t).y
...
return st(r,n),()=>{ri=!1,t(),at(r,n)}}var ii={props:{container:Boolean},data:{container:!0},computed:{container({container:e}){return!0===e&&this.$container||e&&It(e)}}},oi={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
...
n.reverse(),i.reverse()}const s=si(e),a=Ft(e)
...
function si(e){const t=Mr(e),{scrollTop:r}=t
return()=>{r!==t.scrollTop&&(t.scrollTop=r)}}var ai={props:{cls:Boolean,animation:"list",duration:Number,velocity:Number,origin:String,transition:String},data:{cls:!1,animation:[!1],duration:200,velocity:.2,origin:!1,transition:"ease",clsEnter:"uk-togglable-enter",clsLeave:"uk-togglable-leave"},computed:{hasAnimation:({animation:e})=>!!e[0],hasTransition:({animation:e})=>["slide","reveal"].some((t=>l(e[0],t)))},methods:{async toggleElement(e,t,r){try{return await Promise.all(j(e).map((e=>{const n=E(t)?t:!this.isToggled(e)
if(!Ke(e,"before"+(n?"show":"hide"),[this]))return Promise.reject()
const i=(m(r)?r:!1!==r&&this.hasAnimation?this.hasTransition?ui:ci:li)(e,n,this),o=n?this.clsEnter:this.clsLeave
X(e,o),Ke(e,n?"show":"hide",[this])
const s=()=>{var t
if(J(e,o),Ke(e,n?"shown":"hidden",[this]),n){const r=si(e)
...
function li(e,t,{_toggle:r}){return bt.cancel(e),pt.cancel(e),r(e,t)}async function ui(e,t,{animation:r,duration:n,velocity:i,transition:o,_toggle:s}){var a
...
try{await pt.start(e,O,n,o)}finally{st(e,y),Mt(C.firstChild),t||s(e,!1)}}function ci(e,t,r){const{animation:n,duration:i,_toggle:o}=r
return t?(o(e,!0),bt.in(e,n[0],i,r.origin)):bt.out(e,n[1]||n[0],i,r.origin).then((()=>o(e,!1)))}const di=[]
var hi={mixins:[en,ii,ai],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>It(e,t),transitionElement(){return this.panel}},connected(){const e=this.panel||this.$el
...
!r&&n&&Ae(t)&&!this.$el.contains(It(n))?this.hide():Se(t,this.selClose)&&(Dn(e),this.hide())}},{name:"toggle",self:!0,handler(e,t){e.defaultPrevented||(e.preventDefault(),this.target=null==t?void 0:t.$el,this.isToggled()===c(di,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(di,this))return!1
!this.stack&&di.length?(Promise.all(di.map((e=>e.hide()))).then(this.show),e.preventDefault()):di.push(this)}},{name:"show",self:!0,handler(){this.stack&&st(this.$el,"zIndex",R(st(this.$el,"zIndex"))+di.length)
const e=[this.overlay&&fi(this),this.overlay&&ni(this.$el),this.bgClose&&mi(this),this.escClose&&gi(this)]
Ze(this.$el,"hidden",(()=>e.forEach((e=>e&&e()))),{self:!0}),X(document.documentElement,this.clsPage),vi(this.target,!0)}},{name:"shown",self:!0,handler(){ke(this.$el)||(this.$el.tabIndex=-1),Se(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(di,this)&&di.splice(di.indexOf(this),1),st(this.$el,"zIndex",""),di.some((e=>e.clsPage===this.clsPage))||J(document.documentElement,this.clsPage),ke(this.target)&&this.target.focus(),vi(this.target,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},show(){return this.container&&Oe(this.$el)!==this.container?(Et(this.container,this.$el),new Promise((e=>requestAnimationFrame((()=>this.show().then(e)))))):this.toggleElement(this.$el,!0,pi)},hide(){return this.toggleElement(this.$el,!1,pi)}}}
function pi(e,t,{transitionElement:r,_toggle:n}){return new Promise(((i,o)=>Ze(e,"show hide",(()=>{var s
...
var c})))).then((()=>delete e._reject))}function fi(e){return Ge(document,"focusin",(t=>{L(di)!==e||e.$el.contains(t.target)||e.$el.focus()}))}function mi(e){return Ge(document,he,(({target:t})=>{L(di)!==e||e.overlay&&!e.$el.contains(t)||!e.panel||e.panel.contains(t)||Ze(document,`${fe} ${ve} scroll`,(({defaultPrevented:r,type:n,target:i})=>{r||n!==fe||t!==i||e.hide()}),!0)}))}function gi(e){return Ge(document,"keydown",(t=>{27===t.keyCode&&L(di)===e&&e.hide()}))}function vi(e,t){(null==e?void 0:e.ariaExpanded)&&(e.ariaExpanded=t)}var bi={slide:{show:e=>[{transform:wi(-100*e)},{transform:wi()}],percent:e=>yi(e),translate:(e,t)=>[{transform:wi(-100*t*e)},{transform:wi(100*t*(1-e))}]}}
function yi(e){return Math.abs(new DOMMatrix(st(e,"transform")).m41/e.offsetWidth)}function wi(e=0,t="%"){return e?`translate3d(${e+t}, 0, 0)`:""}function _i(e,t,r){Ke(e,Xe(t,!1,!1,r))}function xi(){let e
return{promise:new Promise((t=>e=t)),resolve:e}}var Ei={props:{i18n:Object},data:{i18n:null},methods:{t(e,...t){var r,n,i
let o=0
return(null==(i=(null==(r=this.i18n)?void 0:r[e])||(null==(n=this.$options.i18n)?void 0:n[e]))?void 0:i.replace(/%s/g,(()=>t[o++]||"")))||""}}},Ci={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){ie(this.list,"aria-live",this.autoplay?"off":"polite"),this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){ie(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter:({autoplay:e})=>e,handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval((()=>{this.stack.length||this.draggable&&Se(this.$el,":focus-within")&&!Se(this.$el,":focus")||this.pauseOnHover&&Se(this.$el,":hover")||this.show("next")}),this.autoplayInterval)},stopAutoplay(){clearInterval(this.interval)}}}
const ki={passive:!1,capture:!0},Oi={passive:!0,capture:!0},Ti="touchmove mousemove",Si="touchend touchcancel mouseup click input scroll"
var Pi={props:{draggable:Boolean},data:{draggable:!0,threshold:10},created(){for(const e of["start","move","end"]){const t=this[e]
...
!this.draggable||this.parallax||!nt(e)&&(t=e.target,"none"!==st(t,"userSelect")&&p(t.childNodes).some((e=>3===e.nodeType&&e.textContent.trim())))||e.target.closest(xe)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Ti,el:({list:e})=>e,handler:q,...ki}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ge(document,Ti,this.move,ki),Ge(document,Si,this.end,Oi),st(this.list,"userSelect","none")},move(e){const t=this.pos-this.drag
...
let{slides:r,prevIndex:n}=this,i=Math.abs(t),o=this.getIndex(n+this.dir),s=Mi.call(this,n,o)
for(;o!==n&&i>s;)this.drag-=s*this.dir,n=o,i-=s,o=this.getIndex(n+this.dir),s=Mi.call(this,n,o)
this.percent=i/s
const a=r[n],l=r[o],u=this.index!==o,d=n===o
let h
for(const p of[this.index,this.prevIndex])c([o,n],p)||(Ke(r[p],"itemhidden",[this]),d&&(h=!0,this.prevIndex=n));(this.index===n&&this.prevIndex!==n||h)&&Ke(r[this.index],"itemshown",[this]),u&&(this.prevIndex=n,this.index=o,d||(Ke(a,"beforeitemhide",[this]),Ke(a,"itemhide",[this])),Ke(l,"beforeitemshow",[this]),Ke(l,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!d&&l)},end(){if(Qe(document,Ti,this.move,ki),Qe(document,Si,this.end,Oi),this.dragging)if(setTimeout(Ge(this.list,"click",(e=>e.preventDefault()),ki)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
...
function Mi(e,t){return this._getTransitioner(e,e!==t&&t).getDistance()||this.slides[e].offsetWidth}function Ri(e,t,r){e._watches.push({name:r,...v(t)?t:{handler:t}})}const Ai={subtree:!0,childList:!0}
function ji(e,t,n){e._hasComputed=!0,Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:o,$el:s}=e
if(!r(i,t)&&(i[t]=(n.get||n).call(e,o,s),n.observe&&e._computedObserver)){const t=n.observe.call(e,o)
e._computedObserver.observe(["~","+","-"].includes(t[0])?s.parentElement:s.getRootNode(),Ai)}return i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Ni(e){e._hasComputed&&(function(e,t){e._updates.unshift(t)}(e,{read:()=>function(e,t){for(const{name:n,handler:i,immediate:o=!0}of e._watches)(e._initial&&o||r(t,n)&&!I(t[n],e[n]))&&i.call(e,e[n],t[n])
e._initial=!1}(e,Ii(e)),events:["resize","computed"]}),e._computedObserver=fr(e.$el,(()=>hn(e,"computed")),Ai),e._disconnect.push((()=>{e._computedObserver.disconnect(),e._computedObserver=null,Ii(e)})))}function Ii(e){const t={...e._computed}
return e._computed={},t}function Di(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ge(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function Li(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
if(a&&!a.call(e,e))return
const u=`_observe${e._disconnect.length}`
m(i)&&!r(e,u)&&ji(e,u,(()=>{const t=i.call(e,e)
return h(t)?j(t):t})),o=C(o)?e[o]:o.bind(e),m(s)&&(s=s.call(e,e))
const c=n(r(e,u)?e[u]:i,o,s,l)
m(i)&&h(e[u])&&Ri(e,{handler:$i(c,s),immediate:!1},u),e._disconnect.push((()=>c.disconnect()))}function $i(e,t){return(r,n)=>{for(const t of n)c(r,t)||(e.unobserve?e.unobserve(t):e.observe&&e.disconnect())
for(const i of r)c(n,i)&&e.unobserve||e.observe(i,t)}}function Fi(e){const t={},{args:r=[],props:n={},el:o,id:a}=e
if(!n)return t
...
S(n[e])||(t[e]=cn(n[e],u[i]))}return t}const Bi=K(((e,t)=>{const r=Object.keys(t),n=r.concat(e).map((e=>[i(e),`data-${i(e)}`])).flat()
return{attributes:r,filter:n}}))
function Hi(e,t){var r
null==(r=e.$options[t])||r.forEach((t=>t.call(e)))}function zi(e){e._connected||(function(e){const{$options:t,$props:n}=e,i=Fi(t)
f(n,i)
const{computed:o,methods:s}=t
for(let a in n)!(a in i)||o&&r(o,a)||s&&r(s,a)||(e[a]=n[a])}(e),Hi(e,"beforeConnect"),e._connected=!0,e._disconnect=[],function(e){for(const t of e.$options.events||[])if(r(t,"handler"))Di(e,t)
else for(const r in t)Di(e,{name:r,handler:t[r]})}(e),function(e){e._data={},e._updates=[...e.$options.update||[]],e._disconnect.push((()=>e._updates=e._data=null))}(e),function(e){e._watches=[]
for(const t of e.$options.watch||[])for(const[r,n]of Object.entries(t))Ri(e,n,r)
e._initial=!0}(e),function(e){for(const t of e.$options.observe||[])Li(e,t)}(e),function(e){const{$options:t,$props:r}=e,{id:n,props:i,el:o}=t
if(!i)return
const{attributes:a,filter:l}=Bi(n,i),u=new MutationObserver((i=>{const o=Fi(t)
i.some((({attributeName:e})=>{const t=e.replace("data-","")
return(t===n?a:[s(t),s(e)]).some((e=>!S(o[e])&&o[e]!==r[e]))}))&&e.$reset()}))
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push((()=>u.disconnect()))}(e),Ni(e),Hi(e,"connected"),hn(e))}function Ui(e){e._connected&&(Hi(e,"beforeDisconnect"),e._disconnect.forEach((e=>e())),e._disconnect=null,Hi(e,"disconnected"),e._connected=!1)}let qi=0
function Vi(e,t={}){t.data=function({data:e={}},{args:t=[],props:r={}}){h(e)&&(e=e.slice(0,t.length).reduce(((e,r,n)=>(v(r)?f(e,r):e[t[n]]=r,e)),{}))
for(const n in e)S(e[n])?delete e[n]:r[n]&&(e[n]=cn(r[n],e[n]))
return e}(t,e.constructor.options),e.$options=ln(e.constructor.options,t,e),e.$props={},e._uid=qi++,function(e){const{data:t={}}=e.$options
...
if(e._computed={},t)for(const r in t)ji(e,r,t[r])}(e),Hi(e,"created"),t.el&&e.$mount(t.el)}const Wi=function(e){Vi(this,e)}
Wi.util=Jr,Wi.options={},Wi.version="3.23.9"
const Yi="__uikit__",Gi={}
function Qi(e,t){var r,n
const o="uk-"+i(e)
if(!t)return Gi[o].options||(Gi[o]=Wi.extend(Gi[o])),Gi[o]
e=s(e),Wi[e]=(t,r)=>Zi(e,t,r)
const a=null!=(r=t.options)?r:{...t}
return a.id=o,a.name=e,null==(n=a.install)||n.call(a,Wi,a,e),Wi._initialized&&!a.functional&&requestAnimationFrame((()=>Zi(e,`[${o}],[data-${o}]`))),Gi[o]=a}function Zi(e,t,r,...n){const i=Qi(e)
return i.options.functional?new i({data:v(t)?t:[t,r,...n]}):t?Dt(t).map(o)[0]:o()
function o(t){const n=Xi(t,e)
if(n){if(!r)return n
n.$destroy()}return new i({el:t,data:r})}}function Ki(e){return(null==e?void 0:e[Yi])||{}}function Xi(e,t){return Ki(e)[t]}function Ji(e,t){e=e?A(e):document.body
for(const r of Pe(e).reverse())eo(r,t)
Nt(e,(e=>eo(e,t)))}function eo(e,t){const r=Ki(e)
for(const n in r)hn(r[n],t)}let to=1
function ro(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${to++}`}var no={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s",role:"String"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>It(e,t),navChildren(){return Me(this.nav)},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return Dt(this.selNavItem,t)}},watch:{nav(e,t){ie(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){yt(e,"ul")&&ie(e,"role","presentation")},navChildren(e){ie(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=ae(t,this.attrItem),r=It("a,button",t)||t
let n,i=null
if(O(e)){const t=M(e),o=this.slides[t]
o&&(o.id||(o.id=ro(this,o)),i=o.id),n=this.t("slideX",R(e)+1),r.role="tab"}else this.list&&(this.list.id||(this.list.id=ro(this,this.list)),i=this.list.id),n=this.t(e)
...
var io={mixins:[Ci,Pi,no,Ei],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){J(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>oo(t.offsetWidth/e),list:({selList:e},t)=>It(e,t),maxIndex(){return this.length-1},slides(){return Me(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){X(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){J(e,this.clsEnter)},itemhide({target:e}){X(e,this.clsLeave)},itemhidden({target:e}){J(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
function oo(e){return.5*e+300}var so={mixins:[io],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:bi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=q}=n,l=a(r),{promise:u,resolve:c}=xi()
return{dir:r,show(n,o=0,s){const a=s?"linear":i
return n-=Math.round(n*U(o,-1,1)),this.translate(o),_i(t,"itemin",{percent:o,duration:n,timing:a,dir:r}),_i(e,"itemout",{percent:1-o,duration:n,timing:a,dir:r}),Promise.all([pt.start(t,l[1],n,a),pt.start(e,l[0],n,a)]).then((()=>{this.reset(),c()}),q),u},cancel:()=>pt.cancel([t,e]),reset(){at([t,e],l[0])},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){this.reset()
const i=s(n,r)
st(t,i[1]),st(e,i[0]),_i(t,"itemtranslatein",{percent:n,dir:r}),_i(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation:({animation:e,Animations:t})=>({...t[e]||t.slide,name:e}),transitionOptions(){return{animation:this.animation}}},observe:pn(),events:{itemshow({target:e}){X(e,this.clsActive)},itemshown({target:e}){X(e,this.clsActivated)},itemhidden({target:e}){J(e,this.clsActive,this.clsActivated)}}},ao={...bi,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:lo(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:lo(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:wi(30),zIndex:-1},{transform:wi(),zIndex:0}]:[{transform:wi(-100),zIndex:0},{transform:wi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-yi(t):yi(e),translate:(e,t)=>t<0?[{transform:wi(30*e),zIndex:-1},{transform:wi(-100*(1-e)),zIndex:0}]:[{transform:wi(100*-e),zIndex:0},{transform:wi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:wi(100),zIndex:0},{transform:wi(),zIndex:-1}]:[{transform:wi(-30),zIndex:-1},{transform:wi(),zIndex:0}],percent:(e,t,r)=>r>0?1-yi(t):yi(e),translate:(e,t)=>t<0?[{transform:wi(100*e),zIndex:0},{transform:wi(-30*(1-e)),zIndex:-1}]:[{transform:wi(-30*e),zIndex:-1},{transform:wi(100*(1-e)),zIndex:0}]}}
function lo(e){return`scale3d(${e}, ${e}, 1)`}var uo={...bi,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:lo(.8)},{opacity:1,transform:lo(1)}],percent:e=>1-st(e,"opacity"),translate:e=>[{opacity:1-e,transform:lo(1-.2*e)},{opacity:e,transform:lo(.8+.2*e)}]}},co={i18n:{counter:"%s / %s"},mixins:[hi,so],functional:!0,props:{counter:Boolean,preload:Number,nav:Boolean,slidenav:Boolean,delayControls:Number,videoAutoplay:Boolean,template:String},data:()=>({counter:!1,preload:1,nav:!1,slidenav:!0,delayControls:3e3,videoAutoplay:!1,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",clsFit:"uk-lightbox-items-fit",clsZoom:"uk-lightbox-zoom",attrItem:"uk-lightbox-item",selList:".uk-lightbox-items",selClose:".uk-close-large",selNav:".uk-lightbox-thumbnav, .uk-lightbox-dotnav",selCaption:".uk-lightbox-caption",selCounter:".uk-lightbox-counter",pauseOnHover:!1,velocity:2,Animations:uo,template:'<div class="uk-lightbox uk-overflow-hidden"> <div class="uk-lightbox-items"></div> <div class="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse> <button class="uk-lightbox-close uk-close-large" type="button" uk-close></button> </div> <div class="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-previous uk-lightbox-item="previous"></a> </div> <div class="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-next uk-lightbox-item="next"></a> </div> <div class="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;"> <ul class="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul> <ul class="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul> </div> <div class="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div> <div class="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>'}),created(){let e=It(this.template)
yt(e,"template")&&(e=At(_t(e)))
const t=It(this.selList,e),r=this.$props.nav
Tt(Dt(this.selNav,e).filter((e=>!Se(e,`.uk-${r}`))))
for(const[o,s]of this.items.entries())Et(t,"<div>"),"thumbnav"===r&&St(po(s,this.videoAutoplay),Et(It(this.selNav,e),`<li uk-lightbox-item="${o}"><a href></a></li>`))
...
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=uo.scale,J(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
...
if("image"===n||fo(r)){const e=ho("img")
ei(e,t.sources),ie(e,{src:r,...z(t,["alt","srcset","sizes"]),...i}),Ge(e,"load",(()=>this.setItem(t,Oe(e)||e))),Ge(e,"error",(()=>this.setError(t)))}else if("video"===n||mo(r)){const e="inline"===this.videoAutoplay,n=ho("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":e?"automute: true":Boolean(this.videoAutoplay),...i})
Ge(n,"loadedmetadata",(()=>this.setItem(t,n))),Ge(n,"error",(()=>this.setError(t)))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,ho("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
else if(o=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,ho("iframe",{src:`https://www.youtube${o[1]||""}.com/embed/${o[2]}${o[3]?`?${o[3]}`:""}`,width:1920,height:1080,...s,...i}))
...
function ho(e,t){const r=At(`<${e}>`)
return ie(r,t),r}function po(e,t){const r=e.poster||e.thumb&&("image"===e.type||fo(e.thumb))?ho("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||mo(e.thumb))?ho("video",{src:e.thumb,loop:"",playsinline:"","uk-video":`autoplay: ${Boolean(t)}; automute: true`}):ho("canvas")
return e.thumbRatio&&(r.style.aspectRatio=e.thumbRatio),r}function fo(e){return null==e?void 0:e.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)}function mo(e){return null==e?void 0:e.match(/\.(mp4|webm|ogv)($|\?)/i)}var go={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",co)
...
for(const t of e)yt(t,"a")&&(t.role="button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Se(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(bo)
if("thumbnav"===this.nav&&vo.call(this,this.toggles,t),t=H(t,"source"),_(e)){const{source:r}=bo(e)
...
function vo(e,t){for(const[r,n]of Object.entries(e)){if(t[r].thumb)continue
const e=Pe(n).reverse().concat(n).find((e=>this.$el.contains(e)&&(e===n||1===Dt(this.toggle,e).length)))
if(!e)continue
const i=It("img,video",e)
i&&(t[r].thumb=i.currentSrc||i.poster||i.src,t[r].thumbRatio=(i.naturalWidth||i.videoWidth)/(i.naturalHeight||i.videoHeight))}}function bo(e){const t={}
for(const r of e.getAttributeNames()){const n=r.replace(/^data-/,"")
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=un(t.attrs),t}var yo={mixins:[ii],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Nt(document.body,(n=>{const i=e.getComponent(n,"notification")
...
var wo={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(st(t,`--uk-breakpoint-${e.slice(1)}`))
...
function _o(e){return _e(e)?Math.ceil(Math.max(0,...Dt("[stroke]",e).map((e=>{var t
return(null==(t=e.getTotalLength)?void 0:t.call(e))||0})))):0}const xo={x:ko,y:ko,rotate:ko,scale:ko,color:Oo,backgroundColor:Oo,borderColor:Oo,blur:To,hue:To,fopacity:To,grayscale:To,invert:To,saturate:To,sepia:To,opacity:function(e,t,r){1===r.length&&r.unshift(Fo(t,e,""))
return r=No(r),(t,n)=>{t[e]=Do(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=$o(r),i=_o(t)
if(r=No(r.reverse(),(e=>(e=R(e),"%"===n?e*i/100:e))),!r.some((([e])=>e)))return q
return st(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=Do(r,t)}},bgx:So,bgy:So},{keys:Eo}=Object
var Co={mixins:[wo],props:Bo(Eo(xo),"list"),data:Bo(Eo(xo),void 0),computed:{props(e,t){const r={}
for(const i in e)i in xo&&!S(e[i])&&(r[i]=e[i].slice())
const n={}
for(const i in r)n[i]=xo[i](i,t,r[i],r)
...
function ko(e,t,r){let n,i=$o(r)||{x:"px",y:"px",rotate:"deg"}[e]||""
return"x"===e||"y"===e?(e=`translate${a(e)}`,n=e=>R(R(e).toFixed("px"===i?0:6))):"scale"===e&&(i="",n=e=>{var r
return $o([e])?Gt(e,"width",t,!0)/t["offset"+((null==(r=e.endsWith)?void 0:r.call(e,"vh"))?"Height":"Width")]:R(e)}),1===r.length&&r.unshift("scale"===e?1:0),r=No(r,n),(t,n)=>{t.transform=`${t.transform||""} ${e}(${Do(r,n)}${i})`}}function Oo(e,t,r){return 1===r.length&&r.unshift(Fo(t,e,"")),r=No(r,(e=>function(e,t){return Fo(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e))),(t,n)=>{const[i,o,s]=Io(r,n),a=i.map(((e,t)=>(e+=s*(o[t]-e),3===t?R(e):parseInt(e,10)))).join(",")
t[e]=`rgba(${a})`}}function To(e,t,r){1===r.length&&r.unshift(0)
const n=$o(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=No(r),(t,i)=>{const o=Do(r,i)
t.filter=`${t.filter||""} ${e}(${o+n})`}}function So(e,t,r,n){1===r.length&&r.unshift(0)
const i="bgy"===e?"height":"width"
n[e]=No(r,(e=>Gt(e,i,t)))
const o=["bgx","bgy"].filter((e=>e in n))
if(2===o.length&&"bgx"===e)return q
if("cover"===Fo(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=st(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(Ao[t])return Ao[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!Ro[t]))return Ze(r,"error load",(()=>{Ao[t]=jo(r),Ke(e,Xe("load",!1))})),Ro[t]=!0,jo(r)
return Ao[t]=jo(r)}(t)
if(!i.width)return q
...
a[c]=`max(${Po(t,c)},-${r}px) + ${a[c]}`}const u=Mo(s,a,n)
return(e,t)=>{u(e,t),e.backgroundSize=`${l.width}px ${l.height}px`,e.backgroundRepeat="no-repeat"}}(0,t,0,n)
const s={}
for(const a of o)s[a]=Po(t,a)
return Mo(o,s,n)}function Po(e,t){return Fo(e,`background-position-${t.slice(-1)}`,"")}function Mo(e,t,r){return function(n,i){for(const o of e){const e=Do(r[o],i)
n[`background-position-${o.slice(-1)}`]=`calc(${t[o]} + ${e}px)`}}}const Ro={},Ao={}
function jo(e){return{width:e.naturalWidth,height:e.naturalHeight}}function No(e,t=R){const r=[],{length:n}=e
let i=0
...
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function Do(e,t){const[r,n,i]=Io(e,t)
return r+Math.abs(r-n)*i*(r<n?1:-1)}const Lo=/^-?\d+(?:\.\d+)?(\S+)?/
function $o(e,t){var r
for(const n of e){const e=null==(r=n.match)?void 0:r.call(n,Lo)
if(e)return e[1]}return t}function Fo(e,t,r){const n=e.style[t],i=st(st(e,t,r),t)
return e.style[t]=n,i}function Bo(e,t){return e.reduce(((e,r)=>(e[r]=t,e)),{})}function Ho(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var zo={mixins:[Co],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>Uo(e&&Ne(e,t)||t),start({start:e}){return Gt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Gt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[vn(),bn({target:({target:e})=>e}),pn({target:({$el:e,target:t})=>[e,t,Mr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!_e(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=Ho(Sr(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&st(this.$el,e):this.reset()},events:["scroll","resize"]}}
function Uo(e){return e?"offsetTop"in e?e:Uo(Oe(e)):document.documentElement}var qo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[pn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),bn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&Ne(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=Ho(Sr(e,Gt(this.parallaxStart,"height",e,!0),Gt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
var Vo={update:{write(){if(this.stack.length||this.dragging||this.parallax)return
const e=this.getValidIndex()
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},Wo={observe:gn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map((e=>this.slides[this.getIndex(this.index+e)]))}}}
function Yo(e,t,r){const n=Zo(e,t)
return r?n-function(e,t){return Ft(t).width/2-Ft(e).width/2}(e,t):Math.min(n,Go(t))}function Go(e){return Math.max(0,Qo(e)-Ft(e).width)}function Qo(e,t){return B(Me(e).slice(0,t),(e=>Ft(e).width))}function Zo(e,t){return e&&(Ht(e).left+(ue?Ft(e).width-Ft(t).width:0))*(ue?-1:1)||0}function Ko(e,t){t-=1
const r=Ft(e).width,n=t+r+2
return Me(e).filter((i=>{const o=Zo(i,e),s=o+Math.min(Ft(i).width,r)
return o>=t&&s<=n}))}var Xo={mixins:[en,io,Vo,qo,Wo],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Yo(e,o,n):Yo(t,o,n)+Ft(t).width*r,a=t?Yo(t,o,n):s+Ft(e).width*r*(ue?-1:1),{promise:l,resolve:u}=xi()
return{dir:r,show(t,n=0,s){const c=s?"linear":i
return t-=Math.round(t*U(n,-1,1)),st(o,"transitionProperty","none"),this.translate(n),st(o,"transitionProperty",""),n=e?n:U(n,0,1),_i(this.getItemIn(),"itemin",{percent:n,duration:t,timing:c,dir:r}),e&&_i(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:c,dir:r}),pt.start(o,{transform:wi(-a*(ue?-1:1),"px")},t,c).then(u,q),l},cancel:()=>pt.cancel(o),reset(){st(o,"transform","")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){if(n===this.percent())return
const i=this.getDistance()*r*(ue?-1:1)
st(o,"transform",wi(U(i-i*n-a,-Qo(o),Ft(o).width)*(ue?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?U(n,-1,1):0
for(const a of Me(o)){const i=c(s,a),d=a===l,h=a===u
_i(a,"itemtranslate"+(d||!h&&(i||r*(ue?-1:1)==-1^Zo(a,o)>Zo(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(st(o,"transform")).m41*(ue?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Ko(o,Yo(t||e,o,n))
if(r){const e=i
i=s,s=e}return s[d(s,(e=>!c(i,e)))]},getActives:()=>Ko(o,Yo(e||t,o,n))}}},computed:{finite({finite:e}){return e||function(e,t){if(!e||e.length<2)return!0
const{width:r}=Ft(e)
if(!t)return Math.ceil(Qo(e))<Math.trunc(r+function(e){return Math.max(0,...Me(e).map((e=>Ft(e).width)))}(e))
...
let e=0
const t=Go(this.list),r=d(this.slides,(r=>{if(e>=t-.005)return!0
e+=Ft(r).width}))
...
return void e.preventDefault()}const r=this.dir<0||!this.slides[this.prevIndex]?this.index:this.prevIndex,n=Qo(this.list)/this.length
this.duration=oo(n/this.velocity)*(Ft(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&X(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void st(this.slides,"order","")
...
let r=e*(this.center?Qo(this.list)-(Ft(this.slides[0]).width/2+Ft(L(this.slides)).width/2):Qo(this.list,this.maxIndex)),n=0
do{const e=Ft(this.slides[++t]).width,i=this.center?e/2+Ft(this.slides[t+1]).width/2:e
n=r/i%1,r-=i}while(r>=0&&t<this.maxIndex)
return[t,n]}}}
var Jo={mixins:[Co],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){tr.read((()=>{if(!this.matchMedia)return
const o=this.getCss(ts(e,i,t)),s=this.getCss(es(e)?.5:i>0?1:0)
...
return!os([r.left,r.right],[t.left,t.right])}))}))
r&&Tt(t)
return i}(e,r)||i<s.top+s.height/2?t:t.nextElementSibling
const a=Ft(r),l=os([s.top,s.bottom],[a.top,a.bottom]),[u,c,d,h]=l?[n,"width","left","right"]:[i,"height","top","bottom"],p=a[c]<s[c]?s[c]-a[c]:0
...
let is
function os(e,t){return e[1]>t[0]&&t[1]>e[0]}var ss={mixins:[ii,ai,oi],data:{pos:"top",animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},connected(){var e
...
const t=e.dataTransfer;(null==t?void 0:t.files)&&(J(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){us(e)},dragover(e){us(e),X(this.$el,this.clsDragover)},dragleave(e){us(e),J(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=p(e)).length)return
Ke(this.$el,"upload",[e])
...
await r(t.shift())}}}
function ls(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function us(e){e.preventDefault(),e.stopPropagation()}var cs=Object.freeze({__proto__:null,Countdown:rn,Filter:Wn,Lightbox:go,LightboxPanel:co,Notification:yo,Parallax:zo,Slider:Xo,SliderParallax:Jo,Slideshow:rs,SlideshowParallax:Jo,Sortable:ns,Tooltip:ss,Upload:as})
function ds(e){Ke(document,"uikit:init",e),document.body&&Nt(document.body,ps),new MutationObserver(hs).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function hs(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)Nt(t,ps)
for(const t of n)Nt(t,fs)
const e=o&&ms(o)
e&&(oe(i,o)?Zi(e,i):null==(t=Xi(i,e))||t.$destroy())}}function ps(e){const t=Ki(e)
for(const r in t)zi(t[r])
for(const r of e.getAttributeNames()){const t=ms(r)
t&&Zi(t,e)}}function fs(e){const t=Ki(e)
for(const r in t)Ui(t[r])}function ms(e){l(e,"data-")&&(e=e.slice(5))
const t=Gi[e]
return t&&(t.options||t).name}(function(e){let t
e.component=Qi,e.getComponents=Ki,e.getComponent=Xi,e.update=Ji,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=ln(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Vi(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=ln(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=It(e)}})})(Wi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Yi]||(e[Yi]={}),e[Yi][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&zi(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&Ui(t),Hi(t,"destroy"),function(e,t){var r
null==(r=e[Yi])||delete r[t.$options.name],T(e[Yi])&&delete e[Yi]}(r,t),e&&Tt(t.$el)},e.prototype.$create=Zi,e.prototype.$emit=function(e){hn(this,e)},e.prototype.$update=function(e=this.$el,t){Ji(e,t)},e.prototype.$reset=function(){Ui(this),zi(this)},e.prototype.$getComponent=Xi,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(Wi)
...
vs(t,!e)}this.$emit()}},observe:gn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,async handler(e){var t
...
await pt.cancel(a),vs(r,!1)
const u=B(["marginTop","marginBottom"],(e=>st(r,e)))+Ft(r).height,c=l/u
n=(i*u+n)*(t?1-c:c),st(a,"height",l),await pt.start(a,{height:t?u:0},n,o),Mt(r),delete e._wrapper,t||vs(r,!0)}(e,r,this)
vs(It(this.content,e),!r)})))))}}}
...
var _s={mixins:[ws],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=yt(this.$el,"img","video")},observe:pn({target:({$el:e})=>xs(e)||Oe(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
...
function ks(e){const t=()=>e.$emit(),r=[pr(t),hr(Rr(e.$el).concat(e.target),t)]
return()=>r.map((e=>e.disconnect()))}function Os(e,t=()=>e.$emit()){return Ge([document,...Rr(e.$el)],"scroll",t,{passive:!0})}function Ts(e){return Ge(document,"keydown",(t=>{t.keyCode===$n&&e.hide(!1)}))}function Ss(e){return Os(e,(()=>e.hide(!1)))}function Ps(e){return Ge(document,he,(({target:t})=>{e.$el.contains(t)||Ze(document,`${fe} ${ve} scroll`,(({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==fe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)}),!0)}))}var Ms={mixins:[en,ii],props:{align:String,clsDrop:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:ue?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>Ne(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||Ne(e,this.$el)||It(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=It("<div></div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=Dt(`.${e}`,t)
...
return null==(t=It(Ce,e.target))?void 0:t.focus()})))}Rs(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
...
const t=Dt(Ce,r)
t[Z(s,t,d(t,(e=>Se(e,":focus"))))].focus()}else Rs(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
return c(this.dropdowns,null==(e=Es)?void 0:e.$el)&&Es},async transitionTo(e,t){const{dropbar:r}=this,n=Ut(r)
...
function Rs(e,t,r){var n,i,o
const{current:s,keyCode:a}=e
let l=-1
a===Hn?l=0:a===Bn?l="last":a===zn?l="previous":a===qn?l="next":a===Ln&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Z(l,t,t.indexOf(r.targetEl||s))].focus())}var As={mixins:[en],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>It(xe,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&Oe(this.input)===t&&this.input.nextElementSibling||It(e,t))}},update(){var e
...
Is(n,d,a[l]),Is(i,d,[(d-l)*u*(ue?-1:1),o[d]-s]),o[d]+=c+t,e=Math.max(e,c)}s+=e+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)Is(t,e,r[e])
return t}(t)
...
function Ns(e){return e.flat().some((e=>"absolute"===st(e,"position")))}function Is(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var Ds={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>Dt(e,t)},observe:pn({target:({$el:e,elements:t})=>t.reduce(((e,t)=>e.concat(t,...t.children)),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?xn(this.elements):[this.elements]).map(Ls)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach(((e,r)=>st(e,"minHeight",t[r])))},events:["resize"]}}
function Ls(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map($s)
const r=Math.max(...t)
return{heights:e.map(((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r)),elements:e}}function $s(e){const t=z(e.style,["display","minHeight"])
_e(e)||st(e,"display","block","important"),st(e,"minHeight","")
const r=Ft(e).height-Wt(e,"height","content-box")
return st(e,t),r}var Fs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>Ne(e,t),observe:({target:e})=>e}},observe:pn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){st(this.$el,"minHeight",e)},events:["resize"]}},Bs={props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[vn({filter:({expand:e})=>e}),pn({target:({$el:e})=>Pr(e)})],update:{read(){if(!_e(this.$el))return!1
let e=""
...
!0===this.offsetBottom?e+=` - ${Ft(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?e+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?e+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(e+=` - ${Ft(Ne(this.offsetBottom,this.$el)).height}px`)}return e+=(t?` - ${t}px`:"")+")",{minHeight:e}},write({minHeight:e}){st(this.$el,this.property,`max(${this.min||0}px, ${e})`)},events:["resize"]}},Hs='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',zs={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then((e=>{if(!this._connected)return
const t=function(e,t){if(ye(t)||yt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return Us(e,r)?r:kt(t,e)}const r=t.lastElementChild
return Us(e,r)?r:Et(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Tt(this.svgEl),qs.call(this,t,e),this.svgEl=t}),q)},disconnected(){this.svg.then((e=>{this._connected||(ye(this.$el)&&(this.$el.hidden=!1),Tt(e),this.svgEl=null)})),this.svg=null},methods:{async getSvg(){}}}
function Us(e,t){return yt(e,"svg")&&yt(t,"svg")&&e.innerHTML===t.innerHTML}function qs(e,t){const r=["width","height"]
let n=r.map((e=>this[e]))
n.some((e=>e))||(n=r.map((e=>ie(t,e))))
const i=ie(t,"viewBox")
i&&!n.some((e=>e))&&(n=i.split(" ").slice(2)),n.forEach(((t,n)=>ie(e,r[n],R(t)*this.ratio||null)))}function Vs(e,t){return t&&c(e,"<symbol")&&(e=Ys(e)[t]||e),j(At(e)).filter(_)[0]}const Ws=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Ys=K((function(e){const t={}
let r
for(;r=Ws.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t})),Gs={spinner:'<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"drop-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon-large":'<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',"navbar-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":Hs,"search-medium":'<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-toggle-icon":Hs,"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>'},Qs={install:function(e){e.icon.add=(t,r)=>{const n=C(t)?{[t]:r}:t
$(n,((e,t)=>{Gs[t]=e,delete la[t]})),e._initialized&&Nt(document.body,(t=>$(e.getComponents(t),(e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))))}},mixins:[zs],args:"icon",props:{icon:String},isIcon:!0,beforeConnect(){X(this.$el,"uk-icon")},async connected(){const e=await this.svg
e&&(e.ariaHidden=!0)},methods:{async getSvg(){const e=function(e){if(e=ua[e]||e,!Gs[e])return null
la[e]||(la[e]=Vs(Gs[function(e){return ue?D(D(e,"left","right"),"previous","next"):e}(e)]||Gs[e]))
return la[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Zs={args:!1,extends:Qs,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){X(this.$el,this.$options.id)}},Ks={extends:Zs,beforeConnect(){const e=this.$props.icon
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},Xs={extends:Zs,mixins:[Ei],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=te(this.$el,"uk-search-toggle")||te(this.$el,"uk-navbar-toggle")
...
e&&(e.ariaLabel=this.t("submit"))}}},Js={extends:Zs,beforeConnect(){this.$el.role="status"},methods:{async getSvg(){const e=await Qs.methods.getSvg.call(this)
return 1!==this.ratio&&st(It("circle",e),"strokeWidth",1/this.ratio),e}}},ea={extends:Zs,mixins:[Ei],beforeConnect(){const e=this.$el.closest("a,button")
ie(e,"role",null!==this.role&&yt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!oe(e,"aria-label")&&ie(e,"aria-label",t)}},ta={extends:ea,beforeConnect(){X(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=te(this.$el,"uk-slidenav-large")?`${e}-large`:e}},ra={extends:ea,i18n:{label:"Open menu"},beforeConnect(){this.$el.ariaExpanded=!1}},na={extends:ea,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(te(this.$el,"uk-close-large")?"large":"icon")}},ia={extends:ea,i18n:{label:"Open"}},oa={extends:ea,i18n:{label:"Back to top"}},sa={extends:ea,i18n:{label:"Next page"},data:{role:null}},aa={extends:ea,i18n:{label:"Previous page"},data:{role:null}},la={}
const ua={twitter:"x"}
var ca={props:{target:String,selActive:String},data:{target:!1,selActive:!1},connected(){this.isIntersecting=0},computed:{target:({target:e},t)=>e?Dt(e,t):t},watch:{target:{handler(){queueMicrotask((()=>this.$reset()))},immediate:!1}},observe:[fn({handler(e){this.isIntersecting=e.reduce(((e,{isIntersecting:t})=>e+(t?1:this.isIntersecting?-1:0)),this.isIntersecting),this.$emit()},target:({target:e})=>e,args:{intersecting:!1}}),mn({target:({target:e})=>e,options:{attributes:!0,attributeFilter:["class"]}}),{target:({target:e})=>e,observe:(e,t)=>{const r=hr([...j(e),document.documentElement],t),n=[Ge(document,"scroll itemshown itemhidden",t,{passive:!0,capture:!0}),Ge(document,"show hide transitionstart",(e=>(t(),r.observe(e.target)))),Ge(document,"shown hidden transitionend transitioncancel",(e=>(t(),r.unobserve(e.target))))]
...
for(const e of j(this.target)){let t=!this.selActive||Se(e,this.selActive)?da(e):""
!1!==t&&ee(e,"uk-light uk-dark",t)}}}}
function da(e){const t=Ft(e),r=Ft(window)
if(!V(t,r))return!1
...
for(const r of t){if(e.contains(r)||!ha(r)||r.closest('[class*="-leave"]')&&t.some((e=>r!==e&&Se(e,'[class*="-enter"]'))))continue
const n=st(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function ha(e){if("visible"!==st(e,"visibility"))return!1
for(;e;){if("0"===st(e,"opacity"))return!1
e=Oe(e)}return!0}var pa={mixins:[en,wo],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||st(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=Pt(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){Mt(this.wrapper.childNodes)},observe:pn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){re(this.wrapper,this.clsHide,r),ie(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},fa={install:function({modal:e}){function t(t,r,n=q,i=q){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
...
var ma={extends:gs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const ga="uk-navbar-transparent"
var va={extends:Ms,props:{dropbarTransparentMode:Boolean},data:{delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=te(this.$el,"uk-navbar-justify"),t=Dt(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){st(r,"flexGrow",e?Dt(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&te(this.navbarContainer,ga)&&(J(this.navbarContainer,ga),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await new Promise((e=>setTimeout(e))),!this._transparent||Es&&this.dropContainer.contains(Es.$el)||(X(this.navbarContainer,ga),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
...
function ya(){return It('meta[name="viewport"]',document.head)||Et(document.head,'<meta name="viewport">')}var wa={mixins:[en],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:pn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&_e(this.$el))&&{max:Math.max(this.minHeight,Ut(this.container)-(Ft(this.content).height-Ut(this.$el)))}},write({max:e}){st(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},_a={props:["width","height"],connected(){X(this.$el,"uk-responsive-width"),st(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},xa={props:{offset:Number},data:{offset:0},connected(){(function(e){Ea.size||Ge(document,"click",Ca)
Ea.add(e)})(this)},disconnected(){var e
e=this,Ea.delete(e),Ea.size||Qe(document,"click",Ca)},methods:{async scrollTo(e){e=e&&It(e)||document.body,Ke(this.$el,"beforescroll",[this,e])&&(await Tr(e,{offset:this.offset}),Ke(this.$el,"scrolled",[this,e]))}}}
const Ea=new Set
function Ca(e){if(!e.defaultPrevented)for(const t of Ea)t.$el.contains(e.target)&&Ae(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(je(t.$el)))}const ka="uk-scrollspy-inview"
var Oa={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?Dt(e,t):[t]},watch:{elements(e){this.hidden&&st(Te(e,`:not(.${ka})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())J(e,ka,(null==t?void 0:t.cls)||"")
...
t&&Ke(this.$el,"active",[e,this.elements[e]])},events:["scroll","resize"]}]},Sa={mixins:[en,wo],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&It(e,t)||t},connected(){this.start=Ma(this.start||this.top),this.end=Ma(this.end||this.bottom),this.placeholder=It("+ .uk-sticky-placeholder",this.$el)||It('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),J(this.target,this.clsInactive)),Ra(this.$el),Tt(this.placeholder),this.placeholder=null},observe:[vn(),bn({target:()=>document.scrollingElement}),pn({target:({$el:e})=>[e,Na(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some((({target:e})=>e===Na(this.$el)))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,handler(){const{scrollingElement:e}=document
...
a&&(ja(this.target),this.hide()),this.active||(({height:e,width:t}=Ft(this.$el)),r=st(this.$el,"margin")),a&&this.show()
...
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=Bt(c).top-new DOMMatrix(st(c,"transform")).m42,g=Ft(this.$el).height,v=(!1===this.start?m:Pa(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,Pa(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,Pa(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==st(Na(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:zt(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&Ra(this.$el),this.inactive)return
...
bt.out(this.$el,this.animation).then((()=>this.hide()),q)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),bt.in(this.$el,this.animation).catch(q)):(ja(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),J(this.$el,this.clsFixed,this.clsBelow),t?st(this.$el,"top",e):Ra(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
...
this.active=e,e?(ee(this.target,this.clsInactive,this.clsActive),t!==e&&Ke(this.$el,"active")):(ee(this.target,this.clsActive,this.clsInactive),t!==e&&(ja(this.target),Ke(this.$el,"inactive")))}}}
function Pa(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Gt(e,"height",t,!0)
{const r=!0===e?Na(t):Ne(e,t)
return Bt(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(st(r,"paddingBottom"))+R(st(r,"borderBottomWidth")):0)}}function Ma(e){return"true"===e||"false"!==e&&e}function Ra(e){st(e,{position:"",top:"",marginTop:"",width:""})}const Aa="uk-transition-disable"
function ja(e){te(e,Aa)||(X(e,Aa),requestAnimationFrame((()=>J(e,Aa))))}function Na(e){for(;e=Oe(e);)if(_e(e))return e}var Ia={mixins:[zs],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[mn({async handler(){const e=await this.svg
e&&Da.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&(Da.call(this,e),this.strokeAnimation&&function(e){const t=_o(e)
t&&st(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return yt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise((e=>Ze(this.$el,"load",e))),Vs(await La(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function Da(e){const{$el:t}=this
...
r.role="tab",n&&(r.id=ro(this,r),n.id=ro(this,n),r.ariaControls=n.id,ie(n,{role:"tabpanel","aria-labelledby":r.id}))}ie(this.$el,"aria-orientation",Se(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,(e=>te(e,this.cls)))},show(e){const t=this.toggles.filter((e=>!Se(e,$a))),r=this.index(),n=Z(!w(e)||c(t,e)?e:0,t,Z(this.toggles[r],t)),i=Z(t[n],this.toggles)
...
await this.toggleElement(t,!1,o)&&await this.toggleElement(e[i],!0,o)}))}}},Ba={mixins:[en],extends:Fa,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=te(this.$el,"uk-tab-left")?"uk-tab-left":!!te(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var Ha={mixins:[wo,ai],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ie(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(ke(this.$el)||(this.$el.tabIndex=0),!this.cls&&yt(this.$el,"a")&&(this.$el.role="button"))},observe:gn({targets:({target:e})=>e}),events:[{name:he,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!nt(e)||E(this._showState)||this.$el.disabled||(Ke(this.$el,"focus"),Ze(document,he,(()=>Ke(this.$el,"blur")),!0,(e=>!this.$el.contains(e.target))),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`mouseenter mouseleave ${me} ${ge} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(nt(e)||this.$el.disabled||"loading"===document.readyState)return
...
return $(Object.freeze({__proto__:null,Accordion:gs,Alert:bs,Close:na,Cover:_s,Drop:Cs,DropParentIcon:Zs,Dropdown:Cs,Dropnav:Ms,FormCustom:As,Grid:js,HeightMatch:Ds,HeightPlaceholder:Fs,HeightViewport:Bs,Icon:Qs,Img:Zn,Inverse:ca,Leader:pa,Margin:_n,Marker:ia,Modal:fa,Nav:ma,NavParentIcon:Ks,Navbar:va,NavbarParentIcon:Zs,NavbarToggleIcon:ra,Offcanvas:ba,OverflowAuto:wa,OverlayIcon:Zs,PaginationNext:sa,PaginationPrevious:aa,Responsive:_a,Scroll:xa,Scrollspy:Oa,ScrollspyNav:Ta,SearchIcon:Xs,SlidenavNext:ta,SlidenavPrevious:ta,Spinner:Js,Sticky:Sa,Svg:Ia,Switcher:Fa,Tab:Ba,Toggle:Ha,Totop:oa,Video:ws}),((e,t)=>Wi.component(t,e))),function(e){le&&window.MutationObserver&&(document.body?requestAnimationFrame((()=>ds(e))):new MutationObserver(((t,r)=>{document.body&&(ds(e),r.disconnect())})).observe(document.documentElement,{childList:!0}))}(Wi),$(cs,((e,t)=>Wi.component(t,e))),Wi})),/*! UIkit 3.23.9 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
