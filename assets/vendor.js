...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.25.13 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */
...
for(const r of e)for(const[,,e,n]of $r)t[e]=Math.max(t[e]||0,r[e]),t[n]=Math.min(...[t[n],r[n]].filter(k))
...
Ze(e,"scroll touchend touchcancel",n,{capture:!0})},{passive:!0})
if(ii)return t
ii=!0
...
const s=()=>{var t
J(e,o),Ke(e,n?"shown":"hidden",[this]),n&&(null==(t=Dt("[autofocus]",e).find(_e))||t.focus({preventScroll:!0}))}
...
var hi={mixins:[tn,si,ai],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>It(e,t),transitionElement(){return this.panel}},connected(){const e=this.panel||this.$el
...
!r&&n&&Ae(t)&&!this.$el.contains(It(n))?this.hide():Se(t,this.selClose)&&(Ln(e),this.hide())}},{name:"toggle",self:!0,handler(e,t){e.defaultPrevented||(e.preventDefault(),this.target=null==t?void 0:t.$el,this.isToggled()===c(di,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(di,this))return!1
...
const{target:e}=this
di.some(e=>e.clsPage===this.clsPage)||(J(document.documentElement,this.clsPage),queueMicrotask(()=>{ke(e)&&e.focus({preventScroll:!0})})),vi(e,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},async show(){return this.container&&Oe(this.$el)!==this.container&&(Et(this.container,this.$el),await kn()),this.toggleElement(this.$el,!0,pi)},hide(){return this.toggleElement(this.$el,!1,pi)}}}
...
this[e]=e=>{const r=it(e)
ue&&(r.x=-r.x),this.prevPos=I(r,this.pos)?this.prevPos:this.pos,this.pos=r,t(e)}}},events:[{name:"touchstart mousedown",passive:!0,delegate:({selList:e})=>`${e} > *`,handler(e){var t
!this.draggable||this.parallax||!nt(e)&&(t=e.target,"none"!==st(t,"userSelect")&&p(t.childNodes).some(e=>3===e.nodeType&&e.textContent.trim()))||e.target.closest(xe)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Oi,el:({list:e})=>e,handler:q,...ki}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag.x+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ge(document,Oi,this.move,ki),Ge(document,"touchend touchcancel mouseup click input scroll",this.end,{passive:!0,capture:!0,once:!0}),st(this.list,"userSelect","none")},move(e){const t=this.pos.x-this.drag.x
...
let f
for(const m of[this.index,this.prevIndex])c([a,o],m)||(Ke(i[m],"itemhidden",[this]),p&&(f=!0,this.prevIndex=o));(this.index===o&&this.prevIndex!==o||f)&&Ke(i[this.index],"itemshown",[this]),h&&(this.prevIndex=o,this.index=a,p||(Ke(u,"beforeitemhide",[this]),Ke(u,"itemhide",[this])),Ke(d,"beforeitemshow",[this]),Ke(d,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),u,!p&&d)},end(){if(Qe(document,Oi,this.move,ki),this.dragging)if(setTimeout(Ge(this.list,"click",e=>e.preventDefault(),ki)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const e=this.dir<0==this.prevPos.x>this.pos.x
e?(Ke(this.slides[this.prevIndex],"itemhidden",[this]),Ke(this.slides[this.index],"itemshown",[this]),this.percent=1-this.percent):this.index=this.prevIndex,this.show(this.dir>0&&!e||this.dir<0&&e?"next":"previous",!0)}st(this.list,{userSelect:""}),this.drag=this.percent=null}}}
...
e._initial=!1}(e,ji(e)),events:["resize","computed"]}),e._computedObserver=fr(e.$el,()=>pn(e,"computed"),Mi),e._disconnect.push(()=>{e._computedObserver.disconnect(),e._computedObserver=null,ji(e)}))}function ji(e){const t={...e._computed}
return e._computed={},t}function Ni(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ge(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function Ii(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
...
S(n[e])||(t[e]=dn(n[e],u[i]))}return t}const $i=K((e,t)=>{const r=Object.keys(t),n=r.concat(e).map(e=>[i(e),`data-${i(e)}`]).flat()
...
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push(()=>u.disconnect())}(e),Ai(e),Fi(e,"connected"),pn(e))}function Hi(e){e._connected&&(Fi(e,"beforeDisconnect"),e._disconnect.forEach(e=>e()),e._disconnect=null,Fi(e,"disconnected"),e._connected=!1)}let zi=0
...
return e}(t,e.constructor.options),e.$options=un(e.constructor.options,t,e),e.$props={},e._uid=zi++,function(e){const{data:t={}}=e.$options
...
qi.util=en,qi.options={},qi.version="3.25.13"
...
r[e]=t.findLast(e=>e.matches(`[${n}]`))||It(`<li ${n}><a href></a></li>`)}I(r,t)||_t(e,r)}}}}
var ro={mixins:[Ci,Ti,to,Ei],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){J(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>no(t.offsetWidth/e),list:({selList:e},t)=>It(e,t),maxIndex(){return this.length-1},slides(){return Me(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){X(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){J(e,this.clsEnter)},itemhide({target:e}){X(e,this.clsLeave)},itemhidden({target:e}){J(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
function no(e){return.5*e+300}var io={mixins:[ro],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:bi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=q}=n,l=a(r),{promise:u,resolve:c}=xi()
...
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=ao.scale,J(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
...
ri(e,t.sources),ie(e,{src:r,...z(t,["alt","srcset","sizes"]),...i}),Ge(e,"load",()=>this.setItem(t,Oe(e)||e)),Ge(e,"error",()=>this.setError(t))}else if("video"===n||po(r)){const e="inline"===this.videoAutoplay,n=uo("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,muted:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":Boolean(this.videoAutoplay),...i})
Ge(n,"loadedmetadata",()=>this.setItem(t,n)),Ge(n,"error",()=>this.setError(t))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,uo("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
...
function uo(e,t){const r=At(`<${e}>`)
return ie(r,t),r}function co(e,t){const r=e.poster||e.thumb&&("image"===e.type||ho(e.thumb))?uo("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||po(e.thumb))?uo("video",{src:e.thumb,loop:"",playsinline:"",muted:"","uk-video":"inline"===t}):uo("canvas")
...
for(const t of e)yt(t,"a")&&(t.role="button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Se(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(go)
if("thumbnav"===this.nav&&mo.call(this,this.toggles,t),t=H(t,"source"),_(e)){const{source:r}=go(e)
...
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=cn(t.attrs),t}var vo={mixins:[si],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){Nt(document.body,n=>{const i=e.getComponent(n,"notification")
...
var bo={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(st(t,`--uk-breakpoint-${e.slice(1)}`))
...
function yo(e){return _e(e)?Math.ceil(Math.max(0,...Dt("[stroke]",e).map(e=>{var t
...
const n=Do(r),i=yo(t)
if(r=Ao(r.reverse(),e=>(e=R(e),"%"===n?e*i/100:e)),!r.some(([e])=>e))return q
return st(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=No(r,t)}},bgx:Oo,bgy:Oo},{keys:_o}=Object
...
if("cover"===Lo(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=st(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(Mo[t])return Mo[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!Po[t]))return Ze(r,"error load",()=>{Mo[t]=Ro(r),Ke(e,Xe("load",!1))}),Po[t]=!0,Ro(r)
return Mo[t]=Ro(r)}(t)
if(!i.width)return q
...
if(e)return e[1]}return t}function Lo(e,t,r){const n=e.style[t],i=st(st(e,t,r),t)
return e.style[t]=n,i}function $o(e,t){return e.reduce((e,r)=>(e[r]=t,e),{})}function Fo(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var Bo={mixins:[xo],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>Ho(e&&Ne(e,t)||t),start({start:e}){return Gt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Gt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[bn(),yn({target:({target:e})=>e}),fn({target:({$el:e,target:t})=>[e,t,Rr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!_e(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=Fo(Pr(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&st(this.$el,e):this.reset()},events:["scroll","resize"]}}
function Ho(e){return e?"offsetTop"in e?e:Ho(Oe(e)):document.documentElement}var zo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[fn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),yn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&Ne(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=Fo(Pr(e,Gt(this.parallaxStart,"height",e,!0),Gt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},qo={observe:vn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}}
function Vo(e,t,r){const n=Go(e,t)
return r?n-function(e,t){return(Ft(t).width-Ft(e).width)/2}(e,t):Math.min(n,Wo(t))}function Wo(e){return Math.max(0,Yo(e)-Ft(e).width)}function Yo(e,t){return B(Me(e).slice(0,t),e=>Ft(e).width)}function Go(e,t){return e&&(Ht(e).left+(ue?Ft(e).width-Ft(t).width:0))*(ue?-1:1)||0}function Qo(e,t){t-=1
const r=Ft(e).width,n=t+r+2
return Me(e).filter(i=>{const o=Go(i,e),s=o+Math.min(Ft(i).width,r)
return o>=t&&s<=n})}var Zo={mixins:[tn,ro,Uo,zo,qo],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Vo(e,o,n):Vo(t,o,n)+Ft(t).width*r,a=t?Vo(t,o,n):s+Ft(e).width*r*(ue?-1:1),{promise:l,resolve:u}=xi()
...
st(o,"transform",wi(U(i-i*n-a,-Yo(o),Ft(o).width)*(ue?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?U(n,-1,1):0
for(const a of Me(o)){const i=c(s,a),d=a===l,h=a===u
_i(a,"itemtranslate"+(d||!h&&(i||r*(ue?-1:1)==-1^Go(a,o)>Go(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(st(o,"transform")).m41*(ue?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Qo(o,Vo(t||e,o,n))
if(r){const e=i
...
const{width:r}=Ft(e)
if(!t)return Math.ceil(Yo(e))<Math.trunc(r+function(e){return Math.max(0,...Me(e).map(e=>Ft(e).width))}(e))
...
this.duration=no(n/this.velocity)*(Ft(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&X(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void st(this.slides,"order","")
...
for(const n of this.slides)re(n,r,c(t,n))},getValidIndex(e=this.index,t=this.prevIndex){if(e=this.getIndex(e,t),!this.sets)return e
let r
...
let r,n=e*(this.center?Yo(this.list)-(Ft(this.slides[0]).width+Ft(L(this.slides)).width)/2:Yo(this.list,this.maxIndex))
do{const e=Ft(this.slides[++t]).width,i=this.center?(e+Ft(this.slides[t+1]).width)/2:e
r=n/i%1,n-=i}while(n>=0&&t<this.maxIndex)
return[t,r]}}}
var Ko={mixins:[xo],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){tr.read(()=>{if(!this.matchMedia)return
...
const u=this.getSortable(o),c=function(e,t,r,n,i){if(!Me(e).length)return
const o=Ft(t)
if(!i)return function(e,t){const r=1===Me(e).length
r&&Et(e,t)
...
const s=Ft(r),a=ns([o.top,o.bottom],[s.top,s.bottom]),[l,u,c,d]=a?[n.x,"width","left","right"]:[n.y,"height","top","bottom"],h=s[u]<o[u]?o[u]-s[u]:0
...
let rs
function ns(e,t){return e[1]>t[0]&&t[1]>e[0]}var is={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
...
n.reverse(),i.reverse()}const s=os(e),a=Ft(e)
...
function os(e){const t=Rr(e),{scrollTop:r}=t
...
try{const e=await async function(e,t){const r={url:e,data:null,method:"GET",headers:{},xhr:new XMLHttpRequest,beforeSend:q,responseType:"",...t}
...
await r(t.shift())}}}
function ls(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function us(e){e.preventDefault(),e.stopPropagation()}var cs=Object.freeze({__proto__:null,Countdown:nn,Filter:Yn,Lightbox:fo,LightboxPanel:lo,Notification:vo,Parallax:Bo,Slider:Zo,SliderParallax:Ko,Slideshow:es,SlideshowParallax:Ko,Sortable:ts,Tooltip:ss,Upload:as})
...
const e=o&&ms(o)
e&&(oe(i,o)?Gi(e,i):null==(t=Zi(i,e))||t.$destroy())}}function ps(e){const t=Qi(e)
...
e.component=Yi,e.getComponents=Qi,e.getComponent=Zi,e.update=Ki,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=un(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Ui(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=un(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=It(e)}})})(qi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Vi]||(e[Vi]={}),e[Vi][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&Bi(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&Hi(t),Fi(t,"destroy"),function(e,t){var r
null==(r=e[Vi])||delete r[t.$options.name],T(e[Vi])&&delete e[Vi]}(r,t),e&&Tt(t.$el)},e.prototype.$create=Gi,e.prototype.$emit=function(e){pn(this,e)},e.prototype.$update=function(e=this.$el,t){Ki(e,t)},e.prototype.$reset=function(){Hi(this),Bi(this)},e.prototype.$getComponent=Zi,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(qi)
var gs={mixins:[tn,ai],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:".uk-accordion-title",content:".uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>Dt(e,t),toggles({toggle:e}){return this.items.map(t=>It(e,t))},contents({content:e}){return this.items.map(t=>{var r
...
vs(t,!e)}this.$emit()}},observe:vn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,handler(e){if("keydown"===e.type&&e.keyCode!==Bn)return
const t=Re(this.toggles,e.current)
if(-1===t)return
Ln(e)
const r=function(e){const t=Rr(e,!0)
let r
...
this.toggle(t).finally(r)}},{name:"show hide shown hidden",self:!0,delegate:({targets:e})=>e,handler(){this.$emit()}}],update(){const e=Te(this.items,`.${this.clsOpen}`)
...
n=u?(i*u+n)*(t?1-c:c):0,st(a,"height",l),await pt.start(a,{height:t?u:0},n,o),Mt(r),delete e._wrapper,t||vs(r,!0)}(e,r,this)
vs(It(this.content,e),!r)})))}}}
function vs(e,t){e&&(e.hidden=t)}var bs={mixins:[tn,ai],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){Ln(e),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,ys),this.$destroy(!0)}}}
...
!nt(e)||((t=this.$el).paused||t.ended)?gr(this.$el):_s(this.$el,this.restart)}},{name:`${ge} focusout`,el:({hoverTarget:e,$el:t})=>Ne(e,t)||t,filter:({autoplay:e})=>c(e,"hover"),handler(e){nt(e)||_s(this.$el,this.restart)}}],observe:[mn({filter:({$el:e})=>"none"===e.preload,handler([{target:e}]){e.preload="",this.$reset()}}),mn({filter:({$el:e,autoplay:t})=>"hover"!==t&&"none"!==e.preload,handler([{isIntersecting:e,target:t}]){document.fullscreenElement||(e?this.autoplay&&gr(t):_s(t,this.restart))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:Oe(e).closest(":not(a)")})})]}
function _s(e,t){vr(e),t&&yt(e,"video")&&(e.currentTime=0)}var xs={mixins:[ws],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=yt(this.$el,"img","video")},observe:fn({target:({$el:e})=>Es(e)||Oe(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
const{$el:e,width:t=e.clientWidth,height:r=e.clientHeight}=this,n=Es(e)||Oe(e),i=Q.cover({width:t,height:r},{width:n.offsetWidth,height:n.offsetHeight})
...
t=!1}this.container&&Oe(this.$el)!==this.container&&Et(this.container,this.$el),X(this.$el,this.clsEnter),this.showTimer=setTimeout(()=>this.toggleElement(this.$el,!0),t&&this.delayShow||0)}},hide(e=!0,t=!0){const r=()=>{J(this.$el,this.clsEnter),this.toggleElement(this.$el,!1,this.animateOut&&t)}
...
function Os(e){const t=()=>e.$emit(),r=[pr(t),hr(Ar(e.$el).concat(e.target),t)]
return()=>r.map(e=>e.disconnect())}function Ts(e,t=()=>e.$emit()){return Ge([document,...Ar(e.$el)],"scroll",t,{passive:!0})}function Ss(e){return Ge(document,"keydown",t=>{t.keyCode===Fn&&e.hide(!1)})}function Ps(e){return Ts(e,()=>e.hide(!1))}function Ms(e){return Ge(document,he,({target:t})=>{e.$el.contains(t)||Ze(document,`${fe} ${ve} scroll`,({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==fe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)},!0)})}var Rs={mixins:[tn,si],props:{align:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:ue?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,flip:!0,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>Ne(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||Ne(e,this.$el)||It(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=It("<div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=Dt(`.${e}`,t)
...
let l=-1
a===zn?l=0:a===Hn?l="last":a===Un?l="previous":a===Vn?l="next":a===$n&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Z(l,t,t.indexOf(r.targetEl||s))].focus())}var js={mixins:[tn],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>It(xe,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&Oe(this.input)===t&&this.input.nextElementSibling||It(e,t))}},update(){var e
...
let s=0
for(let a of e){const e=ue?a.slice().reverse():a
let l=0
for(const a in e){const{offsetWidth:u,offsetHeight:c}=e[a],d=r?a:o.indexOf(Math.min(...o))
Ds(n,d,e[a]),Ds(i,d,[(d-a)*u*(ue?-1:1),o[d]-s]),o[d]+=c+t,l=Math.max(l,c)}s+=l+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)Ds(t,e,r[e])
return t}(t)
const u=s.map(e=>B(e,"offsetHeight")+l*(e.length-1)),c=Math.max(0,...u)
let d,h,p
return(n||i)&&(d=u.map((e,t)=>i?c-e+n:n/(t%2||8)),i||(n=Math.max(...u.map((e,t)=>e+d[t]-c))),h=Gt(this.parallaxStart,"height",this.$el,!0),p=Gt(this.parallaxEnd,"height",this.$el,!0)),{columns:s,translates:a,scrollColumns:d,parallaxStart:h,parallaxEnd:p,padding:n,height:a?c:""}},write({height:e,padding:t}){st(this.$el,"paddingBottom",t||""),!1!==e&&st(this.$el,"height",e)},events:["resize"]},{read({rows:e,scrollColumns:t,parallaxStart:r,parallaxEnd:n}){return{scrolled:!(!t||Is(e))&&Pr(this.$el,r,n)}},write({columns:e,scrolled:t,scrollColumns:r,translates:n}){(t||n)&&e.forEach((e,i)=>e.forEach((e,o)=>{let[s,a]=n&&n[i][o]||[0,0]
t&&(a+=t*r[i]),st(e,"transform",`translate(${s}px, ${a}px)`)}))},events:["scroll","resize"]}]}
function Is(e){return e.flat().some(e=>"absolute"===st(e,"position"))}function Ds(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var Ls={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>Dt(e,t)},observe:fn({target:({$el:e,elements:t})=>t.reduce((e,t)=>e.concat(t,...t.children),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?En(this.elements):[this.elements]).map($s)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach((e,r)=>st(e,"minHeight",t[r]))},events:["resize"]}}
...
return st(e,t),r}var Bs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>Ne(e,t),observe:({target:e})=>e}},observe:fn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){st(this.$el,"minHeight",e)},events:["resize"]}},Hs={mixins:[bo],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[bn({filter:({expand:e})=>e}),fn({target:({$el:e})=>Mr(e)})],update:{read(){if(!_e(this.$el))return!1
if(!this.matchMedia)return{minHeight:!1}
const e=Wt(this.$el,"height","content-box"),{body:t,scrollingElement:r}=document,n=Rr(this.$el),{height:i}=jr(n===t?r:n),o=r===n||t===n
let s="calc("+(o?"100vh":`${i}px`)
if(this.expand){s+=` - ${Ft(n).height-Ft(this.$el).height}px`}else{if(this.offsetTop)if(o){const e=!0===this.offsetTop?this.$el:Ne(this.offsetTop,this.$el),{top:t}=Bt(e)
s+=t>0&&t<i/2?` - ${t}px`:""}else s+=` - ${Wt(n,"height",st(n,"boxSizing"))}px`
!0===this.offsetBottom?s+=` - ${Ft(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?s+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?s+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(s+=` - ${Ft(Ne(this.offsetBottom,this.$el)).height}px`)}return s+=(e?` - ${e}px`:"")+")",{minHeight:s}},write({minHeight:e}){st(this.$el,this.property,!1===e?"":`max(${this.min||0}px, ${e})`)},events:["resize"]}},zs='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',Us={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then(e=>{if(!this._connected)return
...
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},Js={extends:Ks,mixins:[Ei],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=te(this.$el,"uk-search-toggle")||te(this.$el,"uk-navbar-toggle")
...
return 1!==this.ratio&&st(It("circle",e),"strokeWidth",1/this.ratio),e}}},ta={extends:Ks,mixins:[Ei],beforeConnect(){const e=this.$el.closest("a,button")
...
var ba={extends:Rs,props:{dropbarTransparentMode:Boolean},data:{flip:!1,autoUpdate:!1,delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=te(this.$el,"uk-navbar-justify"),t=Dt(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){st(r,"flexGrow",e?Dt(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&te(this.navbarContainer,va)&&(J(this.navbarContainer,va),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await On(),!this._transparent||Cs&&this.dropContainer.contains(Cs.$el)||(X(this.navbarContainer,va),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
...
function wa(){return It('meta[name="viewport"]',document.head)||Et(document.head,'<meta name="viewport">')}var _a={mixins:[tn],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:fn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&_e(this.$el))&&{max:Math.max(this.minHeight,Ut(this.container)-(Ft(this.content).height-Ut(this.$el)))}},write({max:e}){st(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},xa={data:{threshold:5,fadeDuration:.05},events:[{name:"scroll",self:!0,passive:!0,handler(){this.$emit()}},{name:he,handler:function(e){const{target:t,button:r,defaultPrevented:n}=e
if(n||r>0||nt(e)||t.closest(xe)||Ee(t))return
e.preventDefault()
const i={passive:!1,capture:!0},{$el:o,threshold:s,$options:a}=this
let l
const u=Ge(document,pe,function(e){let t=it(e),r=t,n=r
return function(e){n=r,r=it(e)
const i=te(o,`${a.id}-vertical`),u=i?"y":"x"
if(l||(l=Math.abs(r[u]-t[u])>s),l){const e=n[u]-r[u]
o[i?"scrollTop":"scrollLeft"]+=e}}}(e),i)
Ge(document,[fe,ve],function(){u(),l&&setTimeout(Ge(o,"click",e=>e.preventDefault(),i))},{capture:!0,once:!0})}}],observe:[gn({options:{subtree:!0,childList:!0}}),fn({target:({$el:e})=>[e,...Me(e)]})],update:{read(){const e=[]
...
st(this.$el,{"--uk-overflow-fade-start-opacity":i(n),"--uk-overflow-fade-end-opacity":i(1-n)})}},events:["resize"]}}
var Ea={props:["width","height"],connected(){X(this.$el,"uk-responsive-width"),st(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},Ca={props:{offset:Number},data:{offset:0},connected(){(function(e){ka.size||Ge(document,"click",Oa)
ka.add(e)})(this)},disconnected(){var e
e=this,ka.delete(e),ka.size||Qe(document,"click",Oa)},methods:{async scrollTo(e){e=e&&It(e)||document.body,Ke(this.$el,"beforescroll",[this,e])&&(await Sr(e,{offset:this.offset}),Ke(this.$el,"scrolled",[this,e]))}}}
const ka=new Set
function Oa(e){if(!e.defaultPrevented)for(const t of ka)t.$el.contains(e.target)&&Ae(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(je(t.$el)))}const Ta="uk-scrollspy-inview"
var Sa={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?Dt(e,t):[t]},watch:{elements(e){this.hidden&&st(Te(e,`:not(.${Ta})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())J(e,Ta,t.cls||"")
...
if(!i)return
let o
if(null==(n=i.off)||n.call(i),st(e,"opacity",!t&&this.hidden?0:""),re(e,Ta,t),re(e,i.cls),o=i.cls.match(/\buk-animation-[\w-]+/g)){const r=()=>J(e,o)
...
r&&Ke(this.$el,"active",[e,t[e]])},events:["scroll","resize"]}]},Ma={mixins:[tn,bo],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&It(e,t)||t},connected(){this.start=Aa(this.start||this.top),this.end=Aa(this.end||this.bottom),this.placeholder=It("+ .uk-sticky-placeholder",this.$el)||It('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),J(this.target,this.clsInactive)),ja(this.$el),Tt(this.placeholder),this.placeholder=null},observe:[bn(),yn({target:()=>document.scrollingElement}),fn({target:({$el:e})=>[e,Da(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some(({target:e})=>e===Da(this.$el))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,async handler(){const{scrollingElement:e}=document
...
a&&(Ia(this.target),this.hide()),this.active||(({height:e,width:t}=Ft(this.$el)),r=st(this.$el,"margin")),a&&this.show()
...
bt.out(this.$el,this.animation).then(()=>this.hide(),q)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),bt.in(this.$el,this.animation).catch(q)):(Ia(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),J(this.$el,this.clsFixed,this.clsBelow),t?st(this.$el,"top",e):ja(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
...
this.active=e,e?(ee(this.target,this.clsInactive,this.clsActive),t!==e&&Ke(this.$el,"active")):(ee(this.target,this.clsActive,this.clsInactive),t!==e&&(Ia(this.target),Ke(this.$el,"inactive")))}}}
function Ra(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Gt(e,"height",t,!0)
{const r=!0===e?Da(t):Ne(e,t)
return Bt(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(st(r,"paddingBottom"))+R(st(r,"borderBottomWidth")):0)}}function Aa(e){return"true"===e||"false"!==e&&e}function ja(e){st(e,{position:"",top:"",marginTop:"",width:""})}const Na="uk-transition-disable"
async function Ia(e){te(e,Na)||(X(e,Na),await kn(),J(e,Na))}function Da(e){for(;e=Oe(e);)if(_e(e))return e}var La={mixins:[Us],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[gn({async handler(){const e=await this.svg
...
t&&st(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return yt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise(e=>Ze(this.$el,"load",e)),Ws(await Fa(this.src),this.icon)||Promise.reject("SVG not found.")}}}
...
ie(e,t,n)}e.ariaHidden=this.$el.ariaHidden,this.$el.id||se(e,"id")}const Fa=K(async e=>{if(e){const t=await fetch(e)
...
const e=this.index()
this.show(~e?e:this.next(this.active))}},connected(){this.$el.role="tablist"},observe:[vn({targets:({connectChildren:e})=>e}),wn({target:({connects:e})=>e,filter:({swiping:e})=>e})],events:[{name:"click keydown",delegate:({toggle:e})=>e,handler(e){Se(e.current,Ba)||"click"!==e.type&&e.keyCode!==Bn||(Ln(e),this.show(e.current))}},{name:"keydown",delegate:({toggle:e})=>e,handler(e){const{current:t,keyCode:r}=e,n=Se(this.$el,this.selVertical)
...
r.focus(),this.followFocus&&this.show(r)}}},{name:"click",el:({$el:e,connects:t,itemNav:r})=>t.concat(r?Ie(r,e):[]),delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){e.target.closest("a,button")&&(Ln(e),this.show(ae(e.current,this.attrItem)))}},{name:"swipeRight swipeLeft",filter:({swiping:e})=>e,el:({connects:e})=>e,handler({type:e}){this.show(u(e,"Left")?"next":"previous")}}],update(){var e
...
r.role="tab",n&&(r.id=eo(this,r),n.id=eo(this,n),r.ariaControls=n.id,ie(n,{role:"tabpanel","aria-labelledby":r.id}))}ie(this.$el,"aria-orientation",Se(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,e=>te(e,this.cls))},next(e,t=this.index()){if(O(e))for(let n=0;n<this.toggles.length;n++){let t=Z(n+ +e,this.toggles)
if(!Se(this.toggles[t],Ba))return t}const r=this.toggles.filter(e=>!Se(e,Ba))
return Z(r[Z(e,r,r.indexOf(this.toggles[t]))],this.toggles)},show(e){const t=this.index(),r=this.next(e)
this.children.forEach((e,t)=>{re(e,this.cls,r===t),ie(this.toggles[t],{"aria-selected":r===t,tabindex:r===t?null:-1})})
const n=t>=0&&t!==r
this.connects.forEach(async({children:e})=>{const t=p(e).filter((e,t)=>t!==r&&te(e,this.cls))
await this.toggleElement(t,!1,n)&&await this.toggleElement(e[r],!0,n)})}}},za={mixins:[tn],extends:Ha,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=te(this.$el,"uk-tab-left")?"uk-tab-left":!!te(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}}
var Ua={mixins:[bo,ai],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ie(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(ke(this.$el)||(this.$el.tabIndex=0),!this.cls&&yt(this.$el,"a")&&(this.$el.role="button"))},observe:vn({targets:({target:e})=>e}),events:[{name:he,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!nt(e)||E(this._showState)||this.$el.disabled||(Ke(this.$el,"focus"),Ze(document,he,()=>Ke(this.$el,"blur"),!0,e=>!this.$el.contains(e.target)),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`${me} ${ge} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(nt(e)||this.$el.disabled||"loading"===document.readyState)return
