...
var c=0
function d(e){return c--,e}i.Test?(i.Test.registerWaiter(function(){return 0===c}),t.default=function(){return c++,t.fetch.apply(e,arguments).then(function(e){return e.clone().blob().then(d,d),e},function(e){throw d(e),e})}):t.default=t.fetch,s.forEach(function(e){delete t[e]})})})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}/*! UIkit 3.25.21 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */
...
function r(t,r){return e.call(t,r)}const n=/\B([A-Z])/g,i=Z(e=>e.replace(n,"-$1").toLowerCase()),o=/-(\w)/g,s=Z(e=>(e.charAt(0).toLowerCase()+e.slice(1)).replace(o,(e,t)=>t.toUpperCase())),a=Z(e=>e.charAt(0).toUpperCase()+e.slice(1))
...
return!0}function F(e,t){return e.reduce((e,r)=>e+R(m(t)?t(r):r[t]),0)}function B(e,t){const r=new Set
return e.filter(({[t]:e})=>!r.has(e)&&r.add(e))}function H(e,t){return t.reduce((t,r)=>({...t,[r]:e[r]}),{})}function z(e,t=0,r=1){return Math.min(Math.max(M(e)||0,t),r)}function U(){}function q(...e){return[["bottom","top"],["right","left"]].every(([t,r])=>Math.min(...e.map(({[t]:e})=>e))-Math.max(...e.map(({[r]:e})=>e))>0)}function V(e,t){return e.x<=t.right&&e.x>=t.left&&e.y<=t.bottom&&e.y>=t.top}function W(e,t,r){const n="width"===t?"height":"width"
...
const{length:i}=t
return i?(e=O(e)?M(e):"next"===e?r+1:"previous"===e?r-1:"last"===e?i-1:t.indexOf(A(e)),n?z(e,0,i-1):(e%=i)<0?e+i:e):-1}function Z(e){const t=Object.create(null)
return(r,...n)=>t[r]||(t[r]=e(r,...n))}function K(e,...t){for(const r of j(e)){const e=re(t).filter(e=>!ee(r,e))
e.length&&r.classList.add(...e)}}function X(e,...t){for(const r of j(e)){const e=re(t).filter(e=>ee(r,e))
e.length&&r.classList.remove(...e)}}function J(e,t,r){r=re(r),X(e,t=re(t).filter(e=>!c(r,e))),K(e,r)}function ee(e,t){return[t]=re(t),j(e).some(e=>e.classList.contains(t))}function te(e,t,r){const n=re(t)
S(r)||(r=!!r)
for(const i of j(e))for(const e of n)i.classList.toggle(e,r)}function re(e){return e?h(e)?e.map(re).flat():String(e).split(" ").filter(Boolean):[]}function ne(e,t,r){var n
if(g(t))for(const i in t)ne(e,i,t[i])
else{if(S(r))return null==(n=A(e))?void 0:n.getAttribute(t)
for(const n of j(e))null===r?oe(n,t):n.setAttribute(t,r)}}function ie(e,t){return j(e).some(e=>e.hasAttribute(t))}function oe(e,t){j(e).forEach(e=>e.removeAttribute(t))}function se(e,t){for(const r of[t,`data-${t}`])if(ie(e,r))return ne(e,r)}const ae="undefined"!=typeof window,le=ae&&"rtl"===document.dir,ue=ae&&"ontouchstart"in window,ce=ae&&window.PointerEvent,de=ce?"pointerdown":ue?"touchstart":"mousedown",he=ce?"pointermove":ue?"touchmove":"mousemove",pe=ce?"pointerup":ue?"touchend":"mouseup",fe=ce?"pointerenter":ue?"":"mouseenter",me=ce?"pointerleave":ue?"":"mouseleave",ge=ce?"pointercancel":"touchcancel",ve={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0}
function be(e){return j(e).some(e=>ve[e.tagName.toLowerCase()])}const ye=ae&&Element.prototype.checkVisibility||function(){return this.offsetWidth||this.offsetHeight||this.getClientRects().length}
function we(e){return j(e).some(e=>ye.call(e))}const _e="input,select,textarea,button"
function xe(e){return j(e).some(e=>Te(e,_e))}const Ee=`${_e},a[href],[tabindex]`
function Ce(e){return Te(e,Ee)}function ke(e){var t
return null==(t=A(e))?void 0:t.parentElement}function Oe(e,t){return j(e).filter(e=>Te(e,t))}function Te(e,t){return j(e).some(e=>e.matches(t))}function Se(e,t){const r=[]
for(;e=ke(e);)t&&!Te(e,t)||r.push(e)
return r}function Pe(e,t){const r=(e=A(e))?p(e.children):[]
return t?Oe(r,t):r}function Me(e,t){return t?j(e).indexOf(A(t)):Pe(ke(e)).indexOf(e)}function Re(e){return(e=A(e))&&["origin","pathname","search"].every(t=>e[t]===location[t])}function Ae(e){if(Re(e)){const{hash:t,ownerDocument:r}=A(e),n=decodeURIComponent(t).slice(1)
return n?r.getElementById(n)||r.getElementsByName(n)[0]:r.documentElement}}function je(e,t){return Ie(e,Le(e,t))}function Ne(e,t){return De(e,Le(e,t))}function Ie(e,t){return A(Ue(e,A(t),"querySelector"))}function De(e,t){return j(Ue(e,A(t),"querySelectorAll"))}function Le(e,t=document){return y(t)||Be(e).isContextSelector?t:t.ownerDocument}const $e=/([!>+~-])(?=\s+[!>+~-]|\s*$)/g,Fe=/(\([^)]*\)|[^,])+/g,Be=Z(e=>{let t=!1
if(!e||!C(e))return{}
const r=[]
for(let n of e.match(Fe))n=n.trim().replace($e,"$1 *"),t||(t=["!","+","~","-",">"].includes(n[0])),r.push(n)
return{selector:r.join(","),selectors:r,isContextSelector:t}}),He=/(\([^)]*\)|\S)*/,ze=Z(e=>{e=e.slice(1).trim()
const[t]=e.match(He)
return[t,e.slice(t.length+1)]})
function Ue(e,t=document,r){var n
const i=Be(e)
if(!i.isContextSelector)return i.selector?qe(t,r,i.selector):e
e=""
const o=1===i.selectors.length
for(let s of i.selectors){let i,a=t
if("!"===s[0]&&([i,s]=ze(s),a=null==(n=t.parentElement)?void 0:n.closest(i),!s&&o))return a
if(a&&"-"===s[0]&&([i,s]=ze(s),a=a.previousElementSibling,a=Te(a,i)?a:null,!s&&o))return a
if(a){if(o)return"~"===s[0]||"+"===s[0]?(s=`:scope > :nth-child(${Me(a)+1}) ${s}`,a=a.parentElement):">"===s[0]&&(s=`:scope ${s}`),qe(a,r,s)
e+=`${e?",":""}${Ve(a)} ${s}`}}return y(t)||(t=t.ownerDocument),qe(t,r,e)}function qe(e,t,r){try{return e[t](r)}catch{return null}}function Ve(e){const t=[]
for(;e.parentNode;){const r=ne(e,"id")
if(r){t.unshift(`#${We(r)}`)
break}{let{tagName:r}=e
"HTML"!==r&&(r+=`:nth-child(${Me(e)+1})`),t.unshift(r),e=e.parentNode}}return t.join(" > ")}function We(e){return C(e)?CSS.escape(e):""}function Ye(...e){let[t,r,n,i,o=!1]=Xe(e)
i.length>1&&(i=function(e){return t=>h(t.detail)?e(t,...t.detail):e(t)}(i)),(null==o?void 0:o.self)&&(i=function(e){return function(t){if(t.target===t.currentTarget||t.target===t.current)return e.call(null,t)}}(i)),n&&(i=function(e,t){return r=>{const n=">"===e[0]?De(e,r.currentTarget).reverse().find(e=>e.contains(r.target)):r.target.closest(e)
n&&(r.current=n,t.call(this,r),delete r.current)}}(n,i))
for(const s of r)for(const e of t)e.addEventListener(s,i,o)
return()=>Ge(t,r,i,o)}function Ge(...e){let[t,r,,n,i=!1]=Xe(e)
for(const o of r)for(const e of t)e.removeEventListener(o,n,i)}function Qe(...e){const[t,r,n,i,o=!1,s]=Xe(e),a=Ye(t,r,n,e=>{const t=!s||s(e)
t&&(a(),i(e,t))},o)
return a}function Ze(e,t,r){return tt(e).map(e=>e.dispatchEvent(Ke(t,!0,!0,r))).every(e=>e)}function Ke(e,t=!0,r=!1,n){return C(e)&&(e=new CustomEvent(e,{bubbles:t,cancelable:r,detail:n})),e}function Xe(e){return e[0]=tt(e[0]),C(e[1])&&(e[1]=e[1].split(" ")),m(e[2])&&e.splice(2,0,!1),e}function Je(e){return e&&"addEventListener"in e}function et(e){return Je(e)?e:A(e)}function tt(e){return h(e)?e.map(et).filter(Boolean):C(e)?De(e):Je(e)?[e]:j(e)}function rt(e){return"touch"===e.pointerType||!!e.touches}function nt(e){var t,r
const{clientX:n,clientY:i}=(null==(t=e.touches)?void 0:t[0])||(null==(r=e.changedTouches)?void 0:r[0])||e
return{x:n,y:i}}const it={"animation-iteration-count":!0,"column-count":!0,"fill-opacity":!0,"flex-grow":!0,"flex-shrink":!0,"font-weight":!0,"line-height":!0,opacity:!0,order:!0,orphans:!0,"stroke-dasharray":!0,"stroke-dashoffset":!0,widows:!0,"z-index":!0,zoom:!0}
function ot(e,t,r,n){const i=j(e)
for(const o of i)if(C(t)){if(t=at(t),S(r))return getComputedStyle(o).getPropertyValue(t)
o.style.setProperty(t,!O(r)||it[t]||lt(t)?r||k(r)?r:"":`${r}px`,n)}else{if(h(t)){const e={}
for(const r of t)e[r]=ot(o,r)
return e}if(g(t))for(const e in t)ot(o,e,t[e],r)}return i[0]}function st(e,t){for(const r in t)ot(e,r,"")}const at=Z(e=>{if(lt(e))return e
e=i(e)
const{style:t}=document.documentElement
if(e in t)return e
for(const r of["webkit","moz"]){const n=`-${r}-${e}`
if(n in t)return n}})
function lt(e){return l(e,"--")}const ut="uk-transition",ct="transitionend",dt="transitioncanceled"
const ht={start:function(e,t,r=400,n="linear",i){return r=Math.round(r),Promise.all(j(e).map(e=>new Promise((o,s)=>{i||e.offsetHeight
const a=setTimeout(()=>Ze(e,ct),r)
Qe(e,[ct,dt],({type:t})=>{clearTimeout(a),X(e,ut),st(e,l),t===dt?s():o(e)},{self:!0}),K(e,ut)
const l={transitionProperty:Object.keys(t).map(at).join(","),transitionDuration:`${r}ms`,transitionTimingFunction:n}
ot(e,{...l,...t})})))},async stop(e){Ze(e,ct),await Promise.resolve()},async cancel(e){Ze(e,dt),await Promise.resolve()},inProgress:e=>ee(e,ut)},pt="uk-animation",ft="animationend",mt="animationcanceled"
function gt(e,t,r=200,n,i){return Promise.all(j(e).map(e=>new Promise((o,s)=>{ee(e,pt)&&Ze(e,mt)
const a=[t,pt,`${pt}-${i?"leave":"enter"}`,n&&`uk-transform-origin-${n}`,i&&`${pt}-reverse`],l=setTimeout(()=>Ze(e,ft),r)
Qe(e,[ft,mt],({type:t})=>{clearTimeout(l),t===mt?s():o(e),ot(e,"animationDuration",""),X(e,a)},{self:!0}),ot(e,"animationDuration",`${r}ms`),K(e,a)})))}const vt={in:gt,out:(e,t,r,n)=>gt(e,t,r,n,!0),inProgress:e=>ee(e,pt),cancel(e){Ze(e,mt)}}
function bt(e,...t){return t.some(t=>{var r
return(null==(r=null==e?void 0:e.tagName)?void 0:r.toLowerCase())===t.toLowerCase()})}function yt(e){return(e=Nt(e))&&(e.innerHTML=""),e}function wt(e,t){return S(t)?Nt(e).innerHTML:xt(yt(e),t)}const _t=kt("prepend"),xt=kt("append"),Et=kt("before"),Ct=kt("after")
function kt(e){return function(t,r){var n
const i=j(C(r)?Rt(r):r)
return null==(n=Nt(t))||n[e](...i),At(i)}}function Ot(e){j(e).forEach(e=>e.remove())}function Tt(e,t){for(t=A(Et(e,t));t.firstElementChild;)t=t.firstElementChild
return xt(t,e),t}function St(e,t){return j(j(e).map(e=>e.hasChildNodes()?Tt(p(e.childNodes),t):xt(e,t)))}function Pt(e){j(e).map(ke).filter((e,t,r)=>r.indexOf(e)===t).forEach(e=>e.replaceWith(...e.childNodes))}const Mt=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
function Rt(e){const t=Mt.exec(e)
if(t)return document.createElement(t[1])
const r=document.createElement("template")
return r.innerHTML=e.trim(),At(r.content.childNodes)}function At(e){return e.length>1?e:e[0]}function jt(e,t){if(_(e))for(t(e),e=e.firstElementChild;e;)jt(e,t),e=e.nextElementSibling}function Nt(e,t){return Dt(e)?A(Rt(e)):Ie(e,t)}function It(e,t){return Dt(e)?j(Rt(e)):De(e,t)}function Dt(e){return C(e)&&l(e.trim(),"<")}const Lt={width:["left","right"],height:["top","bottom"]}
function $t(e){const t=_(e)?A(e).getBoundingClientRect():{height:zt(e),width:Ut(e),top:0,left:0}
return{height:t.height,width:t.width,top:t.top,left:t.left,bottom:t.top+t.height,right:t.left+t.width}}function Ft(e,t){t&&ot(e,{left:0,top:0})
const r=$t(e)
if(e){const{scrollY:t,scrollX:n}=N(e),i={height:t,width:n}
for(const e in Lt)for(const t of Lt[e])r[t]+=i[e]}if(!t)return r
for(const n of["left","top"])ot(e,n,t[n]-r[n])}function Bt(e){let{top:t,left:r}=Ft(e)
const{ownerDocument:{body:n,documentElement:i},offsetParent:o}=A(e)
let s=o||i
for(;s&&(s===n||s===i)&&"static"===ot(s,"position");)s=s.parentNode
if(_(s)){const e=Ft(s)
t-=e.top+R(ot(s,"borderTopWidth")),r-=e.left+R(ot(s,"borderLeftWidth"))}return{top:t-R(ot(e,"marginTop")),left:r-R(ot(e,"marginLeft"))}}function Ht(e){const t=[(e=A(e)).offsetTop,e.offsetLeft]
for(;e=e.offsetParent;)if(t[0]+=e.offsetTop+R(ot(e,"borderTopWidth")),t[1]+=e.offsetLeft+R(ot(e,"borderLeftWidth")),"fixed"===ot(e,"position")){const r=N(e)
return t[0]+=r.scrollY,t[1]+=r.scrollX,t}return t}const zt=qt("height"),Ut=qt("width")
function qt(e){const t=a(e)
return(r,n)=>{if(S(n)){if(b(r))return r[`inner${t}`]
if(y(r)){const e=r.documentElement
return Math.max(e[`offset${t}`],e[`scroll${t}`])}return(n="auto"===(n=ot(r=A(r),e))?r[`offset${t}`]:R(n)||0)-Vt(r,e)}return ot(r,e,n||0===n?+n+Vt(r,e)+"px":"")}}function Vt(e,t,r="border-box"){return ot(e,"boxSizing")===r?F(Lt[t],t=>R(ot(e,`padding-${t}`))+R(ot(e,`border-${t}-width`))):0}function Wt(e){for(const t in Lt)for(const r in Lt[t])if(Lt[t][r]===e)return Lt[t][1-r]
return e}function Yt(e,t="width",r=window,n=!1){return C(e)?F(Qt(e),e=>{const i=Kt(e)
return i?function(e,t){return e*R(t)/100}("vh"===i?function(){if(Xt)return Xt
Jt||(Jt=Nt("<div>"),ot(Jt,{height:"100vh",position:"fixed"}),Ye(window,"resize",()=>Xt=null))
return xt(document.body,Jt),Xt=Jt.clientHeight,Ot(Jt),Xt}():"vw"===i?Ut(N(r)):n?r[`offset${a(t)}`]:$t(r)[t],e):e}):R(e)}const Gt=/-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,Qt=Z(e=>e.toString().replace(/\s/g,"").match(Gt)||[]),Zt=/(?:v[hw]|%)$/,Kt=Z(e=>(e.match(Zt)||[])[0])
let Xt,Jt
const er={read:function(e){return tr.push(e),or(),e},write:function(e){return rr.push(e),or(),e},clear:function(e){ar(tr,e),ar(rr,e)},flush:ir},tr=[],rr=[]
let nr=!1
function ir(){sr(tr),sr(rr.splice(0)),nr=!1,(tr.length||rr.length)&&or()}function or(){nr||(nr=!0,queueMicrotask(ir))}function sr(e){let t
for(;t=e.shift();)try{t()}catch(r){console.error(r)}}function ar(e,t){const r=e.indexOf(t)
return~r&&e.splice(r,1)}class lr{init(){let e
this.positions=[],this.unbind=Ye(document,"mousemove",t=>e=nt(t)),this.interval=setInterval(()=>{e&&(this.positions.push(e),this.positions.length>5&&this.positions.shift())},50)}cancel(){var e
null==(e=this.unbind)||e.call(this),clearInterval(this.interval)}movesTo(e){if(!this.positions||this.positions.length<2)return!1
const t=$t(e),{left:r,right:n,top:i,bottom:o}=t,[s]=this.positions,a=L(this.positions),l=[s,a]
if(V(a,t))return!1
...
return r&&V(r,t)})}}function ur(e,t,r={},{intersecting:n=!0}={}){const i=new IntersectionObserver(n?(e,r)=>{e.some(e=>e.isIntersecting)&&t(e,r)}:t,r)
for(const o of j(e))i.observe(o)
return i}const cr=ae&&window.ResizeObserver
function dr(e,t,r={box:"border-box"}){if(cr)return fr(ResizeObserver,e,t,r)
const n=[Ye(window,"load resize",t),Ye(document,"loadedmetadata load",t,!0)]
return{disconnect:()=>n.map(e=>e())}}function hr(e){return{disconnect:Ye([window,window.visualViewport],"resize",e)}}function pr(e,t,r){return fr(MutationObserver,e,t,r)}function fr(e,t,r,n){const i=new e(r)
for(const o of j(t))i.observe(o,n)
return i}function mr(e){yr(e)&&xr(e,{func:"playVideo",method:"play"}),br(e)&&e.play().catch(U)}function gr(e){yr(e)&&e[Cr]&&xr(e,{func:"pauseVideo",method:"pause"}),br(e)&&e.pause()}function vr(e){yr(e)&&xr(e,{func:"mute",method:"setVolume",value:0}),br(e)&&(e.muted=!0)}function br(e){return bt(e,"video")}function yr(e){return bt(e,"iframe")&&(wr(e)||_r(e))}function wr(e){return!!e.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)}function _r(e){return!!e.src.match(/vimeo\.com\/video\/.*/)}async function xr(e,t){await function(e){if(e[Cr])return e[Cr]
const t=wr(e),r=_r(e),n=++kr
let i
return e[Cr]=new Promise(o=>{t&&Qe(e,"load",()=>{const t=()=>Er(e,{event:"listening",id:n})
...
let kr=0
function Or(e,t=0,r=0){return!!we(e)&&q(...Rr(e).map(e=>{const{top:n,left:i,bottom:o,right:s}=Ar(e)
return{top:n-t,left:i-r,bottom:o+t,right:s+r}}).concat(Ft(e)))}function Tr(e,{offset:t=0}={}){const r=we(e)?Pr(e,!1,["hidden"]):[]
return r.reduce((n,i,o)=>{const{scrollTop:s,scrollHeight:a,offsetHeight:l}=i,u=Ar(i),c=a-u.height,{height:d,top:h}=r[o-1]?Ar(r[o-1]):Ft(e)
...
var l
const u=Date.now(),c=Dr(e)===e,d=Ft(n).top+(c?0:s)
let h=0,p=15;(function l(){const f=(m=z((Date.now()-u)/a),.5*(1-Math.cos(Math.PI*m)))
var m
let g=0
r[0]===e&&s+t<i&&(g=Ft(n).top+(c?0:e.scrollTop)-d-$t(jr(n)).height),"auto"!==ot(e,"scrollBehavior")&&ot(e,"scrollBehavior","auto"),e.scrollTop=s+(t+g)*f,ot(e,"scrollBehavior",""),1!==f||h!==g&&p--?(h=g,requestAnimationFrame(l)):o()})()})}(i,p-s,e,c).then(n)},()=>Promise.resolve())()}function Sr(e,t=0,r=0){if(!we(e))return 0
const n=Mr(e,!0),{scrollHeight:i,scrollTop:o}=n,{height:s}=Ar(n),a=i-s,l=Ht(e)[0]-Ht(n)[0],u=Math.max(0,l-s+t),c=Math.min(a,l+e.offsetHeight-r)
return u<c?z((o-u)/(c-u)):1}function Pr(e,t=!1,r=[]){const n=Dr(e)
let i=Se(e).reverse()
i=i.slice(i.indexOf(n)+1)
const o=d(i,e=>Ir(e,"fixed"))
return~o&&(i=i.slice(o)),[n].concat(i.filter(e=>ot(e,"overflow").split(" ").some(e=>c(["auto","scroll",...r],e))&&(!t||e.scrollHeight>Ar(e).height))).reverse()}function Mr(...e){return Pr(...e)[0]}function Rr(e){return Pr(e,!1,["hidden","clip"])}function Ar(e){const t=N(e),r=Dr(e),n=!w(e)||e.contains(r)
if(n&&t.visualViewport){let{height:e,width:r,scale:n,pageTop:i,pageLeft:o}=t.visualViewport
return e=Math.round(e*n),r=Math.round(r*n),{height:e,width:r,top:i,left:o,bottom:i+e,right:o+r}}let i=Ft(n?t:e)
if("inline"===ot(e,"display"))return i
...
i[d]+=R(ot(l,`border-${d}-width`)),i[u]=i[c]=l[`client${a(u)}`]-(e?e<.5?-e:1-e:0),i[h]=i[u]+i[d]}return i}function jr(e){const{document:t}=N(e)
e=e||t.body
const{left:r,width:n,top:i}=$t(e)
for(const o of i?[0,i]:[0]){let i
for(const s of t.elementsFromPoint(r+n/2,o))s.contains(e)||ee(s,"uk-togglable-leave")||!(Ir(s,"fixed")&&Nr(Se(e).reverse().find(e=>!e.contains(s)&&!Ir(e,"static")))<Nr(s)||Ir(s,"sticky")&&(!e||ke(s).contains(e)))||i&&!($t(i).height<$t(s).height)||(i=s)
if(i)return i}}function Nr(e){return R(ot(e,"zIndex"))}function Ir(e,t){return ot(e,"position")===t}function Dr(e){return N(e).document.scrollingElement}const Lr=[["width","x","left","right"],["height","y","top","bottom"]]
function $r(e,t,r){r={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],placement:[],...r},h(t)||(t=[t,t]),Ft(e,Fr(e,t,r))}function Fr(e,t,r){const n=Br(e,t,r),{boundary:i,viewportOffset:o=0,placement:s}=r
let a=n
...
continue}}else if("shift"===s[l]){const e=Ft(t[l]),{offset:i}=r
p=z(z(n[c],h[c],h[d]-n[u]),e[c]-n[u]+i[l],e[d]-i[l])-n[c]}a=Hr(a,p,l)}return a}function Br(e,t,r){let{attach:n,offset:i}={attach:{element:["left","top"],target:["left","top"],...r.attach},offset:[0,0],...r},o=Ft(e)
for(const[s,[a,,l,u]]of Object.entries(Lr)){const e=n.target[s]===n.element[s]?Ar(t[s]):Ft(t[s])
...
return r&&(o[Lr[i][2]]+=r,o[Lr[i][3]]-=r),n&&(o=Wr(o,Ft(h(n)?n[i]:n))),o}function qr(e,t,r,n){const[i,o,s,l]=Lr[n],[u]=Vr(e,t),c=Ar(u)
return["auto","scroll"].includes(ot(u,`overflow-${o}`))&&(c[s]-=u[`scroll${a(s)}`],c[l]=c[s]+u[`scroll${a(i)}`]),c[s]+=r,c[l]-=r,c}function Vr(e,t){return Rr(t).filter(t=>t.contains(e))}function Wr(...e){let t={}
for(const r of e)for(const[,,e,n]of Lr)t[e]=Math.max(t[e]||0,r[e]),t[n]=Math.min(...[t[n],r[n]].filter(k))
...
if(~r)return Lr[1-t][r%2+2]}}function Xr(e,t){return(e=[...e])[t]*=-1,e}var Jr=Object.freeze({__proto__:null,$:Nt,$$:It,Animation:vt,Dimensions:G,MouseTracker:lr,Transition:ht,addClass:K,after:Ct,append:xt,apply:jt,assign:f,attr:ne,before:Et,boxModelAdjust:Vt,camelize:s,children:Pe,clamp:z,createEvent:Ke,css:ot,data:se,dimensions:$t,each:$,empty:yt,endsWith:u,escape:We,fastdom:er,filter:Oe,find:Ie,findAll:De,findIndex:d,flipPosition:Wt,fragment:Rt,getCoveringElement:jr,getEventPos:nt,getIndex:Q,getTargetedElement:Ae,hasAttr:ie,hasClass:ee,hasOwn:r,hasTouch:ue,height:zt,html:wt,hyphenate:i,inBrowser:ae,includes:c,index:Me,intersectRect:q,isArray:h,isBoolean:E,isDocument:y,isElement:_,isEmpty:T,isEqual:I,isFocusable:Ce,isFunction:m,isInView:Or,isInput:xe,isNode:w,isNumber:k,isNumeric:O,isObject:g,isPlainObject:v,isRtl:le,isSameSiteAnchor:Re,isString:C,isTag:bt,isTouch:rt,isUndefined:S,isVisible:we,isVoidElement:be,isWindow:b,last:L,matches:Te,memoize:Z,mute:vr,noop:U,observeIntersection:ur,observeMutation:pr,observeResize:dr,observeViewportResize:hr,off:Ge,offset:Ft,offsetPosition:Ht,offsetViewport:Ar,on:Ye,once:Qe,overflowParents:Rr,parent:ke,parents:Se,pause:gr,pick:H,play:mr,pointInRect:V,pointerCancel:ge,pointerDown:de,pointerEnter:fe,pointerLeave:me,pointerMove:he,pointerUp:pe,position:Bt,positionAt:$r,prepend:_t,propName:at,query:je,queryAll:Ne,ready:function(e){"loading"===document.readyState?Qe(document,"DOMContentLoaded",e):e()},remove:Ot,removeAttr:oe,removeClass:X,replaceClass:J,resetProps:st,scrollIntoView:Tr,scrollParent:Mr,scrollParents:Pr,scrolledOver:Sr,selFocusable:Ee,selInput:_e,sortBy:function(e,t){return e.slice().sort(({[t]:e=0},{[t]:r=0})=>e>r?1:r>e?-1:0)},startsWith:l,sumBy:F,swap:D,toArray:p,toBoolean:P,toEventTargets:tt,toFloat:R,toNode:A,toNodes:j,toNumber:M,toPx:Yt,toWindow:N,toggleClass:te,trigger:Ze,ucfirst:a,uniqueBy:B,unwrap:Pt,width:Ut,wrapAll:Tt,wrapInner:St}),en={connected(){this._cmpCls=ee(this.$el,this.$options.id),K(this.$el,this.$options.id)},disconnected(){this._cmpCls||X(this.$el,this.$options.id)}}
const tn=["days","hours","minutes","seconds"]
var rn={mixins:[en],props:{date:String,clsWrapper:String,role:String,reload:Boolean},data:{date:"",clsWrapper:".uk-countdown-%unit%",role:"timer",reload:!1},connected(){this.$el.role=this.role,this.date=R(Date.parse(this.$props.date)),this.started=this.end=!1,this.start()},disconnected(){this.stop()},events:{name:"visibilitychange",el:()=>document,handler(){document.hidden?this.stop():this.start()}},methods:{start(){this.stop(),this.update()},stop(){this.timer&&(clearInterval(this.timer),Ze(this.$el,"countdownstop"),this.timer=null)},update(){const e=function(e){const t=Math.max(0,e-Date.now())/1e3
return{total:t,seconds:t%60,minutes:t/60%60,hours:t/60/60%24,days:t/60/60/24}}(this.date)
e.total?this.timer||(this.started=!0,this.timer=setInterval(this.update,1e3),Ze(this.$el,"countdownstart")):(this.stop(),this.end||(Ze(this.$el,"countdownend"),this.end=!0,this.reload&&this.started&&window.location.reload()))
for(const t of tn){const r=Nt(this.clsWrapper.replace("%unit%",t),this.$el)
if(!r)continue
let n=Math.trunc(e[t]).toString().padStart(2,"0")
r.textContent!==n&&(n=n.split(""),n.length!==r.children.length&&wt(r,n.map(()=>"<span></span>").join("")),n.forEach((e,t)=>r.children[t].textContent=e))}}}}
const nn={}
...
return r&&!S(n)&&(e[r.trim()]=n.trim()),e},{}):{}}catch{return{}}}function cn(e,t){return e===Boolean?P(t):e===Number?M(t):"list"===e?function(e){return h(e)?e:C(e)?e.split(dn).map(e=>O(e)?M(e):P(e.trim())):[e]}(t):e===Object&&C(t)?un(t):e?e(t):t}nn.events=nn.watch=nn.observe=nn.created=nn.beforeConnect=nn.connected=nn.beforeDisconnect=nn.disconnected=nn.destroy=sn,nn.args=function(e,t){return!1!==t&&sn(t||e)},nn.update=function(e,t){return sn(e,m(t)?{read:t}:t)},nn.props=function(e,t){if(h(t)){const e={}
...
const dn=/,(?![^(]*\))/
function hn(e,t="update"){e._connected&&e._updates.length&&(e._updateCount||(e._updateCount=0,requestAnimationFrame(()=>e._updateCount=0)),e._queued||(e._queued=new Set,er.read(()=>{e._connected&&function(e,t){for(const{read:r,write:n,events:i=[]}of e._updates){if(!t.has("update")&&!i.some(e=>t.has(e)))continue
let o
r&&(o=r.call(e,e._data,t),o&&v(o)&&f(e._data,o)),n&&!1!==o&&er.write(()=>{e._connected&&n.call(e,e._data,t)})}}(e,e._queued),e._queued=null})),e._updateCount++<20&&e._queued.add(t.type||t))}function pn(e){return wn(dr,e,"resize")}function fn(e){return wn(ur,e)}function mn(e){return wn(pr,e)}function gn(e={}){return fn({handler:function(t,r){const{targets:n=this.$el,preload:i=5}=e
for(const e of j(m(n)?n(this):n))It('[loading="lazy"]',e).slice(0,i-1).forEach(e=>oe(e,"loading"))
for(const e of t.filter(({isIntersecting:e})=>e).map(({target:e})=>e))r.unobserve(e)},...e})}function vn(e){return wn((e,t)=>hr(t),e,"resize")}function bn(e){return wn((e,t)=>{return{disconnect:Ye((r=e,j(r).map(e=>{const{ownerDocument:t}=e,r=Mr(e,!0)
return r===t.scrollingElement?t:r})),"scroll",t,{passive:!0})}
var r},e,"scroll")}function yn(e){return{observe:(e,t)=>({observe:U,unobserve:U,disconnect:Ye(e,de,t,{passive:!0})}),handler(e){if(!rt(e))return
const t=nt(e),r="tagName"in e.target?e.target:ke(e.target)
Qe(document,`${pe} ${ge} scroll`,e=>{const{x:n,y:i}=nt(e);("scroll"!==e.type&&r&&n&&Math.abs(t.x-n)>100||i&&Math.abs(t.y-i)>100)&&setTimeout(()=>{var e,o,s,a
Ze(r,"swipe"),Ze(r,"swipe"+(e=t.x,o=t.y,s=n,a=i,Math.abs(e-s)>=Math.abs(o-a)?e-s>0?"Left":"Right":o-a>0?"Up":"Down"))})})},...e}}function wn(e,t,r){return{observe:e,handler(){hn(this,r)},...t}}var _n={props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},observe:[mn({options:{childList:!0}}),mn({options:{attributes:!0,attributeFilter:["style"]}}),pn({handler(e){for(const{target:t,borderBoxSize:[{inlineSize:r,blockSize:n}]}of e)if(t===this.$el&&!r&&!n)return
this.$emit("resize")},target:({$el:e})=>[e,...Pe(e)]})],update:{read(){return{rows:xn(Pe(this.$el))}},write({rows:e}){for(const t of e)for(const r of t)te(r,this.margin,e[0]!==t),te(r,this.firstColumn,t[le?t.length-1:0]===r)},events:["resize"]}}
function xn(e){const t=[[]],r=e.some((t,r)=>r&&e[r-1].offsetParent!==t.offsetParent)
for(const n of e){if(!we(n))continue
const e=En(n,r)
...
return t&&([r,n]=Ht(e)),{top:r,left:n,bottom:r+i,right:n+o}}function Cn(){return new Promise(e=>requestAnimationFrame(e))}function kn(e){return new Promise(t=>setTimeout(t,e))}const On="uk-transition-leave",Tn="uk-transition-enter"
function Sn(e,t,r,n=0){const i=Pn(t,!0),o={opacity:1},s={opacity:0},a=()=>i===Pn(t),l=e=>()=>a()?e():Promise.reject(),u=l(async()=>{K(t,On),await(n?Rn(t).reduce(async(e,t,i,o)=>{if(await e,!Or(t)||!a())return void ot(t,s)
await kn(n)
const l=ht.start(t,s,r/2,"ease")
o.length-1===i&&await l},Promise.resolve()):ht.start(t,s,r/2,"ease")),X(t,On)}),c=l(async()=>{const i=zt(t)
K(t,Tn),e(),ot(n?Pe(t):t,s),zt(t,i),await kn(),zt(t,"")
const l=zt(t)
ot(t,"alignContent","flex-start"),zt(t,i)
let u=[],c=r/2
if(n){const e=Rn(t)
ot(Pe(t),s),u=e.reduce(async(e,t,i,s)=>{if(await e,!Or(t)||!a())return void st(t,o)
await kn(n)
const l=ht.start(t,o,r/2,"ease").then(()=>a()&&st(t,o))
s.length-1===i&&await l},Promise.resolve()),c+=e.length*n}if(!n||i!==l){const e={height:l,...n?{}:o}
u.push(ht.start(t,e,c,"ease"))}await Promise.all(u),X(t,Tn),a()&&(st(t,{height:"",alignContent:"",...o}),delete t.dataset.transition)})
return ee(t,On)?Mn(t).then(c):ee(t,Tn)?Mn(t).then(u).then(c):u().then(c)}function Pn(e,t){return t&&(e.dataset.transition=1+Pn(e)),M(e.dataset.transition)||0}function Mn(e){return Promise.all(Pe(e).filter(ht.inProgress).map(e=>new Promise(t=>Qe(e,"transitionend transitioncanceled",t))))}function Rn(e){return xn(Pe(e)).flat().filter(we)}async function An(e,t,r){await Cn()
let n=Pe(t)
const i=n.map(e=>jn(e,!0)),o={...ot(t,["height","padding"]),display:"block"},s=n.filter(e=>Or(e)),a=n.concat(t)
await Promise.all(a.map(ht.cancel)),ot(a,"transitionProperty","none"),await e()
const l=Pe(t).filter(e=>!c(n,e))
n=n.concat(l),await Promise.resolve(),ot(a,"transitionProperty","")
const u=ne(t,"style"),d=ot(t,["height","padding"]),[h,p]=function(e,t,r){const n=t.map((e,t)=>!(!ke(e)||!(t in r))&&(r[t]?we(e)?Nn(e):{opacity:0}:{opacity:we(e)?1:0})),i=n.map((n,i)=>{const o=ke(t[i])===e&&(r[i]||jn(t[i]))
if(!o)return!1
if(n){if(!("opacity"in n)){const{opacity:e}=o
e%1?n.opacity=1:delete o.opacity}}else delete o.opacity
return o})
return[n,i]}(t,n,i),f=n.map(e=>({style:ne(e,"style")}))
s.push(...n.filter(e=>Or(e))),n.forEach((e,t)=>p[t]&&ot(e,p[t])),ot(t,o),Ze(t,"scroll"),await Cn()
const m=n.map((e,n)=>{if(ke(e)===t&&s.includes(e))return ht.start(e,h[n],r,"ease",!l.includes(e))}).concat(ht.start(t,d,r,"ease",!0))
try{await Promise.all(m),n.forEach((e,r)=>{ne(e,f[r]),ke(e)===t&&ot(e,"display",0===h[r].opacity?"none":"")}),ne(t,"style",u)}catch{ne(n,"style",""),st(t,o)}}function jn(e,t){const r=ot(e,"zIndex")
return!!we(e)&&{display:"",opacity:t?ot(e,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===r?Me(e):r,...Nn(e)}}function Nn(e){const{height:t,width:r}=$t(e)
return{height:t,width:r,transform:"",...Bt(e),...ot(e,["marginTop","marginLeft"])}}var In={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(e,t=this.$el){const r=this.animation
return("fade"===r?Sn:"delayed-fade"===r?(...e)=>Sn(...e,40):r?An:()=>(e(),Promise.resolve()))(e,t,this.duration).catch(U)}}}
function Dn(e){e.target.closest('a[href="#"],a[href=""]')&&e.preventDefault()}const Ln=9,$n=13,Fn=27,Bn=32,Hn=35,zn=36,Un=37,qn=38,Vn=39,Wn=40
var Yn={mixins:[In],args:"target",props:{target:String,selActive:Boolean},data:{target:"",selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{children:({target:e},t)=>It(`${e} > *`,t),toggles:({attrItem:e},t)=>It(`[${e}],[data-${e}]`,t)},watch:{toggles(e){this.updateState()
const t=It(this.selActive,this.$el)
for(const r of e){!1!==this.selActive&&te(r,this.cls,c(t,r))
const e=Kn(r)
bt(e,"a")&&(e.role="button")}},children(e,t){t&&this.updateState()}},events:{name:"click keydown",delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){"keydown"===e.type&&e.keyCode!==Bn||e.target.closest("a,button")&&(Dn(e),this.apply(e.current))}},methods:{apply(e){const t=this.getState(),r=Qn(e,this.attrItem,this.getState())
var n,i
n=t,i=r,["filter","sort"].every(e=>I(n[e],i[e]))||this.setState(r)},getState(){return this.toggles.filter(e=>ee(e,this.cls)).reduce((e,t)=>Qn(t,this.attrItem,e),{filter:{"":""},sort:[]})},async setState(e,t=!0){e={filter:{"":""},sort:[],...e},Ze(this.$el,"beforeFilter",[this,e])
for(const r of this.toggles)te(r,this.cls,Zn(r,this.attrItem,e))
await Promise.all(It(this.target,this.$el).map(r=>{const n=()=>function(e,t,r){for(const o of r)ot(o,"display",Object.values(e.filter).every(e=>!e||Te(o,e))?"":"none")
const[n,i]=e.sort
if(n){const e=function(e,t,r){return[...e].sort((e,n)=>{const i=se(e,t)||"",o=se(n,t)||""
return(O(i)&&O(o)?i-o:i.localeCompare(o,void 0,{numeric:!0}))*("asc"===r||-1)})}(r,n,i)
I(e,r)||xt(t,e)}}(e,r,Pe(r))
return t?this.animate(n,r):n()})),Ze(this.$el,"afterFilter",[this])},updateState(){er.write(()=>this.setState(this.getState(),!1))}}}
function Gn(e,t){return un(se(e,t),["filter"])}function Qn(e,t,r){const{filter:n,group:i,sort:o,order:s="asc"}=Gn(e,t)
return(n||S(o))&&(i?n?(delete r.filter[""],r.filter[i]=n):(delete r.filter[i],(T(r.filter)||""in r.filter)&&(r.filter={"":n||""})):r.filter={"":n||""}),S(o)||(r.sort=[o,s]),r}function Zn(e,t,{filter:r={"":""},sort:[n,i]}){const{filter:o="",group:s="",sort:a,order:l="asc"}=Gn(e,t),u=!s&&o===r[""],c=s in r&&o===r[s],d=!o&&s&&!(s in r)&&!r[""],h=u||c||d
if(S(a))return h
return n===a&&i===l&&(!(o||s)||h)}function Kn(e){return Nt("a,button",e)||e}var Xn={args:"dataSrc",props:{dataSrc:String,sources:String,margin:String,target:String,loading:String},data:{dataSrc:"",sources:!1,margin:"50%",target:!1,loading:"lazy"},connected(){"lazy"!==this.loading?this.load():ni(this.$el)&&(this.$el.loading="lazy",Jn(this.$el))},disconnected(){this.img&&(this.img.onload=""),delete this.img},observe:fn({handler(e,t){this.load(),t.disconnect()},options:({margin:e})=>({rootMargin:e}),filter:({loading:e})=>"lazy"===e,target:({$el:e,$props:t})=>t.target?[e,...Ne(t.target,e)]:e}),methods:{load(){if(this.img)return this.img
...
return oe(e,"loading"),Jn(this.$el,e.currentSrc),this.img=e}}}
function Jn(e,t){if(ni(e)){const t=ke(e);(bt(t,"picture")?Pe(t):[e]).forEach(e=>ti(e,e))}else if(t){!c(e.style.backgroundImage,t)&&(ot(e,"backgroundImage",`url(${We(t)})`),Ze(e,Ke("load",!1)))}}const ei=["data-src","data-srcset","sizes"]
function ti(e,t){for(const r of ei){const n=se(e,r)
n&&ne(t,r.replace(/data-/g,""),n)}}function ri(e,t){if((t=function(e){if(!e)return[]
if(l(e,"["))try{e=JSON.parse(e)}catch{e=[]}else e=un(e)
h(e)||(e=[e])
return e.filter(e=>!T(e))}(t)).length){const r=Rt("<picture>")
for(const e of t){const t=Rt("<source>")
ne(t,e),xt(r,t)}xt(r,e)}}function ni(e){return bt(e,"img")}let ii
function oi(e){const t=Ye(e,"touchstart",t=>{if(1!==t.targetTouches.length||Te(t.target,'input[type="range"]'))return
let r=nt(t).y
const n=Ye(e,"touchmove",t=>{const n=nt(t).y
...
Qe(e,"scroll touchend touchcancel",n,{capture:!0})},{passive:!0})
if(ii)return t
ii=!0
const{scrollingElement:r}=document,n={overflowY:CSS.supports("overflow","clip")?"clip":"hidden",touchAction:"none",scrollbarGutter:Ut(window)-r.clientWidth?"stable":""}
return ot(r,n),()=>{ii=!1,t(),st(r,n)}}var si={props:{container:Boolean},data:{container:!0},computed:{container({container:e}){return!0===e&&this.$container||e&&Nt(e)}}},ai={props:{cls:Boolean,animation:"list",duration:Number,velocity:Number,origin:String,transition:String},data:{cls:!1,animation:[!1],duration:200,velocity:.2,origin:!1,transition:"ease",clsEnter:"uk-togglable-enter",clsLeave:"uk-togglable-leave"},computed:{hasAnimation:({animation:e})=>!!e[0],hasTransition:({animation:e})=>["slide","reveal"].some(t=>l(e[0],t))},methods:{async toggleElement(e,t,r){const n={}
return(await Promise.all(j(e).map(e=>{const i=E(t)?t:!this.isToggled(e)
if(!Ze(e,"before"+(i?"show":"hide"),[this]))return n
const o=(m(r)?r:!1!==r&&this.hasAnimation?this.hasTransition?ui:ci:li)(e,i,this),s=i?this.clsEnter:this.clsLeave
K(e,s),Ze(e,i?"show":"hide",[this])
const a=()=>{var t
X(e,s),Ze(e,i?"shown":"hidden",[this]),i&&(null==(t=It("[autofocus]",e).find(we))||t.focus({preventScroll:!0}))}
return o?o.then(a,()=>(X(e,s),n)):a()}))).every(e=>e!==n)},isToggled(e=this.$el){return!!ee(e=A(e),this.clsEnter)||!ee(e,this.clsLeave)&&(this.cls?ee(e,this.cls.split(" ")[0]):we(e))},_toggle(e,t){if(!e)return
let r
t=Boolean(t),this.cls?(r=c(this.cls," ")||t!==ee(e,this.cls),r&&te(e,this.cls,c(this.cls," ")?void 0:t)):(r=t===e.hidden,r&&(e.hidden=!t)),r&&Ze(e,"toggled",[t,this])}}}
function li(e,t,{_toggle:r}){return vt.cancel(e),ht.cancel(e),r(e,t)}async function ui(e,t,{animation:r,duration:n,velocity:i,transition:o,_toggle:s}){var a
...
let v=$t(e)[f]
const b=ht.inProgress(e)
await ht.cancel(e),t&&s(e,!0)
const y=Object.fromEntries(["padding","border","width","height","minWidth","minHeight","overflowY","overflowX",m,g].map(t=>[t,e.style[t]])),w=$t(e),_=R(ot(e,m)),x=R(ot(e,g)),E=w[f]+x
b||t||(v+=x)
const[C]=St(e,"<div>")
ot(C,{boxSizing:"border-box",height:w.height,width:w.width,...ot(e,["overflow","padding","borderTop","borderRight","borderBottom","borderLeft","borderImage",g])}),ot(e,{padding:0,border:0,minWidth:0,minHeight:0,[g]:0,width:w.width,height:w.height,overflow:"hidden",[f]:v})
const k=v/E
n=(i*E+n)*(t?1-k:k)
const O={[f]:t?E:0}
p&&(ot(e,m,E-v+_),O[m]=t?_:E+_),!p^"reveal"===l&&(ot(C,m,-E+v),ht.start(C,{[m]:t?0:-E},n,o))
try{await ht.start(e,O,n,o)}finally{ot(e,y),Pt(C.firstChild),t||s(e,!1)}}function ci(e,t,r){const{animation:n,duration:i,_toggle:o}=r
return t?(o(e,!0),vt.in(e,n[0],i,r.origin)):vt.out(e,n[1]||n[0],i,r.origin).then(()=>o(e,!1))}const di=[]
var hi={mixins:[en,si,ai],props:{selPanel:String,selClose:String,escClose:Boolean,bgClose:Boolean,stack:Boolean,role:String},data:{cls:"uk-open",escClose:!0,bgClose:!0,overlay:!0,stack:!1,role:"dialog"},computed:{panel:({selPanel:e},t)=>Nt(e,t),transitionElement(){return this.panel}},connected(){const e=this.panel||this.$el
e.role=this.role,this.overlay&&(e.ariaModal=!0)},beforeDisconnect(){c(di,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate:({selClose:e})=>`${e},a[href*="#"]`,handler(e){const{current:t,defaultPrevented:r}=e,{hash:n}=t
!r&&n&&Re(t)&&!this.$el.contains(Nt(n))?this.hide():Te(t,this.selClose)&&(Dn(e),this.hide())}},{name:"toggle",self:!0,handler(e,t){e.defaultPrevented||(e.preventDefault(),this.target=null==t?void 0:t.$el,this.isToggled()===c(di,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(e){if(c(di,this))return!1
!this.stack&&di.length?(Promise.all(di.map(e=>e.hide())).then(this.show),e.preventDefault()):di.push(this)}},{name:"show",self:!0,handler(){this.stack&&ot(this.$el,"zIndex",R(ot(this.$el,"zIndex"))+di.length)
const e=[this.overlay&&fi(this),this.overlay&&oi(this.$el),this.bgClose&&mi(this),this.escClose&&gi(this)]
Qe(this.$el,"hidden",()=>e.forEach(e=>e&&e()),{self:!0}),K(document.documentElement,this.clsPage),vi(this.target,!0)}},{name:"shown",self:!0,handler(){Ce(this.$el)||(this.$el.tabIndex=-1),Te(this.$el,":focus-within")||this.$el.focus()}},{name:"hidden",self:!0,handler(){c(di,this)&&di.splice(di.indexOf(this),1),ot(this.$el,"zIndex","")
const{target:e}=this
di.some(e=>e.clsPage===this.clsPage)||(X(document.documentElement,this.clsPage),queueMicrotask(()=>{Ce(e)&&e.focus({preventScroll:!0})})),vi(e,!1),this.target=null}}],methods:{toggle(){return this.isToggled()?this.hide():this.show()},async show(){return this.container&&ke(this.$el)!==this.container&&(xt(this.container,this.$el),await Cn()),this.toggleElement(this.$el,!0,pi)},hide(){return this.toggleElement(this.$el,!1,pi)}}}
function pi(e,t,{transitionElement:r,_toggle:n}){return new Promise((i,o)=>Qe(e,"show hide",()=>{var s
null==(s=e._reject)||s.call(e),e._reject=o,n(e,t)
const a=Qe(r,"transitionstart",()=>{Qe(r,"transitionend transitioncancel",i,{self:!0}),clearTimeout(l)},{self:!0}),l=setTimeout(()=>{a(),i()},(c=ot(r,"transitionDuration"))?u(c,"ms")?R(c):1e3*R(c):0)
var c})).then(()=>delete e._reject)}function fi(e){return Ye(document,"focusin",t=>{if(L(di)!==e||e.$el.contains(t.target))return
const{left:r,top:n,width:i,height:o}=$t(t.target),s=document.elementFromPoint(r+i/2,n+o/2)
s&&(t.target.contains(s)||s.contains(t.target))||e.$el.focus()})}function mi(e){return Ye(document,de,({target:t})=>{L(di)!==e||e.overlay&&!e.$el.contains(t)||!e.panel||e.panel.contains(t)||Qe(document,`${pe} ${ge} scroll`,({defaultPrevented:r,type:n,target:i})=>{r||n!==pe||t!==i||e.hide()},!0)})}function gi(e){return Ye(document,"keydown",t=>{27===t.keyCode&&L(di)===e&&e.hide()})}function vi(e,t){(null==e?void 0:e.ariaExpanded)&&(e.ariaExpanded=t)}var bi={slide:{show:e=>[{transform:wi(-100*e)},{transform:wi()}],percent:e=>yi(e),translate:(e,t)=>[{transform:wi(-100*t*e)},{transform:wi(100*t*(1-e))}]}}
function yi(e){return Math.abs(new DOMMatrix(ot(e,"transform")).m41/e.offsetWidth)}function wi(e=0,t="%"){return e?`translate3d(${e+t}, 0, 0)`:""}function _i(e,t,r){Ze(e,Ke(t,!1,!1,r))}function xi(){let e
return{promise:new Promise(t=>e=t),resolve:e}}var Ei={props:{i18n:Object},data:{i18n:null},methods:{t(e,...t){var r,n,i
let o=0
return(null==(i=(null==(r=this.i18n)?void 0:r[e])||(null==(n=this.$options.i18n)?void 0:n[e]))?void 0:i.replace(/%s/g,()=>t[o++]||""))||""}}},Ci={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){ne(this.list,"aria-live",this.autoplay?"off":"polite"),this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){ne(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter:({autoplay:e})=>e,handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval(()=>{this.stack.length||!we(this.$el)||this.draggable&&Te(this.$el,":focus-within")&&!Te(this.$el,":focus")||this.pauseOnHover&&Te(this.$el,":hover")||this.show("next")},this.autoplayInterval)},stopAutoplay(){clearInterval(this.interval)}}}
const ki={passive:!1,capture:!0},Oi="touchmove mousemove"
var Ti={props:{draggable:Boolean},data:{draggable:!0,threshold:10,angleThreshold:45},created(){for(const e of["start","move","end"]){const t=this[e]
this[e]=e=>{const r=nt(e)
le&&(r.x=-r.x),this.prevPos=I(r,this.pos)?this.prevPos:this.pos,this.pos=r,t(e)}}},events:[{name:"touchstart mousedown",passive:!0,delegate:({selList:e})=>`${e} > *`,handler(e){var t
!this.draggable||this.parallax||!rt(e)&&(t=e.target,"none"!==ot(t,"userSelect")&&p(t.childNodes).some(e=>3===e.nodeType&&e.textContent.trim()))||e.target.closest(_e)||e.button>0||this.length<2||this.start(e)}},{name:"dragstart",handler(e){e.preventDefault()}},{name:Oi,el:({list:e})=>e,handler:U,...ki}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag.x+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ye(document,Oi,this.move,ki),Ye(document,"touchend touchcancel mouseup click input scroll",this.end,{passive:!0,capture:!0,once:!0}),ot(this.list,"userSelect","none")},move(e){const t=this.pos.x-this.drag.x
if(0===t||!this.dragging&&(r=this.pos,n=this.drag,180*Math.atan2(Math.abs(n.y-r.y),Math.abs(n.x-r.x))/Math.PI>this.angleThreshold)||this.prevPos.x===this.pos.x||!this.dragging&&Math.abs(t)<this.threshold)return
var r,n
e.cancelable&&e.preventDefault(),this.dragging=!0,this.dir=t<0?1:-1
let{slides:i,prevIndex:o}=this,s=Math.abs(t),a=this.getIndex(o+this.dir),l=Si.call(this,o,a)
for(;a!==o&&s>l;)this.drag.x-=l*this.dir,o=a,s-=l,a=this.getIndex(o+this.dir),l=Si.call(this,o,a)
this.percent=s/l
const u=i[o],d=i[a],h=this.index!==a,p=o===a
let f
for(const m of[this.index,this.prevIndex])c([a,o],m)||(Ze(i[m],"itemhidden",[this]),p&&(f=!0,this.prevIndex=o));(this.index===o&&this.prevIndex!==o||f)&&Ze(i[this.index],"itemshown",[this]),h&&(this.prevIndex=o,this.index=a,p||(Ze(u,"beforeitemhide",[this]),Ze(u,"itemhide",[this])),Ze(d,"beforeitemshow",[this]),Ze(d,"itemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),u,!p&&d)},end(){if(Ge(document,Oi,this.move,ki),this.dragging)if(setTimeout(Ye(this.list,"click",e=>e.preventDefault(),ki)),this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const e=this.dir<0==this.prevPos.x>this.pos.x
e?(Ze(this.slides[this.prevIndex],"itemhidden",[this]),Ze(this.slides[this.index],"itemshown",[this]),this.percent=1-this.percent):this.index=this.prevIndex,this.show(this.dir>0&&!e||this.dir<0&&e?"next":"previous",!0)}ot(this.list,{userSelect:""}),this.drag=this.percent=null}}}
function Si(e,t){return this._getTransitioner(e,e!==t&&t).getDistance()||this.slides[e].offsetWidth}function Pi(e,t,r){e._watches.push({name:r,...v(t)?t:{handler:t}})}const Mi={subtree:!0,childList:!0}
function Ri(e,t,n){e._hasComputed=!0,Object.defineProperty(e,t,{enumerable:!0,get(){const{_computed:i,$props:o,$el:s}=e
if(!r(i,t)&&(i[t]=(n.get||n).call(e,o,s),n.observe&&e._computedObserver)){const t=n.observe.call(e,o)
e._computedObserver.observe(["~","+","-"].includes(t[0])?s.parentElement:s.getRootNode(),Mi)}return i[t]},set(r){const{_computed:i}=e
i[t]=n.set?n.set.call(e,r):r,S(i[t])&&delete i[t]}})}function Ai(e){e._hasComputed&&(function(e,t){e._updates.unshift(t)}(e,{read:()=>function(e,t){for(const{name:n,handler:i,immediate:o=!0}of e._watches)(e._initial&&o||r(t,n)&&!I(t[n],e[n]))&&i.call(e,e[n],t[n])
e._initial=!1}(e,ji(e)),events:["resize","computed"]}),e._computedObserver=pr(e.$el,()=>hn(e,"computed"),Mi),e._disconnect.push(()=>{e._computedObserver.disconnect(),e._computedObserver=null,ji(e)}))}function ji(e){const t={...e._computed}
return e._computed={},t}function Ni(e,{name:t,el:r,handler:n,capture:i,passive:o,delegate:s,filter:a,self:l}){a&&!a.call(e,e)||e._disconnect.push(Ye(r?r.call(e,e):e.$el,t,null==s?void 0:s.call(e,e),n.bind(e),{passive:o,capture:i,self:l}))}function Ii(e,t){let{observe:n,target:i=e.$el,handler:o,options:s,filter:a,args:l}=t
if(a&&!a.call(e,e))return
const u=`_observe${e._disconnect.length}`
m(i)&&!r(e,u)&&Ri(e,u,()=>{const t=i.call(e,e)
return h(t)?j(t):t}),o=C(o)?e[o]:o.bind(e),m(s)&&(s=s.call(e,e))
const c=n(r(e,u)?e[u]:i,o,s,l)
m(i)&&h(e[u])&&Pi(e,{handler:Di(c,s),immediate:!1},u),e._disconnect.push(()=>c.disconnect())}function Di(e,t){return(r,n)=>{for(const t of n)c(r,t)||(e.unobserve?e.unobserve(t):e.observe&&e.disconnect())
for(const i of r)c(n,i)&&e.unobserve||e.observe(i,t)}}function Li(e){const t={},{args:r=[],props:n={},el:o,id:a}=e
if(!n)return t
for(const s in n){const e=i(s)
let r=se(o,e)
S(r)||(r=n[s]===Boolean&&""===r||cn(n[s],r),"target"===e&&l(r,"_")||(t[s]=r))}const u=un(se(o,a),r)
for(const i in u){const e=s(i)
S(n[e])||(t[e]=cn(n[e],u[i]))}return t}const $i=Z((e,t)=>{const r=Object.keys(t),n=r.concat(e).map(e=>[i(e),`data-${i(e)}`]).flat()
return{attributes:r,filter:n}})
function Fi(e,t){var r
null==(r=e.$options[t])||r.forEach(t=>t.call(e))}function Bi(e){e._connected||(function(e){const{$options:t,$props:n}=e,i=Li(t)
f(n,i)
const{computed:o,methods:s}=t
for(let a in n)!(a in i)||o&&r(o,a)||s&&r(s,a)||(e[a]=n[a])}(e),Fi(e,"beforeConnect"),e._connected=!0,e._disconnect=[],function(e){for(const t of e.$options.events||[])if(r(t,"handler"))Ni(e,t)
else for(const r in t)Ni(e,{name:r,handler:t[r]})}(e),function(e){e._data={},e._updates=[...e.$options.update||[]],e._disconnect.push(()=>e._updates=e._data=null)}(e),function(e){e._watches=[]
for(const t of e.$options.watch||[])for(const[r,n]of Object.entries(t))Pi(e,n,r)
e._initial=!0}(e),function(e){for(const t of e.$options.observe||[])Ii(e,t)}(e),function(e){const{$options:t,$props:r}=e,{id:n,props:i,el:o}=t
if(!i)return
const{attributes:a,filter:l}=$i(n,i),u=new MutationObserver(i=>{const o=Li(t)
i.some(({attributeName:e})=>{const t=e.replace("data-","")
return(t===n?a:[s(t),s(e)]).some(e=>!S(o[e])&&o[e]!==r[e])})&&e.$reset()})
u.observe(o,{attributes:!0,attributeFilter:l}),e._disconnect.push(()=>u.disconnect())}(e),Ai(e),Fi(e,"connected"),hn(e))}function Hi(e){e._connected&&(Fi(e,"beforeDisconnect"),e._disconnect.forEach(e=>e()),e._disconnect=null,Fi(e,"disconnected"),e._connected=!1)}let zi=0
function Ui(e,t={}){t.data=function({data:e={}},{args:t=[],props:r={}}){h(e)&&(e=e.slice(0,t.length).reduce((e,r,n)=>(v(r)?f(e,r):e[t[n]]=r,e),{}))
for(const n in e)S(e[n])?delete e[n]:r[n]&&(e[n]=cn(r[n],e[n]))
return e}(t,e.constructor.options),e.$options=ln(e.constructor.options,t,e),e.$props={},e._uid=zi++,function(e){const{data:t={}}=e.$options
...
if(e._computed={},t)for(const r in t)Ri(e,r,t[r])}(e),Fi(e,"created"),t.el&&e.$mount(t.el)}const qi=function(e){Ui(this,e)}
qi.util=Jr,qi.options={},qi.version="3.25.21"
const Vi="__uikit__",Wi={}
function Yi(e,t){var r,n
const o="uk-"+i(e)
if(!t)return Wi[o].options||(Wi[o]=qi.extend(Wi[o])),Wi[o]
e=s(e),qi[e]=(t,r)=>Gi(e,t,r)
const a=null!=(r=t.options)?r:{...t}
return a.id=o,a.name=e,null==(n=a.install)||n.call(a,qi,a,e),qi._initialized&&!a.functional&&requestAnimationFrame(()=>Gi(e,`[${o}],[data-${o}]`)),Wi[o]=a}function Gi(e,t,r,...n){const i=Yi(e)
return i.options.functional?new i({data:v(t)?t:[t,r,...n]}):t?It(t).map(o)[0]:o()
function o(t){const n=Zi(t,e)
if(n){if(!r)return n
n.$destroy()}return new i({el:t,data:r})}}function Qi(e){return(null==e?void 0:e[Vi])||{}}function Zi(e,t){return Qi(e)[t]}function Ki(e,t){e=e?A(e):document.body
for(const r of Se(e).reverse())Xi(r,t)
jt(e,e=>Xi(e,t))}function Xi(e,t){const r=Qi(e)
for(const n in r)hn(r[n],t)}let Ji=1
function eo(e,t=null){return(null==t?void 0:t.id)||`${e.$options.id}-${Ji++}`}var to={i18n:{next:"Next slide",previous:"Previous slide",slideX:"Slide %s",slideLabel:"%s of %s"},data:{selNav:!1,role:"region"},computed:{nav:({selNav:e},t)=>It(e,t),navChildren(){return this.nav.map(e=>Pe(e)).flat()},selNavItem:({attrItem:e})=>`[${e}],[data-${e}]`,navItems(e,t){return It(this.selNavItem,t)}},watch:{nav(e,t){ne(e,"role","tablist"),this.padNavitems(),t&&this.$emit()},list(e){bt(e,"ul")&&ne(e,"role","presentation")},navChildren(e){ne(e,"role","presentation"),this.padNavitems(),this.updateNav()},navItems(e){for(const t of e){const e=se(t,this.attrItem),r=Nt("a,button",t)||t
let n,i=null
if(O(e)){const t=M(e),o=this.slides[t]
o&&(o.id||(o.id=eo(this,o)),i=o.id),n=this.t("slideX",R(e)+1),r.role="tab"}else this.list&&(this.list.id||(this.list.id=eo(this,this.list)),i=this.list.id),n=this.t(e)
ne(r,"aria-controls",i),r.ariaLabel=r.ariaLabel||n}},slides(e){e.forEach((e,t)=>ne(e,{role:this.nav.length?"tabpanel":"group","aria-label":this.t("slideLabel",t+1,this.length),"aria-roledescription":this.nav.length?null:"slide"})),this.padNavitems()}},connected(){this.$el.role=this.role,this.$el.ariaRoleDescription="carousel"},update:[{write(){this.navItems.concat(this.nav).forEach(e=>e&&(e.hidden=this.maxIndex<1)),this.updateNav()},events:["resize"]}],events:[{name:"click keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){!e.target.closest("a,button")||"click"!==e.type&&e.keyCode!==Bn||(Dn(e),this.show(se(e.current,this.attrItem)))}},{name:"itemshow",handler(){this.updateNav()}},{name:"keydown",delegate:({selNavItem:e})=>e,filter:({parallax:e})=>!e,handler(e){const{current:t,keyCode:r}=e
if(!O(se(t,this.attrItem)))return
...
for(const t of this.navItems){const r=se(t,this.attrItem),n=Nt("a,button",t)||t
if(O(r)){const i=M(r)===e
te(t,this.clsActive,i),te(n,"uk-disabled",!!this.parallax),n.ariaSelected=i,n.tabIndex=i&&!this.parallax?null:-1,i&&n&&Te(ke(t),":focus-within")&&n.focus()}else te(t,"uk-invisible",this.finite&&("previous"===r&&0===e||"next"===r&&e>=this.maxIndex))}},padNavitems(){for(const e of this.nav){const t=Pe(e),r=[]
for(let e=0;e<this.length;e++){const n=`${this.attrItem}="${e}"`
r[e]=t.findLast(e=>e.matches(`[${n}]`))||Nt(`<li ${n}><a href></a></li>`)}I(r,t)||wt(e,r)}}}}
var ro={mixins:[Ci,Ti,to,Ei],props:{clsActivated:String,easing:String,index:Number,finite:Boolean,velocity:Number},data:()=>({easing:"ease",finite:!1,velocity:1,index:0,prevIndex:-1,stack:[],percent:0,clsActive:"uk-active",clsActivated:"",clsEnter:"uk-slide-enter",clsLeave:"uk-slide-leave",clsSlideActive:"uk-slide-active",Transitioner:!1,transitionOptions:{}}),connected(){this.prevIndex=-1,this.index=this.getValidIndex(this.$props.index),this.stack=[]},disconnected(){X(this.slides,this.clsActive)},computed:{duration:({velocity:e},t)=>no(t.offsetWidth/e),list:({selList:e},t)=>Nt(e,t),maxIndex(){return this.length-1},slides(){return Pe(this.list)},length(){return this.slides.length}},watch:{slides(e,t){t&&this.$emit()}},events:{itemshow({target:e}){K(e,this.clsEnter,this.clsSlideActive)},itemshown({target:e}){X(e,this.clsEnter)},itemhide({target:e}){K(e,this.clsLeave)},itemhidden({target:e}){X(e,this.clsLeave,this.clsSlideActive)}},methods:{async show(e,t=!1){var r
...
const s=this.getIndex(this.index),a=ee(this.slides,this.clsActive)&&this.slides[s],l=this.getIndex(e,this.index),u=this.slides[l]
...
a&&Ze(a,"itemhide",[this]),Ze(u,"itemshow",[this]),await this._show(a,u,t),a&&Ze(a,"itemhidden",[this]),Ze(u,"itemshown",[this]),n.shift(),this._transitioner=null,await Cn(),n.length&&this.show(n.shift(),!0)}else o()},getIndex(e=this.index,t=this.index){return z(Q(e,this.slides,t,this.finite),0,Math.max(0,this.maxIndex))},getValidIndex(e=this.index,t=this.prevIndex){return this.getIndex(e,t)},async _show(e,t,r){if(this._transitioner=this._getTransitioner(e,t,this.dir,{easing:r?t.offsetWidth<600?"cubic-bezier(0.25, 0.46, 0.45, 0.94)":"cubic-bezier(0.165, 0.84, 0.44, 1)":this.easing,...this.transitionOptions}),!r&&!e)return void this._translate(1)
...
return n.translate(e),n},_getTransitioner(e=this.prevIndex,t=this.index,r=this.dir||1,n=this.transitionOptions){return new this.Transitioner(k(e)?this.slides[e]:e,k(t)?this.slides[t]:t,r*(le?-1:1),n)}}}
function no(e){return.5*e+300}var io={mixins:[ro],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:bi,Transitioner:function(e,t,r,{animation:n,easing:i}){const{percent:o,translate:s,show:a=U}=n,l=a(r),{promise:u,resolve:c}=xi()
return{dir:r,show(n,o=0,s){const a=s?"linear":i
return n-=Math.round(n*z(o,-1,1)),this.translate(o),_i(t,"itemin",{percent:o,duration:n,timing:a,dir:r}),_i(e,"itemout",{percent:1-o,duration:n,timing:a,dir:r}),Promise.all([ht.start(t,l[1],n,a),ht.start(e,l[0],n,a)]).then(()=>{this.reset(),c()},U),u},cancel:()=>ht.cancel([t,e]),reset(){st([t,e],l[0])},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){this.reset()
const i=s(n,r)
ot(t,i[1]),ot(e,i[0]),_i(t,"itemtranslatein",{percent:n,dir:r}),_i(e,"itemtranslateout",{percent:1-n,dir:r})},percent:()=>o(e||t,t,r),getDistance:()=>null==e?void 0:e.offsetWidth}}},computed:{animation:({animation:e,Animations:t})=>({...t[e]||t.slide,name:e}),transitionOptions(){return{animation:this.animation}}},observe:pn(),events:{itemshow({target:e}){K(e,this.clsActive)},itemshown({target:e}){K(e,this.clsActivated)},itemhidden({target:e}){X(e,this.clsActive,this.clsActivated)}}},oo={...bi,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:e=>1-ot(e,"opacity"),translate:e=>[{opacity:1-e,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:so(1.5),zIndex:0},{zIndex:-1}],percent:e=>1-ot(e,"opacity"),translate:e=>[{opacity:1-e,transform:so(1+.5*e),zIndex:0},{zIndex:-1}]},pull:{show:e=>e<0?[{transform:wi(30),zIndex:-1},{transform:wi(),zIndex:0}]:[{transform:wi(-100),zIndex:0},{transform:wi(),zIndex:-1}],percent:(e,t,r)=>r<0?1-yi(t):yi(e),translate:(e,t)=>t<0?[{transform:wi(30*e),zIndex:-1},{transform:wi(-100*(1-e)),zIndex:0}]:[{transform:wi(100*-e),zIndex:0},{transform:wi(30*(1-e)),zIndex:-1}]},push:{show:e=>e<0?[{transform:wi(100),zIndex:0},{transform:wi(),zIndex:-1}]:[{transform:wi(-30),zIndex:-1},{transform:wi(),zIndex:0}],percent:(e,t,r)=>r>0?1-yi(t):yi(e),translate:(e,t)=>t<0?[{transform:wi(100*e),zIndex:0},{transform:wi(-30*(1-e)),zIndex:-1}]:[{transform:wi(-30*e),zIndex:-1},{transform:wi(100*(1-e)),zIndex:0}]}}
function so(e){return`scale3d(${e}, ${e}, 1)`}var ao={...bi,fade:{show:()=>[{opacity:0},{opacity:1}],percent:e=>1-ot(e,"opacity"),translate:e=>[{opacity:1-e},{opacity:e}]},scale:{show:()=>[{opacity:0,transform:so(.8)},{opacity:1,transform:so(1)}],percent:e=>1-ot(e,"opacity"),translate:e=>[{opacity:1-e,transform:so(1-.2*e)},{opacity:e,transform:so(.8+.2*e)}]}},lo={i18n:{counter:"%s / %s"},mixins:[hi,io],functional:!0,props:{counter:Boolean,preload:Number,nav:Boolean,slidenav:Boolean,delayControls:Number,videoAutoplay:Boolean,template:String},data:()=>({counter:!1,preload:1,nav:!1,slidenav:!0,delayControls:3e3,videoAutoplay:!1,items:[],cls:"uk-open",clsPage:"uk-lightbox-page",clsFit:"uk-lightbox-items-fit",clsZoom:"uk-lightbox-zoom",attrItem:"uk-lightbox-item",selList:".uk-lightbox-items",selClose:".uk-close-large",selNav:".uk-lightbox-thumbnav, .uk-lightbox-dotnav",selCaption:".uk-lightbox-caption",selCounter:".uk-lightbox-counter",pauseOnHover:!1,velocity:2,Animations:ao,template:'<div class="uk-lightbox uk-overflow-hidden">  <div class="uk-lightbox-items"></div>  <div class="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse>  <button class="uk-lightbox-close uk-close-large" type="button" uk-close></button>  </div>  <div class="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse>  <a href uk-slidenav-previous uk-lightbox-item="previous"></a>  </div>  <div class="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse>  <a href uk-slidenav-next uk-lightbox-item="next"></a>  </div>  <div class="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;">  <ul class="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul>  <ul class="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul>  </div>  <div class="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div>  <div class="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div>  </div>'}),created(){let e=Nt(this.template)
bt(e,"template")&&(e=Rt(wt(e)))
const t=Nt(this.selList,e),r=this.$props.nav
Ot(It(this.selNav,e).filter(e=>!Te(e,`.uk-${r}`)))
for(const[o,s]of this.items.entries())xt(t,"<div>"),"thumbnav"===r&&Tt(co(s,this.videoAutoplay),xt(Nt(this.selNav,e),`<li uk-lightbox-item="${o}"><a href></a></li>`))
this.slidenav||Ot(It(".uk-lightbox-slidenav",e)),this.counter||Ot(Nt(this.selCounter,e)),K(t,this.clsFit)
const n=Nt("[uk-close]",e),i=this.t("close")
n&&i&&(n.dataset.i18n=JSON.stringify({label:i})),this.$mount(xt(this.container,e))},events:[{name:"click",self:!0,filter:({bgClose:e})=>e,delegate:({selList:e})=>`${e} > *`,handler(e){e.defaultPrevented||this.hide()}},{name:"click",self:!0,delegate:({clsZoom:e})=>`.${e}`,handler(e){e.defaultPrevented||te(this.list,this.clsFit)}},{name:`${he} ${de} keydown`,filter:({delayControls:e})=>e,handler(){this.showControls()}},{name:"shown",self:!0,handler(){this.showControls()}},{name:"hide",self:!0,handler(){this.hideControls(),X(this.slides,this.clsActive),ht.stop(this.slides)}},{name:"hidden",self:!0,handler(){this.$destroy(!0)}},{name:"keyup",el:()=>document,handler({keyCode:e}){if(!this.isToggled()||!this.draggable)return
let t=-1
e===Un?t="previous":e===Vn?t="next":e===zn?t=0:e===Hn&&(t="last"),~t&&this.show(t)}},{name:"beforeitemshow",handler(e){wt(Nt(this.selCaption,this.$el),this.getItem().caption||""),wt(Nt(this.selCounter,this.$el),this.t("counter",this.index+1,this.slides.length))
for(let t=-this.preload;t<=this.preload;t++)this.loadItem(this.index+t)
this.isToggled()||(this.draggable=!1,e.preventDefault(),this.toggleElement(this.$el,!0,!1),this.animation=ao.scale,X(e.target,this.clsActive),this.stack.splice(1,0,this.index))}},{name:"itemshown",handler(){this.draggable=this.$props.draggable}},{name:"itemload",async handler(e,t){const{source:r,type:n,attrs:i={}}=t
...
if("image"===n||ho(r)){const e=uo("img")
ri(e,t.sources),ne(e,{src:r,...H(t,["alt","srcset","sizes"]),...i}),Ye(e,"load",()=>this.setItem(t,ke(e)||e)),Ye(e,"error",()=>this.setError(t))}else if("video"===n||po(r)){const e="inline"===this.videoAutoplay,n=uo("video",{src:r,playsinline:"",controls:e?null:"",loop:e?"":null,muted:e?"":null,poster:this.videoAutoplay?null:t.poster,"uk-video":Boolean(this.videoAutoplay),...i})
Ye(n,"loadedmetadata",()=>this.setItem(t,n)),Ye(n,"error",()=>this.setError(t))}else if("iframe"===n||r.match(/\.(html|php)($|\?)/i))this.setItem(t,uo("iframe",{src:r,allowfullscreen:"",class:"uk-lightbox-iframe",...i}))
else if(o=r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))this.setItem(t,uo("iframe",{src:`https://www.youtube${o[1]||""}.com/embed/${o[2]}${o[3]?`?${o[3]}`:""}`,width:1920,height:1080,...s,...i}))
...
this.setItem(t,uo("iframe",{src:`https://player.vimeo.com/video/${o[1]}${o[2]?`?${o[2]}`:""}`,width:n,height:e,...s,...i}))}catch{this.setError(t)}}},{name:"itemloaded",handler(){this.$emit("resize")}}],update:{read(){for(const e of It(`${this.selList} :not([controls]):is(img,video)`,this.$el))te(e,this.clsZoom,(e.naturalHeight||e.videoHeight)-this.$el.offsetHeight>Math.max(0,(e.naturalWidth||e.videoWidth)-this.$el.offsetWidth))},events:["resize"]},methods:{loadItem(e=this.index){const t=this.getItem(e)
this.getSlide(t).childElementCount||Ze(this.$el,"itemload",[t])},getItem(e=this.index){return this.items[Q(e,this.slides)]},setItem(e,t){Ze(this.$el,"itemloaded",[this,wt(this.getSlide(e),t)])},getSlide(e){return this.slides[this.items.indexOf(e)]},setError(e){this.setItem(e,'<span uk-icon="icon: bolt; ratio: 2" uk-inverse></span>')},showControls(){clearTimeout(this.controlsTimer),this.controlsTimer=this.delayControls&&setTimeout(this.hideControls,this.delayControls),K(this.$el,"uk-active","uk-transition-active")},hideControls(){X(this.$el,"uk-active","uk-transition-active")}}}
function uo(e,t){const r=Rt(`<${e}>`)
return ne(r,t),r}function co(e,t){const r=e.poster||e.thumb&&("image"===e.type||ho(e.thumb))?uo("img",{src:e.poster||e.thumb,alt:""}):e.thumb&&("video"===e.type||po(e.thumb))?uo("video",{src:e.thumb,loop:"",playsinline:"",muted:"","uk-video":"inline"===t}):uo("canvas")
return e.thumbRatio&&(r.style.aspectRatio=e.thumbRatio),r}function ho(e){return null==e?void 0:e.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)}function po(e){return null==e?void 0:e.match(/\.(mp4|webm|ogv)($|\?)/i)}var fo={install:function(e,t){e.lightboxPanel||e.component("lightboxPanel",lo)
f(t.props,e.component("lightboxPanel").options.props)},props:{toggle:String},data:{toggle:"a"},computed:{toggles:({toggle:e},t)=>It(e,t)},watch:{toggles(e){this.hide()
for(const t of e)bt(t,"a")&&(t.role="button")}},disconnected(){this.hide()},events:{name:"click",delegate:({toggle:e})=>e,handler(e){e.defaultPrevented||(e.preventDefault(),Te(e.current,".uk-disabled *, .uk-disabled, [disabled]")||this.show(e.current))}},methods:{show(e){let t=this.toggles.map(go)
if("thumbnav"===this.nav&&mo.call(this,this.toggles,t),t=B(t,"source"),_(e)){const{source:r}=go(e)
e=d(t,({source:e})=>r===e)}return this.panel=this.panel||this.$create("lightboxPanel",{...this.$props,items:t}),Ye(this.panel.$el,"hidden",()=>this.panel=null),this.panel.show(e)},hide(){var e
return null==(e=this.panel)?void 0:e.hide()}}}
function mo(e,t){for(const[r,n]of Object.entries(e)){if(t[r].thumb)continue
const e=Se(n).reverse().concat(n).find(e=>this.$el.contains(e)&&(e===n||1===It(this.toggle,e).length))
if(!e)continue
const i=Nt("img,video",e)
i&&(t[r].thumb=i.currentSrc||i.poster||i.src,t[r].thumbRatio=(i.naturalWidth||i.videoWidth)/(i.naturalHeight||i.videoHeight))}}function go(e){const t={}
for(const r of e.getAttributeNames()){const n=r.replace(/^data-/,"")
t["href"===n?"source":n]=e.getAttribute(r)}return t.attrs=un(t.attrs),t}var vo={mixins:[si],functional:!0,args:["message","status"],data:{message:"",status:"",timeout:5e3,group:"",pos:"top-center",clsContainer:"uk-notification",clsClose:"uk-notification-close",clsMsg:"uk-notification-message"},install:function(e){e.notification.closeAll=function(t,r){jt(document.body,n=>{const i=e.getComponent(n,"notification")
!i||t&&t!==i.group||i.close(r)})}},computed:{marginProp:({pos:e})=>`margin-${e.match(/[a-z]+(?=-)/)[0]}`,startProps(){return{opacity:0,[this.marginProp]:-this.$el.offsetHeight}}},created(){const e=`${this.clsContainer}-${this.pos}`,t=`data-${this.clsContainer}-container`,r=Nt(`.${e}[${t}]`,this.container)||xt(this.container,`<div class="${this.clsContainer} ${e}" ${t}></div>`)
this.$mount(xt(r,`<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert">  <a href class="${this.clsClose}" data-uk-close></a>  <div>${this.message}</div>  </div>`))},async connected(){const e=R(ot(this.$el,this.marginProp))
await ht.start(ot(this.$el,this.startProps),{opacity:1,[this.marginProp]:e}),this.timeout&&(this.timer=setTimeout(this.close,this.timeout))},events:{click(e){Dn(e),this.close()},[fe](){this.timer&&clearTimeout(this.timer)},[me](){this.timeout&&(this.timer=setTimeout(this.close,this.timeout))}},methods:{async close(e){this.timer&&clearTimeout(this.timer),e||await ht.start(this.$el,this.startProps),(e=>{const t=ke(e)
Ze(e,"close",[this]),Ot(e),(null==t?void 0:t.hasChildNodes())||Ot(t)})(this.$el)}}}
var bo={props:{media:Boolean},data:{media:!1},connected(){const e=function(e,t){if(C(e))if(l(e,"@"))e=R(ot(t,`--uk-breakpoint-${e.slice(1)}`))
...
const t=()=>{this.matchMedia=this.mediaObj.matches,Ze(this.$el,Ke("mediachange",!1,!0,[this.mediaObj]))}
this.offMediaObj=Ye(this.mediaObj,"change",()=>{t(),this.$emit("resize")}),t()}},disconnected(){var e
null==(e=this.offMediaObj)||e.call(this)}}
function yo(e){return we(e)?Math.ceil(Math.max(0,...It("[stroke]",e).map(e=>{var t
return(null==(t=e.getTotalLength)?void 0:t.call(e))||0}))):0}const wo={x:Eo,y:Eo,rotate:Eo,scale:Eo,color:Co,backgroundColor:Co,borderColor:Co,blur:ko,hue:ko,fopacity:ko,grayscale:ko,invert:ko,saturate:ko,sepia:ko,opacity:function(e,t,r){1===r.length&&r.unshift(Lo(t,e,""))
return r=Ao(r),(t,n)=>{t[e]=No(r,n)}},stroke:function(e,t,r){1===r.length&&r.unshift(0)
const n=Do(r),i=yo(t)
if(r=Ao(r.reverse(),e=>(e=R(e),"%"===n?e*i/100:e)),!r.some(([e])=>e))return U
return ot(t,"strokeDasharray",i),(e,t)=>{e.strokeDashoffset=No(r,t)}},bgx:Oo,bgy:Oo},{keys:_o}=Object
var xo={mixins:[bo],props:$o(_o(wo),"list"),data:$o(_o(wo),void 0),computed:{props(e,t){const r={}
for(const i in e)i in wo&&!S(e[i])&&(r[i]=e[i].slice())
const n={}
for(const i in r)n[i]=wo[i](i,t,r[i],r)
return n}},events:{load(){this.$emit()}},methods:{reset(){st(this.$el,this.getCss(0))},getCss(e){const t={}
for(const r in this.props)this.props[r](t,z(e))
...
return Do([e])?Yt(e,"width",t,!0)/t["offset"+((null==(r=e.endsWith)?void 0:r.call(e,"vh"))?"Height":"Width")]:R(e)}),1===r.length&&r.unshift("scale"===e?1:0),r=Ao(r,n),(t,n)=>{t.transform=`${t.transform||""} ${e}(${No(r,n)}${i})`}}function Co(e,t,r){return 1===r.length&&r.unshift(Lo(t,e,"")),r=Ao(r,e=>function(e,t){return Lo(e,"color",t).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(R)}(t,e)),(t,n)=>{const[i,o,s]=jo(r,n),a=i.map((e,t)=>(e+=s*(o[t]-e),3===t?R(e):parseInt(e,10))).join(",")
t[e]=`rgba(${a})`}}function ko(e,t,r){1===r.length&&r.unshift(0)
const n=Do(r)||{blur:"px",hue:"deg"}[e]||"%"
return e={fopacity:"opacity",hue:"hue-rotate"}[e]||e,r=Ao(r),(t,i)=>{const o=No(r,i)
t.filter=`${t.filter||""} ${e}(${o+n})`}}function Oo(e,t,r,n){1===r.length&&r.unshift(0)
const i="bgy"===e?"height":"width"
n[e]=Ao(r,e=>Yt(e,i,t))
const o=["bgx","bgy"].filter(e=>e in n)
if(2===o.length&&"bgx"===e)return U
if("cover"===Lo(t,"backgroundSize",""))return function(e,t,r,n){const i=function(e){const t=ot(e,"backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/,"$1")
if(Mo[t])return Mo[t]
const r=new Image
if(t&&(r.src=t,!r.naturalWidth&&!Po[t]))return Qe(r,"error load",()=>{Mo[t]=Ro(r),Ze(e,Ke("load",!1))}),Po[t]=!0,Ro(r)
return Mo[t]=Ro(r)}(t)
if(!i.width)return U
...
a[c]=(i?-s:0)-(i?t:r)+"px",o["bgy"===c?"height":"width"]+=s}const l=G.cover(i,o)
for(const c of s){const e="bgy"===c?"height":"width",r=l[e]-o[e]
a[c]=`max(${To(t,c)},-${r}px) + ${a[c]}`}const u=So(s,a,n)
return(e,t)=>{u(e,t),e.backgroundSize=`${l.width}px ${l.height}px`,e.backgroundRepeat="no-repeat"}}(0,t,0,n)
const s={}
for(const a of o)s[a]=To(t,a)
return So(o,s,n)}function To(e,t){return Lo(e,`background-position-${t.slice(-1)}`,"")}function So(e,t,r){return function(n,i){for(const o of e){const e=No(r[o],i)
n[`background-position-${o.slice(-1)}`]=`calc(${t[o]} + ${e}px)`}}}const Po={},Mo={}
function Ro(e){return{width:e.naturalWidth,height:e.naturalHeight}}function Ao(e,t=R){const r=[],{length:n}=e
let i=0
...
i=0}}return r}function jo(e,t){const r=d(e.slice(1),([,e])=>t<=e)+1
return[e[r-1][0],e[r][0],(t-e[r-1][1])/(e[r][1]-e[r-1][1])]}function No(e,t){const[r,n,i]=jo(e,t)
return r+(n-r)*i}const Io=/^-?\d+(?:\.\d+)?(\S+)?/
function Do(e,t){var r
for(const n of e){const e=null==(r=n.match)?void 0:r.call(n,Io)
if(e)return e[1]}return t}function Lo(e,t,r){const n=e.style[t],i=ot(ot(e,t,r),t)
return e.style[t]=n,i}function $o(e,t){return e.reduce((e,r)=>(e[r]=t,e),{})}function Fo(e,t){return t>=0?Math.pow(e,t+1):1-Math.pow(1-e,1-t)}var Bo={mixins:[xo],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target:({target:e},t)=>Ho(e&&je(e,t)||t),start({start:e}){return Yt(e,"height",this.target,!0)},end({end:e,viewport:t}){return Yt(e||(t=100*(1-t))&&`${t}vh+${t}%`,"height",this.target,!0)}},observe:[vn(),bn({target:({target:e})=>e}),pn({target:({$el:e,target:t})=>[e,t,Mr(t,!0)]})],update:{read({percent:e},t){if(t.has("scroll")||(e=!1),!we(this.$el))return!1
if(!this.matchMedia)return
const r=e
return{percent:e=Fo(Sr(this.target,this.start,this.end),this.easing),style:r!==e&&this.getCss(e)}},write({style:e}){this.matchMedia?e&&ot(this.$el,e):this.reset()},events:["scroll","resize"]}}
function Ho(e){return e?"offsetTop"in e?e:Ho(ke(e)):document.documentElement}var zo={props:{parallax:Boolean,parallaxTarget:Boolean,parallaxStart:String,parallaxEnd:String,parallaxEasing:Number},data:{parallax:!1,parallaxTarget:!1,parallaxStart:0,parallaxEnd:0,parallaxEasing:0},observe:[pn({target:({$el:e,parallaxTarget:t})=>[e,t],filter:({parallax:e})=>e}),bn({filter:({parallax:e})=>e})],computed:{parallaxTarget({parallaxTarget:e},t){return e&&je(e,t)||this.list}},update:{read(){if(!this.parallax)return!1
const e=this.parallaxTarget
if(!e)return!1
const t=Fo(Sr(e,Yt(this.parallaxStart,"height",e,!0),Yt(this.parallaxEnd,"height",e,!0)),this.parallaxEasing)
...
function i(r){ee(r,n)&&(s(r),a(r)),ee(r,t)||(Ze(r,"beforeitemshow",[e]),Ze(r,"itemshow",[e]))}function o(t){ee(t,r)&&Ze(t,"itemshown",[e])}function s(s){ee(s,t)||i(s),ee(s,r)&&o(s),ee(s,n)||(Ze(s,"beforeitemhide",[e]),Ze(s,"itemhide",[e]))}function a(t){ee(t,n)&&Ze(t,"itemhidden",[e])}}(this)
...
var Uo={update:{write(){if(this.stack.length||this.dragging||this.parallax)return
const e=this.getValidIndex()
~this.prevIndex&&this.index===e?this._translate(1):this.show(e)},events:["resize"]}},qo={observe:gn({target:({slides:e})=>e,targets:e=>e.getAdjacentSlides()}),methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}}
function Vo(e,t,r){const n=Go(e,t)
return r?n-function(e,t){return($t(t).width-$t(e).width)/2}(e,t):Math.min(n,Wo(t))}function Wo(e){return Math.max(0,Yo(e)-$t(e).width)}function Yo(e,t){return F(Pe(e).slice(0,t),e=>$t(e).width)}function Go(e,t){return e&&(Bt(e).left+(le?$t(e).width-$t(t).width:0))*(le?-1:1)||0}function Qo(e,t){t-=1
const r=$t(e).width,n=t+r+2
return Pe(e).filter(i=>{const o=Go(i,e),s=o+Math.min($t(i).width,r)
return o>=t&&s<=n})}var Zo={mixins:[en,ro,Uo,zo,qo],props:{center:Boolean,sets:Boolean,active:String},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",active:"all",Transitioner:function(e,t,r,{center:n,easing:i,list:o}){const s=e?Vo(e,o,n):Vo(t,o,n)+$t(t).width*r,a=t?Vo(t,o,n):s+$t(e).width*r*(le?-1:1),{promise:l,resolve:u}=xi()
return{dir:r,show(t,n=0,s){const c=s?"linear":i
return t-=Math.round(t*z(n,-1,1)),ot(o,"transitionProperty","none"),this.translate(n),ot(o,"transitionProperty",""),n=e?n:z(n,0,1),_i(this.getItemIn(),"itemin",{percent:n,duration:t,timing:c,dir:r}),e&&_i(this.getItemIn(!0),"itemout",{percent:1-n,duration:t,timing:c,dir:r}),ht.start(o,{transform:wi(-a*(le?-1:1),"px")},t,c).then(u,U),l},cancel:()=>ht.cancel(o),reset(){ot(o,"transform","")},async forward(e,t=this.percent()){return await this.cancel(),this.show(e,t,!0)},translate(n){if(n===this.percent())return
const i=this.getDistance()*r*(le?-1:1)
ot(o,"transform",wi(z(i-i*n-a,-Yo(o),$t(o).width)*(le?-1:1),"px"))
const s=this.getActives(),l=this.getItemIn(),u=this.getItemIn(!0)
n=e?z(n,-1,1):0
for(const a of Pe(o)){const i=c(s,a),d=a===l,h=a===u
_i(a,"itemtranslate"+(d||!h&&(i||r*(le?-1:1)==-1^Go(a,o)>Go(e||t))?"in":"out"),{dir:r,percent:h?1-n:d?n:i?1:0})}},percent:()=>Math.abs((new DOMMatrix(ot(o,"transform")).m41*(le?-1:1)+s)/(a-s)),getDistance:()=>Math.abs(a-s),getItemIn(r=!1){let i=this.getActives(),s=Qo(o,Vo(t||e,o,n))
if(r){const e=i
i=s,s=e}return s[d(s,e=>!c(i,e))]},getActives:()=>Qo(o,Vo(e||t,o,n))}}},computed:{finite({finite:e}){return e||function(e,t){if(!e||e.length<2)return!0
const{width:r}=$t(e)
if(!t)return Math.ceil(Yo(e))<Math.trunc(r+function(e){return Math.max(0,...Pe(e).map(e=>$t(e).width))}(e))
const n=Pe(e),i=Math.trunc(r/2)
for(const o in n){const e=n[o],t=$t(e).width,r=new Set([e])
let s=0
for(const a of[-1,1]){let e=t/2,l=0
for(;e<i;){const t=n[Q(+o+a+l++*a,n)]
if(r.has(t))return!0
e+=$t(t).width,r.add(t)}s=Math.max(s,(t+$t(n[Q(+o+a,n)]).width)/2-(e-i))}if(Math.trunc(s)>F(n.filter(e=>!r.has(e)),e=>$t(e).width))return!0}return!1}(this.list,this.center)},maxIndex(){if(!this.finite||this.center&&!this.sets)return this.length-1
if(this.center)return L(this.sets)
let e=0
const t=Wo(this.list),r=d(this.slides,r=>{if(e>=t-.005)return!0
e+=$t(r).width})
return~r?r:this.length-1},sets({sets:e}){if(!e||this.parallax)return
let t=0
const r=[],n=$t(this.list).width
for(let i=0;i<this.length;i++){const e=$t(this.slides[i]).width
t+e>n&&(t=0),this.center?t<n/2&&t+e+$t(this.slides[Q(i+1,this.slides)]).width/2>n/2&&(r.push(i),t=(n-e)/2):0===t&&r.push(Math.min(i,this.maxIndex)),t+=e}return r.length?r:void 0},transitionOptions(){return{center:this.center,list:this.list}},slides(){return Pe(this.list).filter(we)}},connected(){te(this.$el,this.clsContainer,!Nt(`.${this.clsContainer}`,this.$el))},observe:[pn({target:({list:e,$el:t})=>[t,...Pe(e)]}),fn({handler(e){for(const{target:t,isIntersecting:r}of e)t.ariaHidden=t.inert=!r},target:({list:e})=>Pe(e),args:{intersecting:!1},options:({$el:e})=>({root:e,rootMargin:"0px -10px"})})],update:{write(){for(const e of this.navItems){const t=M(se(e,this.attrItem))
...
return void e.preventDefault()}const r=this.dir<0||!this.slides[this.prevIndex]?this.index:this.prevIndex,n=Yo(this.list)/this.length
this.duration=no(n/this.velocity)*($t(this.slides[r]).width/n),this.reorder()},itemshow(){~this.prevIndex&&K(this._getTransitioner().getItemIn(),this.clsActive),this.updateActiveClasses(this.prevIndex)},itemshown(){this.updateActiveClasses()}},methods:{reorder(){if(this.finite)return void ot(this.slides,"order","")
const e=this.dir>0&&this.slides[this.prevIndex]?this.prevIndex:this.index
if(this.slides.forEach((t,r)=>ot(t,"order",this.dir>0&&r<e?1:this.dir<0&&r>=this.index?-1:"")),!this.center||!this.length)return
const t=this.slides[e]
let r=($t(this.list).width-$t(t).width)/2,n=0
for(;r>0;){const t=this.getIndex(--n+e,e),i=this.slides[t]
ot(i,"order",t>e?-2:-1),r-=$t(i).width}},updateActiveClasses(e=this.index){let t=this._getTransitioner(e).getActives()
"all"!==this.active&&(t=[this.slides[this.getValidIndex(e)]])
const r=[this.clsActive,!this.sets||c(this.sets,R(this.index))?this.clsActivated:""]
for(const n of this.slides)te(n,r,c(t,n))},getValidIndex(e=this.index,t=this.prevIndex){if(e=this.getIndex(e,t),!this.sets)return e
let r
do{if(c(this.sets,e))return e
r=e,e=this.getIndex(e+this.dir,t)}while(e!==r)
return e},getAdjacentSlides(){const{width:e}=$t(this.list),t=-e,r=2*e,n=$t(this.slides[this.index]).width,i=this.center?(e-n)/2:0,o=new Set
for(const s of[-1,1]){let e=i+(s>0?n:0),a=0
do{const t=this.slides[this.getIndex(this.index+s+a++*s)]
e+=$t(t).width*s,o.add(t)}while(this.length>a&&e>t&&e<r)}return Array.from(o)},getIndexAt(e){let t=-1
let r,n=e*(this.center?Yo(this.list)-($t(this.slides[0]).width+$t(L(this.slides)).width)/2:Yo(this.list,this.maxIndex))
do{const e=$t(this.slides[++t]).width,i=this.center?(e+$t(this.slides[t+1]).width)/2:e
r=n/i%1,n-=i}while(n>=0&&t<this.maxIndex)
return[t,r]}}}
var Ko={mixins:[xo],beforeConnect(){this.item=this.$el.closest(`.${this.$options.id.replace("parallax","items")} > *`)},disconnected(){this.item=null},events:[{name:"itemin itemout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,duration:r,timing:n,dir:i}}){er.read(()=>{if(!this.matchMedia)return
const o=this.getCss(Jo(e,i,t)),s=this.getCss(Xo(e)?.5:i>0?1:0)
er.write(()=>{ot(this.$el,o),ht.start(this.$el,s,r,n).catch(U)})})}},{name:"transitioncanceled transitionend",self:!0,el:({item:e})=>e,handler(){ht.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el:({item:e})=>e,handler({type:e,detail:{percent:t,dir:r}}){er.read(()=>{if(!this.matchMedia)return void this.reset()
const n=this.getCss(Jo(e,r,t))
er.write(()=>ot(this.$el,n))})}}]}
function Xo(e){return u(e,"in")}function Jo(e,t,r){return r/=2,Xo(e)^t<0?r:1-r}var es={mixins:[en,io,Uo,zo,qo],props:{ratio:String,minHeight:String,maxHeight:String},data:{ratio:"16:9",minHeight:void 0,maxHeight:void 0,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:oo},watch:{list(e){ot(e,{aspectRatio:this.ratio?this.ratio.replace(":","/"):void 0,minHeight:this.minHeight,maxHeight:this.maxHeight,width:"100%"})}},methods:{getAdjacentSlides(){return[1,-1].map(e=>this.slides[this.getIndex(this.index+e)])}}},ts={mixins:[en,In],props:{group:String,threshold:Number,clsItem:String,clsPlaceholder:String,clsDrag:String,clsDragState:String,clsBase:String,clsNoDrag:String,clsEmpty:String,clsCustom:String,handle:String},data:{group:!1,threshold:5,clsItem:"uk-sortable-item",clsPlaceholder:"uk-sortable-placeholder",clsDrag:"uk-sortable-drag",clsDragState:"uk-drag",clsBase:"uk-sortable",clsNoDrag:"uk-sortable-nodrag",clsEmpty:"uk-sortable-empty",clsCustom:"",handle:!1,pos:{}},events:{name:de,passive:!1,handler(e){this.init(e)}},computed:{target:(e,t)=>(t.tBodies||[t])[0],items(){return Pe(this.target)},isEmpty(){return!this.items.length},handles({handle:e},t){return e?It(e,t):this.items}},watch:{isEmpty(e){te(this.target,this.clsEmpty,e)},handles(e,t){const r={touchAction:"none",userSelect:"none"}
st(t,r),ot(e,r)}},update:{write(e){if(!this.drag||!ke(this.placeholder))return
const{pos:{x:t,y:r},origin:{offsetTop:n,offsetLeft:i},placeholder:o}=this
ot(this.drag,{top:r-n,left:t-i})
const s=this.getSortable(document.elementFromPoint(t,r))
if(!s)return
const{items:a}=s
if(a.some(ht.inProgress))return
const l=function(e,t){return e[d(e,e=>V(t,$t(e)))]}(a,{x:t,y:r})
if(a.length&&(!l||l===o))return
const u=this.getSortable(o),c=function(e,t,r,n,i){if(!Pe(e).length)return
const o=$t(t)
if(!i)return function(e,t){const r=1===Pe(e).length
r&&xt(e,t)
const n=Pe(e),i=n.some((e,t)=>{const r=$t(e)
return n.slice(t+1).some(e=>{const t=$t(e)
return!ns([r.left,r.right],[t.left,t.right])})})
r&&Ot(t)
return i}(e,r)||n.y<o.top+o.height/2?t:t.nextElementSibling
const s=$t(r),a=ns([o.top,o.bottom],[s.top,s.bottom]),[l,u,c,d]=a?[n.x,"width","left","right"]:[n.y,"height","top","bottom"],h=s[u]<o[u]?o[u]-s[u]:0
if(s[c]<o[c])return!(h&&l<o[c]+h)&&t.nextElementSibling
if(h&&l>o[d]-h)return!1
return t}(s.target,l,o,{x:t,y:r},s===u&&e.moved!==l)
...
!i||n||r>0||xe(t)||t.closest(`.${this.clsNoDrag}`)||this.handle&&!t.closest(this.handle)||(e.preventDefault(),this.pos=nt(e),this.touched=new Set([this]),this.placeholder=i,this.origin={target:t,index:Me(i),...this.pos},Ye(document,he,this.move),Ye(document,pe,this.end),this.threshold||this.start(e))},start(e){this.drag=function(e,t){let r
if(bt(t,"li","tr")){r=Nt("<div>"),xt(r,t.cloneNode(!0).children)
for(const e of t.getAttributeNames())ne(r,e,t.getAttribute(e))}else r=t.cloneNode(!0)
return xt(e,r),ot(r,"margin","0","important"),ot(r,{boxSizing:"border-box",width:t.offsetWidth,height:t.offsetHeight,padding:ot(t,"padding")}),zt(r.firstElementChild,zt(t.firstElementChild)),r}(this.$container,this.placeholder)
const{left:t,top:r}=$t(this.placeholder)
f(this.origin,{offsetLeft:this.pos.x-t,offsetTop:this.pos.y-r}),K(this.drag,this.clsDrag,this.clsCustom),K(this.placeholder,this.clsPlaceholder),K(this.items,this.clsItem),K(document.documentElement,this.clsDragState),Ze(this.$el,"start",[this,this.placeholder]),function(e){let t=Date.now()
rs=setInterval(()=>{let{x:r,y:n}=e
...
return function(...r){t||(t=!0,e.call(this,...r),requestAnimationFrame(()=>t=!1))}}(function(e){f(this.pos,nt(e)),!this.drag&&(Math.abs(this.pos.x-this.origin.x)>this.threshold||Math.abs(this.pos.y-this.origin.y)>this.threshold)&&this.start(e),this.$emit("move")}),end(){if(Ge(document,he,this.move),Ge(document,pe,this.end),!this.drag)return
clearInterval(rs)
const e=this.getSortable(this.placeholder)
this===e?this.origin.index!==Me(this.placeholder)&&Ze(this.$el,"moved",[this,this.placeholder]):(Ze(e.$el,"added",[e,this.placeholder]),Ze(this.$el,"removed",[this,this.placeholder])),Ze(this.$el,"stop",[this,this.placeholder]),Ot(this.drag),this.drag=null
for(const{clsPlaceholder:t,clsItem:r}of this.touched)for(const e of this.touched)X(e.items,t,r)
this.touched=null,X(document.documentElement,this.clsDragState)},insert(e,t){K(this.items,this.clsItem),t&&t.previousElementSibling!==e?this.animate(()=>Et(t,e)):t||this.target.lastElementChild===e||this.animate(()=>xt(this.target,e))},remove(e){this.target.contains(e)&&this.animate(()=>Ot(e))},getSortable(e){do{const t=this.$getComponent(e,"sortable")
if(t&&(t===this||!1!==this.group&&t.group===this.group))return t}while(e=ke(e))}}}
let rs
function ns(e,t){return e[1]>t[0]&&t[1]>e[0]}var is={props:{pos:String,offset:Boolean,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(le?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=c(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(e,t,r){let n=[this.getPositionOffset(e),this.getShiftOffset(e)]
const i=[this.flip&&"flip",this.shift&&"shift"],o={element:[this.inset?this.dir:Wt(this.dir),this.align],target:[this.dir,this.align]}
if("y"===this.axis){for(const e in o)o[e].reverse()
n.reverse(),i.reverse()}const s=os(e),a=$t(e)
ot(e,{top:-a.height,left:-a.width}),$r(e,t,{attach:o,offset:n,boundary:r,placement:i,viewportOffset:this.getViewportOffset(e)}),s()},getPositionOffset(e=this.$el){return Yt(!1===this.offset?ot(e,"--uk-position-offset"):this.offset,"x"===this.axis?"width":"height",e)*(c(["left","top"],this.dir)?-1:1)*(this.inset?-1:1)},getShiftOffset(e=this.$el){return"center"===this.align?0:Yt(ot(e,"--uk-position-shift-offset"),"y"===this.axis?"width":"height",e)*(c(["left","top"],this.align)?1:-1)},getViewportOffset:e=>Yt(ot(e,"--uk-position-viewport-offset"))}}
function os(e){const t=Mr(e),{scrollTop:r}=t
return()=>{r!==t.scrollTop&&(t.scrollTop=r)}}var ss={mixins:[si,ai,is],data:{pos:"top",animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},connected(){var e
Ce(e=this.$el)||(e.tabIndex=0)},disconnected(){this.hide()},methods:{show(){if(this.isToggled(this.tooltip||null))return
const{delay:e=0,title:t}=function(e){const{el:t,id:r,data:n}=e
return["delay","title"].reduce((e,r)=>({[r]:se(t,r),...e}),{...un(se(t,r),["title"]),...n})}(this.$options)
if(!t)return
const r=ne(this.$el,"title"),n=Ye(this.$el,["blur",me],e=>!rt(e)&&this.hide())
this.reset=()=>{ne(this.$el,{title:r,"aria-describedby":null}),n()}
const i=eo(this)
ne(this.$el,{title:null,"aria-describedby":i}),clearTimeout(this.showTimer),this.showTimer=setTimeout(()=>this._show(t,i),e)},async hide(){var e
Te(this.$el,"input:focus")||(clearTimeout(this.showTimer),this.isToggled(this.tooltip||null)&&await this.toggleElement(this.tooltip,!1,!1),null==(e=this.reset)||e.call(this),Ot(this.tooltip),this.tooltip=null)},async _show(e,t){this.tooltip=xt(this.container,`<div id="${t}" class="uk-${this.$options.name}" role="tooltip">  <div class="uk-${this.$options.name}-inner">${e}</div>  </div>`),Ye(this.tooltip,"toggled",(e,t)=>{if(!t)return
const r=()=>this.positionAt(this.tooltip,this.$el)
r()
const[n,i]=function(e,t,[r,n]){const i=Ft(e),o=Ft(t),s=[["left","right"],["top","bottom"]]
...
this.origin="y"===this.axis?`${Wt(n)}-${i}`:`${i}-${Wt(n)}`
const o=[Qe(document,`keydown ${de}`,this.hide,!1,e=>e.type===de&&!this.$el.contains(e.target)||"keydown"===e.type&&e.keyCode===Fn),Ye([document,...Rr(this.$el)],"scroll",r,{passive:!0})]
Qe(this.tooltip,"hide",()=>o.forEach(e=>e()),{self:!0})}),await this.toggleElement(this.tooltip,!0)||this.hide()}},events:{[`focus ${fe} ${de}`](e){rt(e)&&e.type!==de||"loading"===document.readyState||this.show()}}}
var as={mixins:[Ei],i18n:{invalidMime:"Invalid File Type: %s",invalidName:"Invalid File Name: %s",invalidSize:"Invalid File Size: %s Kilobytes Max"},props:{allow:String,clsDragover:String,concurrent:Number,maxSize:Number,method:String,mime:String,multiple:Boolean,name:String,params:Object,type:String,url:String},data:{allow:!1,clsDragover:"uk-dragover",concurrent:1,maxSize:0,method:"POST",mime:!1,multiple:!1,name:"files[]",params:{},type:"",url:"",abort:U,beforeAll:U,beforeSend:U,complete:U,completeAll:U,error:U,fail:U,load:U,loadEnd:U,loadStart:U,progress:U},events:{change(e){Te(e.target,'input[type="file"]')&&(e.preventDefault(),e.target.files&&this.upload(e.target.files),e.target.value="")},drop(e){us(e)
const t=e.dataTransfer;(null==t?void 0:t.files)&&(X(this.$el,this.clsDragover),this.upload(t.files))},dragenter(e){us(e)},dragover(e){us(e),K(this.$el,this.clsDragover)},dragleave(e){us(e),X(this.$el,this.clsDragover)}},methods:{async upload(e){if(!(e=p(e)).length)return
this.multiple||(e=e.slice(0,1)),Ze(this.$el,"upload",[e])
for(const n of e){if(this.maxSize&&1e3*this.maxSize<n.size)return void this.fail(this.t("invalidSize",this.maxSize))
if(this.allow&&!ls(this.allow,n.name))return void this.fail(this.t("invalidName",this.allow))
if(this.mime&&!ls(this.mime,n.type))return void this.fail(this.t("invalidMime",this.mime))}this.beforeAll(this,e)
...
try{const e=await async function(e,t){const r={url:e,data:null,method:"GET",headers:{},xhr:new XMLHttpRequest,beforeSend:U,responseType:"",...t}
if(!1===await r.beforeSend(r))throw cs(r.xhr)
return function(e,t){return new Promise((r,n)=>{const{xhr:i}=t
...
Ye(i,"load",()=>{0===i.status||i.status>=200&&i.status<300||304===i.status?r(i):n(f(Error(i.statusText),{xhr:i,status:i.status}))}),Ye(i,"error",()=>n(f(Error("Network Error"),{xhr:i}))),Ye(i,"timeout",()=>n(f(Error("Network Timeout"),{xhr:i}))),Ye(i,"abort",()=>n(cs(i))),i.send(t.data)})}(r.url,r)}(this.url,{data:n,method:this.method,responseType:this.type,beforeSend:e=>{const{xhr:t}=e
Ye(t.upload,"progress",this.progress)
for(const r of["loadStart","load","loadEnd","abort"])Ye(t,r.toLowerCase(),this[r])
return this.beforeSend(e)}})
this.complete(e),t.length?await r(t.shift()):this.completeAll(e)}catch(i){"AbortError"!==i.name&&this.error(i)}}
await r(t.shift())}}}
function ls(e,t){return t.match(new RegExp(`^${e.replace(/\//g,"\\/").replace(/\*\*/g,"(\\/[^\\/]+)*").replace(/\*/g,"[^\\/]+").replace(/((?!\\))\?/g,"$1.")}$`,"i"))}function us(e){e.preventDefault(),e.stopPropagation()}function cs(e){return f(Error("Network Abort"),{xhr:e,name:"AbortError"})}var ds=Object.freeze({__proto__:null,Countdown:rn,Filter:Yn,Lightbox:fo,LightboxPanel:lo,Notification:vo,Parallax:Bo,Slider:Zo,SliderParallax:Ko,Slideshow:es,SlideshowParallax:Ko,Sortable:ts,Tooltip:ss,Upload:as})
function hs(e){Ze(document,"uikit:init",e),document.body&&jt(document.body,fs),new MutationObserver(ps).observe(document,{subtree:!0,childList:!0,attributes:!0}),e._initialized=!0}function ps(e){var t
for(const{addedNodes:r,removedNodes:n,target:i,attributeName:o}of e){for(const t of r)jt(t,fs)
for(const t of n)jt(t,ms)
const e=o&&gs(o)
e&&(ie(i,o)?Gi(e,i):null==(t=Zi(i,e))||t.$destroy())}}function fs(e){const t=Qi(e)
for(const r in t)Bi(t[r])
for(const r of e.getAttributeNames()){const t=gs(r)
t&&Gi(t,e)}}function ms(e){const t=Qi(e)
for(const r in t)Hi(t[r])}function gs(e){l(e,"data-")&&(e=e.slice(5))
const t=Wi[e]
return t&&(t.options||t).name}(function(e){let t
e.component=Yi,e.getComponents=Qi,e.getComponent=Zi,e.update=Ki,e.use=function(e){if(!e.installed)return e.call(null,this),e.installed=!0,this},e.mixin=function(e,t){(t=(C(t)?this.component(t):t)||this).options=ln(t.options,e)},e.extend=function(e){e||(e={})
const t=this,r=function(e){Ui(this,e)}
return(r.prototype=Object.create(t.prototype)).constructor=r,r.options=ln(t.options,e),r.super=t,r.extend=t.extend,r},Object.defineProperty(e,"container",{get:()=>t||document.body,set(e){t=Nt(e)}})})(qi),function(e){e.prototype.$mount=function(e){const t=this;(function(e,t){e[Vi]||(e[Vi]={}),e[Vi][t.$options.name]=t})(e,t),t.$options.el=e,e.isConnected&&Bi(t)},e.prototype.$destroy=function(e=!1){const t=this,{el:r}=t.$options
r&&Hi(t),Fi(t,"destroy"),r&&(function(e,t){var r
null==(r=e[Vi])||delete r[t.$options.name],T(e[Vi])&&delete e[Vi]}(r,t),e&&Ot(r))},e.prototype.$create=Gi,e.prototype.$emit=function(e){hn(this,e)},e.prototype.$update=function(e=this.$el,t){Ki(e,t)},e.prototype.$reset=function(){Hi(this),Bi(this)},e.prototype.$getComponent=Zi,Object.defineProperties(e.prototype,{$el:{get(){return this.$options.el}},$container:Object.getOwnPropertyDescriptor(e,"container")})}(qi)
var vs={mixins:[en,ai],props:{animation:Boolean,targets:String,active:null,collapsible:Boolean,multiple:Boolean,toggle:String,content:String,offset:Number},data:{targets:"> *",active:!1,animation:!0,collapsible:!0,multiple:!1,clsOpen:"uk-open",toggle:".uk-accordion-title",content:".uk-accordion-content",offset:0},computed:{items:({targets:e},t)=>It(e,t),toggles({toggle:e}){return this.items.map(t=>Nt(e,t))},contents({content:e}){return this.items.map(t=>{var r
return(null==(r=t._wrapper)?void 0:r.firstElementChild)||Nt(e,t)})}},watch:{items(e,t){if(t||ee(e,this.clsOpen))return
const r=!1!==this.active&&e[Number(this.active)]||!this.collapsible&&e[0]
r&&this.toggle(r,!1)},toggles(){this.$emit()},contents(e){for(const t of e){const e=ee(this.items.find(e=>e.contains(t)),this.clsOpen)
bs(t,!e)}this.$emit()}},observe:gn(),events:[{name:"click keydown",delegate:({targets:e,$props:t})=>`${e} ${t.toggle}`,handler(e){if("keydown"===e.type&&e.keyCode!==Bn)return
const t=Me(this.toggles,e.current)
if(-1===t)return
Dn(e)
const r=function(e){const t=Mr(e,!0)
let r
return function n(){r=requestAnimationFrame(()=>{const{top:r}=$t(e)
r<0&&(t.scrollTop+=r),n()})}(),()=>requestAnimationFrame(()=>cancelAnimationFrame(r))}(e.target)
this.toggle(t).finally(r)}},{name:"show hide shown hidden",self:!0,delegate:({targets:e})=>e,handler(){this.$emit()}}],update(){const e=Oe(this.items,`.${this.clsOpen}`)
for(const t in this.items){const r=this.toggles[t],n=this.contents[t]
if(!r||!n)continue
r.id=eo(this,r),n.id=eo(this,n)
const i=c(e,this.items[t])
ne(r,{role:bt(r,"a")?"button":null,"aria-controls":n.id,"aria-expanded":i,"aria-disabled":!this.collapsible&&e.length<2&&i}),ne(n,{role:"region","aria-labelledby":r.id}),bt(n,"ul")&&ne(Pe(n),"role","presentation")}},methods:{toggle(e,t){let r=[e=this.items[Q(e,this.items)]]
const n=Oe(this.items,`.${this.clsOpen}`)
return this.multiple||c(n,r[0])||(r=r.concat(n)),!this.collapsible&&n.length<2&&c(n,e)&&(r=[]),Promise.all(r.map(e=>this.toggleElement(e,!c(n,e),(e,r)=>{if(te(e,this.clsOpen,r),!1!==t&&this.animation)return async function(e,t,{content:r,duration:n,velocity:i,transition:o}){var s
r=(null==(s=e._wrapper)?void 0:s.firstElementChild)||Nt(r,e),e._wrapper||(e._wrapper=Tt(r,"<div>"))
const a=e._wrapper
ot(a,"overflow","hidden")
const l=R(ot(a,"height"))
await ht.cancel(a),bs(r,!1)
const u=F(["marginTop","marginBottom"],e=>ot(r,e))+$t(r).height,c=l/u
n=u?(i*u+n)*(t?1-c:c):0,ot(a,"height",l),await ht.start(a,{height:t?u:0},n,o),Pt(r),delete e._wrapper,t||bs(r,!0)}(e,r,this)
bs(Nt(this.content,e),!r)})))}}}
function bs(e,t){e&&(e.hidden=t)}var ys={mixins:[en,ai],args:"animation",props:{animation:Boolean,close:String},data:{animation:!0,selClose:".uk-alert-close",duration:150},events:{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.close()}},methods:{async close(){await this.toggleElement(this.$el,!1,ws),this.$destroy(!0)}}}
function ws(e,t,{duration:r,transition:n,velocity:i}){const o=R(ot(e,"height"))
return ot(e,"height",o),ht.start(e,{height:0,marginTop:0,marginBottom:0,paddingTop:0,paddingBottom:0,borderTop:0,borderBottom:0,opacity:0},i*o+r,n)}var _s={args:"autoplay",props:{automute:Boolean,autoplay:Boolean,restart:Boolean,hoverTarget:Boolean},data:{automute:!1,autoplay:!0,restart:!1,hoverTarget:!1},beforeConnect(){const e=bt(this.$el,"video")
"inview"===this.autoplay&&e&&!ie(this.$el,"preload")&&(this.$el.preload="none"),e||ie(this.$el,"allow")||(this.$el.allow="autoplay"),"hover"===this.autoplay&&(e?this.$el.tabIndex=0:this.autoplay=!0),(this.automute||ie(this.$el,"muted"))&&vr(this.$el)},events:[{name:`${fe} focusin`,el:({hoverTarget:e,$el:t})=>je(e,t)||t,filter:({autoplay:e})=>"hover"===e,handler(e){var t
!rt(e)||((t=this.$el).paused||t.ended)?mr(this.$el):xs(this.$el,this.restart)}},{name:`${me} focusout`,el:({hoverTarget:e,$el:t})=>je(e,t)||t,filter:({autoplay:e})=>"hover"===e,handler(e){rt(e)||xs(this.$el,this.restart)}}],observe:[fn({filter:({$el:e})=>"none"===e.preload,handler([{target:e}]){e.preload="",this.$reset()}}),fn({filter:({$el:e,autoplay:t})=>"hover"!==t&&"none"!==e.preload,handler([{isIntersecting:e,target:t}]){document.fullscreenElement||(e?this.autoplay&&mr(t):xs(t,this.restart))},args:{intersecting:!1},options:({$el:e,autoplay:t})=>({root:"inview"===t?null:ke(e).closest(":not(a)")})})]}
function xs(e,t){gr(e),t&&bt(e,"video")&&(e.currentTime=0)}var Es={mixins:[_s],props:{width:Number,height:Number},data:{automute:!0},created(){this.useObjectFit=bt(this.$el,"img","video")},observe:pn({target:({$el:e})=>Cs(e)||ke(e),filter:({useObjectFit:e})=>!e}),update:{read(){if(this.useObjectFit)return!1
const{$el:e,width:t=e.clientWidth,height:r=e.clientHeight}=this,n=Cs(e)||ke(e),i=G.cover({width:t,height:r},{width:n.offsetWidth,height:n.offsetHeight})
return!(!i.width||!i.height)&&i},write({height:e,width:t}){ot(this.$el,{height:e,width:t})},events:["resize"]}}
function Cs(e){for(;e=ke(e);)if("static"!==ot(e,"position"))return e}let ks
var Os={mixins:[en,si,is,ai],args:"pos",props:{mode:"list",toggle:Boolean,boundary:Boolean,boundaryX:Boolean,boundaryY:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,stretch:Boolean,delayShow:Number,delayHide:Number,autoUpdate:Boolean,animateOut:Boolean,bgScroll:Boolean,closeOnScroll:Boolean},data:{mode:["click","hover"],toggle:"- *",boundary:!1,boundaryX:!1,boundaryY:!1,target:!1,targetX:!1,targetY:!1,stretch:!1,delayShow:0,delayHide:800,autoUpdate:!0,animateOut:!1,bgScroll:!0,animation:["uk-animation-fade"],cls:"uk-open",container:!1,closeOnScroll:!1,selClose:".uk-drop-close"},computed:{boundary:({boundary:e,boundaryX:t,boundaryY:r},n)=>[je(t||e,n)||window,je(r||e,n)||window],target({target:e,targetX:t,targetY:r},n){return t||(t=e||this.targetEl),r||(r=e||this.targetEl),[!0===t?window:je(t,n),!0===r?window:je(r,n)]}},created(){this.tracker=new lr},connected(){K(this.$el,"uk-drop"),this.toggle&&!this.targetEl&&(this.targetEl=function(e){const t=je(e.toggle,e.$el)
if(t){e.$create("toggle",t,{target:e.$el,mode:e.mode}),t.ariaHasPopup=!0
const r=e.$el
r.id||(r.id=eo(e,r)),ne(t,"aria-controls",r.id)}return t}(this)),ne(this.targetEl,"aria-expanded",!1),this._style=H(this.$el.style,["width","height"])},disconnected(){this.isActive()&&(this.hide(!1),ks=null),ot(this.$el,this._style)},events:[{name:"click",delegate:({selClose:e})=>e,handler(e){Dn(e),this.hide(!1)}},{name:"click",delegate:()=>'a[href*="#"]',handler({defaultPrevented:e,current:t}){const{hash:r}=t
!e&&r&&Re(t)&&!this.$el.contains(Nt(r))&&this.hide(!1)}},{name:"beforescroll",handler(){this.hide(!1)}},{name:"toggle",self:!0,handler(e,t){e.preventDefault(),this.isToggled()?this.hide(!1):this.show(null==t?void 0:t.$el,!1)}},{name:"toggleshow",self:!0,handler(e,t){e.preventDefault(),this.show(null==t?void 0:t.$el)}},{name:"togglehide",self:!0,handler(e){e.preventDefault(),Te(this.$el,":focus,:hover")||this.hide()}},{name:`${fe} focusin`,filter:({mode:e})=>c(e,"hover"),handler(e){rt(e)||this.clearTimers()}},{name:`${me} focusout`,filter:({mode:e})=>c(e,"hover"),handler(e){!rt(e)&&e.relatedTarget&&this.hide()}},{name:"toggled",self:!0,handler(e,t){t&&(this.clearTimers(),this.position())}},{name:"show",self:!0,handler(){ks=this,this.tracker.init(),ne(this.targetEl,"aria-expanded",!0)
const e=[Ts(this),Ps(this),Rs(this),this.autoUpdate&&Ss(this),this.closeOnScroll&&Ms(this)]
Qe(this.$el,"hide",()=>e.forEach(e=>e&&e()),{self:!0}),this.bgScroll||Qe(this.$el,"hidden",oi(this.$el),{self:!0})}},{name:"beforehide",self:!0,handler(){this.clearTimers()}},{name:"hide",handler({target:e}){this.$el===e?(ks=this.isActive()?null:ks,this.tracker.cancel(),ne(this.targetEl,"aria-expanded",!1)):ks=null===ks&&this.$el.contains(e)&&this.isToggled()?this:ks}}],update:{write(){this.isToggled()&&!ee(this.$el,this.clsEnter)&&this.position()}},methods:{show(e=this.targetEl,t=!0){if(this.isToggled()&&e&&this.targetEl&&e!==this.targetEl&&this.hide(!1,!1),this.targetEl=e,this.clearTimers(),!this.isActive()){if(ks){if(t&&ks.isDelaying())return void(this.showTimer=setTimeout(()=>Te(e,":hover")&&this.show(),10))
let r
for(;ks&&r!==ks&&!ks.$el.contains(this.$el);)r=ks,ks.hide(!1,!1)
t=!1}this.container&&ke(this.$el)!==this.container&&xt(this.container,this.$el),K(this.$el,this.clsEnter),this.showTimer=setTimeout(()=>this.toggleElement(this.$el,!0),t&&this.delayShow||0)}},hide(e=!0,t=!0){const r=()=>{X(this.$el,this.clsEnter),this.toggleElement(this.$el,!1,this.animateOut&&t)}
this.clearTimers(),this.isDelayedHide=e,e&&this.isDelaying()?this.hideTimer=setTimeout(this.hide,50):e&&this.delayHide?this.hideTimer=setTimeout(r,this.delayHide):r()},clearTimers(){clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.showTimer=null,this.hideTimer=null},isActive(){return ks===this},isDelaying(){return[this.$el,...It(".uk-drop",this.$el)].some(e=>this.tracker.movesTo(e))},position(){const e=os(this.$el)
X(this.$el,"uk-drop-stack"),ot(this.$el,this._style),this.$el.hidden=!0
...
for(const[o,[s,a]]of n)this.axis!==s&&c([s,!0],this.stretch)&&ot(this.$el,{[a]:Math.min(Ft(this.boundary[o])[a],t[o][a]-2*r),[`overflow-${s}`]:"auto"})
const i=t[0].width-2*r
this.$el.hidden=!1,ot(this.$el,"maxWidth",""),this.$el.offsetWidth>i&&K(this.$el,"uk-drop-stack"),ot(this.$el,"maxWidth",i),this.positionAt(this.$el,this.target,this.boundary)
for(const[o,[s,a,l,u]]of n)if(this.axis===s&&c([s,!0],this.stretch)){const e=Math.abs(this.getPositionOffset()),n=Ft(this.target[o]),i=Ft(this.$el)
ot(this.$el,{[a]:(n[l]>i[l]?n[this.inset?u:l]-Math.max(Ft(this.boundary[o])[l],t[o][l]+r):Math.min(Ft(this.boundary[o])[u],t[o][u]-r)-n[this.inset?l:u])-e,[`overflow-${s}`]:"auto"}),this.positionAt(this.$el,this.target,this.boundary)}e()}}}
function Ts(e){const t=()=>e.$emit(),r=[hr(t),dr(Rr(e.$el).concat(e.target),t)]
return()=>r.map(e=>e.disconnect())}function Ss(e,t=()=>e.$emit()){return Ye([document,...Rr(e.$el)],"scroll",t,{passive:!0})}function Ps(e){return Ye(document,"keydown",t=>{t.keyCode===Fn&&e.hide(!1)})}function Ms(e){return Ss(e,()=>e.hide(!1))}function Rs(e){return Ye(document,de,({target:t})=>{e.$el.contains(t)||Qe(document,`${pe} ${ge} scroll`,({defaultPrevented:r,type:n,target:i})=>{var o
r||n!==pe||t!==i||(null==(o=e.targetEl)?void 0:o.contains(t))||e.hide(!1)},!0)})}var As={mixins:[en,si],props:{align:String,boundary:Boolean,dropbar:Boolean,dropbarAnchor:Boolean,duration:Number,mode:Boolean,offset:Boolean,stretch:Boolean,delayShow:Boolean,delayHide:Boolean,target:Boolean,targetX:Boolean,targetY:Boolean,animation:Boolean,animateOut:Boolean,closeOnScroll:Boolean},data:{align:le?"right":"left",clsDrop:"uk-dropdown",clsDropbar:"uk-dropnav-dropbar",boundary:!0,dropbar:!1,dropbarAnchor:!1,flip:!0,delayShow:160,duration:200,container:!1,selNavItem:"> li > a, > ul > li > a"},computed:{dropbarAnchor:({dropbarAnchor:e},t)=>je(e,t)||t,dropbar({dropbar:e}){return e?(e=this._dropbar||je(e,this.$el)||Nt(`+ .${this.clsDropbar}`,this.$el))||(this._dropbar=Nt("<div>")):null},dropContainer(e,t){return this.container||t},dropdowns({clsDrop:e},t){var r
const n=It(`.${e}`,t)
if(this.dropContainer!==t)for(const i of It(`.${e}`,this.dropContainer)){const e=null==(r=this.getDropdown(i))?void 0:r.targetEl
!c(n,i)&&e&&this.$el.contains(e)&&n.push(i)}return n},items:({selNavItem:e},t)=>It(e,t)},watch:{dropbar(e){K(e,"uk-dropbar","uk-dropbar-top",this.clsDropbar,`uk-${this.$options.name}-dropbar`)},dropdowns(){this.initializeDropdowns()}},connected(){this.initializeDropdowns(),function(e){const t=()=>r.forEach(e=>e()),r=[Qe(e.ownerDocument,he,r=>e.contains(r.target)||t()),Ye(e,`mouseenter ${fe}`,e=>e.stopPropagation(),{capture:!0}),Ye(e,`mouseleave ${me}`,t,{capture:!0})]}(this.$el)},disconnected(){Ot(this._dropbar),delete this._dropbar},events:[{name:"mouseover focusin",delegate:({selNavItem:e})=>e,handler({current:e}){const t=this.getActive()
...
if(n===Wn)if((null==i?void 0:i.targetEl)===r)e.preventDefault(),null==(t=Nt(Ee,i.$el))||t.focus()
else{const t=this.dropdowns.find(e=>{var t
return(null==(t=this.getDropdown(e))?void 0:t.targetEl)===r})
t&&(e.preventDefault(),r.click(),Qe(t,"show",e=>{var t
return null==(t=Nt(Ee,e.target))?void 0:t.focus()}))}js(e,this.items,i)}},{name:"keydown",el:({dropContainer:e})=>e,delegate:({clsDrop:e})=>`.${e}`,handler(e){var t
const{current:r,keyCode:n,target:i}=e
if(xe(i)||!c(this.dropdowns,r))return
...
const t=It(Ee,r)
return void t[Q(s,t,d(t,e=>Te(e,":focus")))].focus()}js(e,this.items,o)}},{name:"mouseleave",el:({dropbar:e})=>e,filter:({dropbar:e})=>e,handler(){const e=this.getActive()
...
const t=this.getDropdown(e),r=()=>{const r=Math.max(...Se(e,`.${this.clsDrop}`).concat(e).map(e=>Ft(e).bottom))
Ft(this.dropbar,{left:Ft(this.dropbar).left,top:this.getDropbarOffset(t.getPositionOffset())}),this.transitionTo(r-Ft(this.dropbar).top+R(ot(e,"marginBottom")),e)}
this._observer=dr([t.$el,...t.target],r),r()}},{name:"beforehide",el:({dropContainer:e})=>e,filter:({dropbar:e})=>e,handler(e){const t=this.getActive()
Te(this.dropbar,":hover")&&t.$el===e.target&&this.isDropbarDrop(t.$el)&&c(t.mode,"hover")&&t.isDelayedHide&&!this.items.some(e=>t.targetEl!==e&&Te(e,":focus"))&&e.preventDefault()}},{name:"hide",el:({dropContainer:e})=>e,filter:({dropbar:e})=>e,handler({target:e}){var t
...
return c(this.dropdowns,null==(e=ks)?void 0:e.$el)&&ks},async transitionTo(e,t){const{dropbar:r}=this,n=zt(r)
if(t=n<e&&t,await ht.cancel([t,r]),t){const i=Ft(t).top-Ft(r).top-n
i>0&&ot(t,"transitionDelay",i/e*this.duration+"ms")}ot(t,"clipPath",`polygon(0 0,100% 0,100% ${n}px,0 ${n}px)`),zt(r,n),await Promise.all([ht.start(r,{height:e},this.duration),ht.start(t,{clipPath:`polygon(0 0,100% 0,100% ${e}px,0 ${e}px)`},this.duration).finally(()=>ot(t,{clipPath:"",transitionDelay:""}))]).catch(U)},getDropdown(e){return this.$getComponent(e,"drop")||this.$getComponent(e,"dropdown")},isDropbarDrop(e){return c(this.dropdowns,e)&&ee(e,this.clsDrop)},getDropbarOffset(e){const{$el:t,target:r,targetY:n}=this,{top:i,height:o}=Ft(je(n||r||t,t))
return i+o+e},initializeDropdowns(){this.$create("drop",this.dropdowns.filter(e=>!this.getDropdown(e)),{...this.$props,flip:this.flip&&!this.$props.dropbar,shift:!0,pos:`bottom-${this.align}`,boundary:!1,boundaryX:!0===this.boundary?this.$el:this.boundary})}}}
function js(e,t,r){var n,i,o
const{current:s,keyCode:a}=e
let l=-1
a===zn?l=0:a===Hn?l="last":a===Un?l="previous":a===Vn?l="next":a===Ln&&(null==(n=r.targetEl)||n.focus(),null==(i=r.hide)||i.call(r,!1)),~l&&(e.preventDefault(),null==(o=r.hide)||o.call(r,!1),t[Q(l,t,t.indexOf(r.targetEl||s))].focus())}var Ns={mixins:[en],args:"target",props:{target:Boolean},data:{target:!1},computed:{input:(e,t)=>Nt(_e,t),state(){return this.input.nextElementSibling},target({target:e},t){return e&&(!0===e&&ke(this.input)===t&&this.input.nextElementSibling||Nt(e,t))}},update(){var e
const{target:t,input:r}=this
if(!t)return
let n
const i=xe(t)?"value":"textContent",o=t[i],s=(null==(e=r.files)?void 0:e[0])?r.files[0].name:Te(r,"select")&&(n=It("option",r).filter(e=>e.selected)[0])?n.textContent:r.value
o!==s&&(t[i]=s)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el:({$el:e})=>e.closest("form"),handler(){this.$emit()}}]},Is={extends:_n,mixins:[en],name:"grid",props:{masonry:Boolean,parallax:String,parallaxStart:String,parallaxEnd:String,parallaxJustify:Boolean},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0,parallaxStart:0,parallaxEnd:0,parallaxJustify:!1},connected(){this.masonry&&K(this.$el,"uk-flex-top","uk-flex-wrap-top")},observe:bn({filter:({parallax:e,parallaxJustify:t})=>e||t}),update:[{write({rows:e}){te(this.$el,this.clsStack,!e.some(e=>e.length>1))},events:["resize"]},{read(e){const{rows:t}=e
let{masonry:r,parallax:n,parallaxJustify:i,margin:o}=this
if(n=Math.max(0,Yt(n)),!(r||n||i)||Ds(t)||t[0].some((e,r)=>t.some(t=>t[r]&&t[r].offsetWidth!==e.offsetWidth)))return e.translates=e.scrollColumns=!1
let s,a,l=function(e,t){const r=e.flat().find(e=>ee(e,t))
return R(r?ot(r,"marginTop"):ot(e[0][0],"paddingLeft"))}(t,o)
r?[s,a]=function(e,t,r){const n=[],i=[],o=Array(e[0].length).fill(0)
let s=0
for(let a of e){const e=le?a.slice().reverse():a
let l=0
for(const a in e){const{offsetWidth:u,offsetHeight:c}=e[a],d=r?a:o.indexOf(Math.min(...o))
Ls(n,d,e[a]),Ls(i,d,[(d-a)*u*(le?-1:1),o[d]-s]),o[d]+=c+t,l=Math.max(l,c)}s+=l+t}return[n,i]}(t,l,"next"===r):s=function(e){const t=[]
for(const r of e)for(const e in r)Ls(t,e,r[e])
return t}(t)
const u=s.map(e=>F(e,"offsetHeight")+l*(e.length-1)),c=Math.max(0,...u)
let d,h,p
return(n||i)&&(d=u.map((e,t)=>i?c-e+n:n/(t%2||8)),i||(n=Math.max(...u.map((e,t)=>e+d[t]-c))),h=Yt(this.parallaxStart,"height",this.$el,!0),p=Yt(this.parallaxEnd,"height",this.$el,!0)),{columns:s,translates:a,scrollColumns:d,parallaxStart:h,parallaxEnd:p,padding:n,height:a?c:""}},write({height:e,padding:t}){ot(this.$el,"paddingBottom",t||""),!1!==e&&ot(this.$el,"height",e)},events:["resize"]},{read({rows:e,scrollColumns:t,parallaxStart:r,parallaxEnd:n}){return{scrolled:!(!t||Ds(e))&&Sr(this.$el,r,n)}},write({columns:e,scrolled:t,scrollColumns:r,translates:n}){(t||n)&&e.forEach((e,i)=>e.forEach((e,o)=>{let[s,a]=n&&n[i][o]||[0,0]
t&&(a+=t*r[i]),ot(e,"transform",`translate(${s}px, ${a}px)`)}))},events:["scroll","resize"]}]}
function Ds(e){return e.flat().some(e=>"absolute"===ot(e,"position"))}function Ls(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}var $s={args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:({target:e},t)=>It(e,t)},observe:pn({target:({$el:e,elements:t})=>t.reduce((e,t)=>e.concat(t,...t.children),[e])}),events:{name:"loadingdone",el:()=>document.fonts,handler(){this.$emit("resize")}},update:{read(){return{rows:(this.row?xn(this.elements):[this.elements]).map(Fs)}},write({rows:e}){for(const{heights:t,elements:r}of e)r.forEach((e,r)=>ot(e,"minHeight",t[r]))},events:["resize"]}}
function Fs(e){if(e.length<2)return{heights:[""],elements:e}
let t=e.map(Bs)
const r=Math.max(...t)
return{heights:e.map((e,n)=>t[n].toFixed(2)===r.toFixed(2)?"":r),elements:e}}function Bs(e){const t=H(e.style,["display","minHeight"])
we(e)||ot(e,"display","block","important"),ot(e,"minHeight","")
const r=$t(e).height-Vt(e,"height","content-box")
return ot(e,t),r}var Hs={args:"target",props:{target:String},data:{target:""},computed:{target:{get:({target:e},t)=>je(e,t),observe:({target:e})=>e}},observe:pn({target:({target:e})=>e}),update:{read(){return!!this.target&&{height:this.target.offsetHeight}},write({height:e}){ot(this.$el,"minHeight",e)},events:["resize"]}},zs={mixins:[bo],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,min:Number,property:String},data:{expand:!1,offsetTop:!1,offsetBottom:!1,min:0,property:"min-height"},observe:[vn({filter:({expand:e})=>e}),pn({target:({$el:e})=>Pr(e)})],update:{read(){if(!we(this.$el))return!1
if(!this.matchMedia)return{minHeight:!1}
const e=Vt(this.$el,"height","content-box"),{body:t,scrollingElement:r}=document,n=Mr(this.$el),{height:i}=Ar(n===t?r:n),o=r===n||t===n
let s="calc("+(o?"100vh":`${i}px`)
if(this.expand){s+=` - ${$t(n).height-$t(this.$el).height}px`}else{if(this.offsetTop)if(o){const e=!0===this.offsetTop?this.$el:je(this.offsetTop,this.$el),{top:t}=Ft(e)
s+=t>0&&t<i/2?` - ${t}px`:""}else s+=` - ${Vt(n,"height",ot(n,"boxSizing"))}px`
!0===this.offsetBottom?s+=` - ${$t(this.$el.nextElementSibling).height}px`:O(this.offsetBottom)?s+=` - ${this.offsetBottom}vh`:this.offsetBottom&&u(this.offsetBottom,"px")?s+=` - ${R(this.offsetBottom)}px`:C(this.offsetBottom)&&(s+=` - ${$t(je(this.offsetBottom,this.$el)).height}px`)}return s+=(e?` - ${e}px`:"")+")",{minHeight:s}},write({minHeight:e}){ot(this.$el,this.property,!1===e?"":`max(${this.min||0}px, ${e})`)},events:["resize"]}},Us='<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',qs={args:"src",props:{width:Number,height:Number,ratio:Number},data:{ratio:1},connected(){this.svg=this.getSvg().then(e=>{if(!this._connected)return
const t=function(e,t){if(be(t)||bt(t,"canvas")){t.hidden=!0
const r=t.nextElementSibling
return Vs(e,r)?r:Ct(t,e)}const r=t.lastElementChild
return Vs(e,r)?r:xt(t,e)}(e,this.$el)
return this.svgEl&&t!==this.svgEl&&Ot(this.svgEl),Ws.call(this,t,e),this.svgEl=t},U)},disconnected(){this.svg.then(e=>{this._connected||(be(this.$el)&&(this.$el.hidden=!1),Ot(e),this.svgEl=null)}),this.svg=null},methods:{async getSvg(){}}}
function Vs(e,t){return bt(e,"svg")&&bt(t,"svg")&&e.innerHTML===t.innerHTML}function Ws(e,t){const r=["width","height"]
let n=r.map(e=>this[e])
n.some(e=>e)||(n=r.map(e=>ne(t,e)))
const i=ne(t,"viewBox")
i&&!n.some(e=>e)&&(n=i.split(" ").slice(2)),n.forEach((t,n)=>ne(e,r[n],R(t)*this.ratio||null))}function Ys(e,t){return t&&c(e,"<symbol")&&(e=Qs(e)[t]||e),j(Rt(e)).filter(_)[0]}const Gs=/<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,Qs=Z(function(e){const t={}
let r
for(;r=Gs.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t}),Zs={spinner:'<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',totop:'<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',marker:'<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',"accordion-icon":'<svg width="13" height="13" viewBox="0 0 13 13"><style>.uk-accordion-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-out;transition-property:transform, opacity;transform-origin:center}[aria-expanded=&quot;true&quot;] .uk-accordion-icon svg&gt;.line-1{transform:rotate(-45deg);opacity:0}[aria-expanded=&quot;true&quot;] .uk-accordion-icon svg&gt;.line-2{transform:rotate(90deg)}</style><rect width="13" height="1" fill="#000" x="0" y="6" class="line-1"/><rect width="1" height="13" fill="#000" x="6" y="0" class="line-2"/></svg>',"close-icon":'<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',"close-large":'<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',"drop-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"nav-parent-icon-large":'<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',"navbar-parent-icon":'<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',"navbar-toggle-icon":'<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-3{opacity:1}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-2,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-2{transform:rotate(45deg)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-3{transform:rotate(-45deg)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-4{opacity:0}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-1{transform:translateY(6px) scaleX(0)}[aria-expanded=&quot;true&quot;].uk-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.uk-navbar-toggle-icon svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',"overlay-icon":'<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',"pagination-next":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',"pagination-previous":'<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',"search-icon":Us,"search-medium":'<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',"search-large":'<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',"search-toggle-icon":Us,"slidenav-next":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',"slidenav-next-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',"slidenav-previous":'<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',"slidenav-previous-large":'<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>'},Ks={install:function(e){e.icon.add=(t,r)=>{const n=C(t)?{[t]:r}:t
$(n,(e,t)=>{Zs[t]=e,delete ca[t]}),e._initialized&&jt(document.body,t=>$(e.getComponents(t),e=>{e.$options.isIcon&&e.icon in n&&e.$reset()}))}},mixins:[qs],args:"icon",props:{icon:String},isIcon:!0,beforeConnect(){K(this.$el,"uk-icon")},async connected(){const e=await this.svg
e&&(e.ariaHidden=!0)},methods:{async getSvg(){const e=function(e){if(e=da[e]||e,!Zs[e])return null
ca[e]||(ca[e]=Ys(Zs[function(e){return le?D(D(e,"left","right"),"previous","next"):e}(e)]||Zs[e]))
return ca[e].cloneNode(!0)}(this.icon)
if(!e)throw"Icon not found."
return e}}},Xs={args:!1,extends:Ks,data:e=>({icon:i(e.constructor.options.name)}),beforeConnect(){K(this.$el,this.$options.id)}},Js={extends:Xs,beforeConnect(){const e=this.$props.icon
this.icon=this.$el.closest(".uk-nav-primary")?`${e}-large`:e}},ea={extends:Xs,mixins:[Ei],i18n:{toggle:"Open Search",submit:"Submit Search"},beforeConnect(){const e=ee(this.$el,"uk-search-toggle")||ee(this.$el,"uk-navbar-toggle")
if(this.icon=e?"search-toggle-icon":ee(this.$el,"uk-search-icon")&&this.$el.closest(".uk-search-large")?"search-large":this.$el.closest(".uk-search-medium")?"search-medium":this.$props.icon,!ie(this.$el,"aria-label"))if(e)this.$el.ariaLabel=this.t("toggle")
else{const e=this.$el.closest("a,button")
e&&(e.ariaLabel=this.t("submit"))}}},ta={extends:Xs,beforeConnect(){this.$el.role="status"},methods:{async getSvg(){const e=await Ks.methods.getSvg.call(this)
return 1!==this.ratio&&ot(Nt("circle",e),"strokeWidth",1/this.ratio),e}}},ra={extends:Xs,mixins:[Ei],beforeConnect(){const e=this.$el.closest("a,button")
ne(e,"role",null!==this.role&&bt(e,"a")?"button":this.role)
const t=this.t("label")
t&&!ie(e,"aria-label")&&ne(e,"aria-label",t)}},na={extends:ra,beforeConnect(){K(this.$el,"uk-slidenav")
const e=this.$props.icon
this.icon=ee(this.$el,"uk-slidenav-large")?`${e}-large`:e}},ia={extends:ra,i18n:{label:"Open menu"},beforeConnect(){const e=this.$el.closest("a,button")
e&&(e.ariaExpanded=!1)}},oa={extends:ra,i18n:{label:"Close"},beforeConnect(){this.icon="close-"+(ee(this.$el,"uk-close-large")?"large":"icon")}},sa={extends:ra,i18n:{label:"Open"}},aa={extends:ra,i18n:{label:"Back to top"}},la={extends:ra,i18n:{label:"Next page"},data:{role:null}},ua={extends:ra,i18n:{label:"Previous page"},data:{role:null}},ca={}
const da={twitter:"x"}
var ha={props:{target:String,selActive:String},data:{target:!1,selActive:!1},connected(){this.isIntersecting=0},computed:{target:({target:e},t)=>e?It(e,t):t},watch:{target:{handler(){queueMicrotask(()=>this.$reset())},immediate:!1}},observe:[fn({handler(e){this.isIntersecting=e.reduce((e,{isIntersecting:t})=>e+(t?1:this.isIntersecting?-1:0),this.isIntersecting),this.$emit()},target:({target:e})=>e,args:{intersecting:!1}}),mn({target:({target:e})=>e,options:{attributes:!0,attributeFilter:["class"]}}),{target:({target:e})=>e,observe:(e,t)=>{const r=dr([...j(e),document.documentElement],t),n=[Ye(document,"scroll itemshown itemhidden",t,{passive:!0,capture:!0}),Ye(document,"show hide transitionstart",e=>(t(),r.observe(e.target))),Ye(document,"shown hidden transitionend transitioncancel",e=>(t(),r.unobserve(e.target)))]
...
for(const e of j(this.target)){let t=!this.selActive||Te(e,this.selActive)?pa(e):""
!1!==t&&J(e,"uk-light uk-dark",t)}}}}
function pa(e){const t=$t(e),r=$t(window)
if(!q(t,r))return!1
...
for(const r of t){if(e.contains(r)||!fa(r)||r.closest('[class*="-leave"]')&&t.some(e=>r!==e&&Te(e,'[class*="-enter"]')))continue
const n=ot(r,"--uk-inverse")
if(n){if(n===a)return`uk-${n}`
a=n
break}}}return a?`uk-${a}`:""}function fa(e){if("visible"!==ot(e,"visibility"))return!1
for(;e;){if("0"===ot(e,"opacity"))return!1
e=ke(e)}return!0}var ma={mixins:[en,bo],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill:({fill:e},t)=>e||ot(t,"--uk-leader-fill-content")},connected(){[this.wrapper]=St(this.$el,`<span class="${this.clsWrapper}">`)},disconnected(){Pt(this.wrapper.childNodes)},observe:pn(),update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write({width:e,fill:t,hide:r}){te(this.wrapper,this.clsHide,r),ne(this.wrapper,this.attrFill,new Array(e).join(t))},events:["resize"]}},ga={install:function({modal:e}){function t(t,r,n=U,i=U){r={bgClose:!1,escClose:!0,...r,i18n:{...e.i18n,...null==r?void 0:r.i18n}}
const o=e.dialog(t(r),r)
return f(new Promise(e=>{const t=Ye(o.$el,"hide",()=>e(n()))
Ye(o.$el,"submit","form",r=>{r.preventDefault(),e(i(o)),t(),o.hide()})}),{dialog:o})}e.dialog=function(t,r){const n=e(Nt(`<div><div class="uk-modal-dialog">${t}</div></div>`),{stack:!0,role:"alertdialog",...r})
return n.show(),Ye(n.$el,"hidden",async()=>{await Promise.resolve(),n.$destroy(!0)},{self:!0}),n},e.alert=function(e,r){return t(({i18n:t})=>`<div class="uk-modal-body">${C(e)?e:wt(e)}</div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-primary uk-modal-close" type="button" autofocus>${t.ok}</button>  </div>`,r)},e.confirm=function(e,r){return t(({i18n:t})=>`<form>  <div class="uk-modal-body">${C(e)?e:wt(e)}</div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-default uk-modal-close" type="button">${t.cancel}</button>  <button class="uk-button uk-button-primary" autofocus>${t.ok}</button>  </div>  </form>`,r,()=>Promise.reject())},e.prompt=function(e,r,n){const i=t(({i18n:t})=>`<form class="uk-form-stacked">  <div class="uk-modal-body">  <label>${C(e)?e:wt(e)}</label>  <input class="uk-input" autofocus>  </div>  <div class="uk-modal-footer uk-text-right">  <button class="uk-button uk-button-default uk-modal-close" type="button">${t.cancel}</button>  <button class="uk-button uk-button-primary">${t.ok}</button>  </div>  </form>`,n,()=>null,()=>s.value),{$el:o}=i.dialog,s=Nt("input",o)
return s.value=r||"",Ye(o,"show",()=>s.select()),i},e.i18n={ok:"Ok",cancel:"Cancel"}},mixins:[hi],data:{clsPage:"uk-modal-page",selPanel:".uk-modal-dialog",selClose:'[class*="uk-modal-close"]'},events:[{name:"fullscreenchange webkitendfullscreen",capture:!0,handler(e){bt(e.target,"video")&&this.isToggled()&&!document.fullscreenElement&&this.hide()}},{name:"show",self:!0,handler(){ee(this.panel,"uk-margin-auto-vertical")?K(this.$el,"uk-flex"):ot(this.$el,"display","block"),zt(this.$el)}},{name:"hidden",self:!0,handler(){ot(this.$el,"display",""),X(this.$el,"uk-flex")}}]}
var va={extends:vs,data:{targets:"> .uk-parent",toggle:"> a",content:"> ul"}}
const ba="uk-navbar-transparent"
var ya={extends:As,props:{dropbarTransparentMode:Boolean},data:{flip:!1,autoUpdate:!1,delayShow:200,clsDrop:"uk-navbar-dropdown",selNavItem:".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle",dropbarTransparentMode:!1},computed:{navbarContainer:(e,t)=>t.closest(".uk-navbar-container")},watch:{items(){const e=ee(this.$el,"uk-navbar-justify"),t=It(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el)
for(const r of t){ot(r,"flexGrow",e?It(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle",r).length:"")}}},events:[{name:"show",el:({dropContainer:e})=>e,handler({target:e}){"remove"===this.getTransparentMode(e)&&ee(this.navbarContainer,ba)&&(X(this.navbarContainer,ba),this._transparent=!0)}},{name:"hide",el:({dropContainer:e})=>e,async handler(){await kn(),!this._transparent||ks&&this.dropContainer.contains(ks.$el)||(K(this.navbarContainer,ba),this._transparent=null)}}],methods:{getTransparentMode(e){if(!this.navbarContainer)return
if(this.dropbar&&this.isDropbarDrop(e))return this.dropbarTransparentMode
const t=this.getDropdown(e)
return t&&ee(e,"uk-dropbar")?t.inset?"behind":"remove":void 0},getDropbarOffset(e){const{top:t,height:r}=Ft(this.navbarContainer)
return t+("behind"===this.dropbarTransparentMode?0:r+e)}}},wa={mixins:[hi],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean,swiping:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1,swiping:!0},computed:{clsFlip:({flip:e,clsFlip:t})=>e?t:"",clsOverlay:({overlay:e,clsOverlay:t})=>e?t:"",clsMode:({mode:e,clsMode:t})=>`${t}-${e}`,clsSidebarAnimation:({mode:e,clsSidebarAnimation:t})=>"none"===e||"reveal"===e?"":t,clsContainerAnimation:({mode:e,clsContainerAnimation:t})=>"push"!==e&&"reveal"!==e?"":t,transitionElement({mode:e}){return"reveal"===e?ke(this.panel):this.panel}},observe:yn({filter:({swiping:e})=>e}),update:{read(){this.isToggled()&&!we(this.$el)&&this.hide()},events:["resize"]},events:[{name:"touchmove",self:!0,passive:!1,filter:({overlay:e})=>e,handler(e){e.cancelable&&e.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||ee(ke(this.panel),this.clsMode)||K(Tt(this.panel,"<div>"),this.clsMode)
const{body:e,scrollingElement:t}=document
K(e,this.clsContainer,this.clsFlip),ot(e,"touchAction","pan-y pinch-zoom"),ot(this.$el,"display","block"),ot(this.panel,"maxWidth",t.clientWidth),K(this.$el,this.clsOverlay),K(this.panel,this.clsSidebarAnimation,"reveal"===this.mode?"":this.clsMode),zt(e),K(e,this.clsContainerAnimation),this.clsContainerAnimation&&(_a().content+=",user-scalable=0")}},{name:"hide",self:!0,handler(){X(document.body,this.clsContainerAnimation),ot(document.body,"touchAction","")}},{name:"hidden",self:!0,handler(){this.clsContainerAnimation&&function(){const e=_a()
e.content=e.content.replace(/,user-scalable=0$/,"")}(),"reveal"===this.mode&&ee(ke(this.panel),this.clsMode)&&Pt(this.panel),X(this.panel,this.clsSidebarAnimation,this.clsMode),X(this.$el,this.clsOverlay),ot(this.$el,"display",""),ot(this.panel,"maxWidth",""),X(document.body,this.clsContainer,this.clsFlip)}},{name:"swipeLeft swipeRight",handler(e){this.isToggled()&&u(e.type,"Left")^this.flip&&this.hide()}}]}
function _a(){return Nt('meta[name="viewport"]',document.head)||xt(document.head,'<meta name="viewport">')}var xa={mixins:[en],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container:({selContainer:e},t)=>t.closest(e),content:({selContent:e},t)=>t.closest(e)},observe:pn({target:({container:e,content:t})=>[e,t]}),update:{read(){return!!(this.content&&this.container&&we(this.$el))&&{max:Math.max(this.minHeight,zt(this.container)-($t(this.content).height-zt(this.$el)))}},write({max:e}){ot(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},Ea={data:{threshold:5,fadeDuration:.05},events:[{name:"scroll",self:!0,passive:!0,handler(){this.$emit()}},{name:de,handler:function(e){const{target:t,button:r,defaultPrevented:n}=e
if(n||r>0||rt(e)||t.closest(_e)||xe(t))return
e.preventDefault()
const i={passive:!1,capture:!0},{$el:o,threshold:s,$options:a}=this
let l
const u=Ye(document,he,function(e){let t=nt(e),r=t,n=r
return function(e){n=r,r=nt(e)
const i=ee(o,`${a.id}-vertical`),u=i?"y":"x"
if(l||(l=Math.abs(r[u]-t[u])>s),l){const e=n[u]-r[u]
o[i?"scrollTop":"scrollLeft"]+=e}}}(e),i)
Ye(document,[pe,ge],function(){u(),l&&setTimeout(Ye(o,"click",e=>e.preventDefault(),i))},{capture:!0,once:!0})}}],observe:[mn({options:{subtree:!0,childList:!0}}),pn({target:({$el:e})=>[e,...Pe(e)]})],update:{read(){const e=[]
for(const t of["Width","Height"])e.push(this.$el[`scroll${t}`]-this.$el[`client${t}`])
return{overflow:e}},write({overflow:e}){for(let t=0;t<2;t++)if(te(this.$el,`${this.$options.id}-${t?"vertical":"horizontal"}`,e[t]&&!e[t-1]),!e[t-1]){const r=t?"Top":"Left",n=e[t]?this.$el[`scroll${r}`]/e[t]:0,i=r=>e[t]?z((this.fadeDuration-r)/this.fadeDuration):1
ot(this.$el,{"--uk-overflow-fade-start-opacity":i(n),"--uk-overflow-fade-end-opacity":i(1-n)})}},events:["resize"]}}
var Ca={props:["width","height"],connected(){K(this.$el,"uk-responsive-width"),ot(this.$el,"aspectRatio",`${this.width}/${this.height}`)}},ka={props:{offset:Number},data:{offset:0},connected(){(function(e){Oa.size||Ye(document,"click",Ta)
Oa.add(e)})(this)},disconnected(){var e
e=this,Oa.delete(e),Oa.size||Ge(document,"click",Ta)},methods:{async scrollTo(e){e=e&&Nt(e)||document.body,Ze(this.$el,"beforescroll",[this,e])&&(await Tr(e,{offset:this.offset}),Ze(this.$el,"scrolled",[this,e]))}}}
const Oa=new Set
function Ta(e){if(!e.defaultPrevented)for(const t of Oa)t.$el.contains(e.target)&&Re(t.$el)&&(e.preventDefault(),window.location.href!==t.$el.href&&window.history.pushState({},"",t.$el.href),t.scrollTo(Ae(t.$el)))}const Sa="uk-scrollspy-inview"
var Pa={args:"cls",props:{cls:String,target:String,hidden:Boolean,margin:String,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,margin:"-1px",repeat:!1,delay:0}),computed:{elements:({target:e},t)=>e?It(e,t):[t]},watch:{elements(e){this.hidden&&ot(Oe(e,`:not(.${Sa})`),"opacity",0)}},connected(){this.elementData=new Map},disconnected(){for(const[e,t]of this.elementData.entries())X(e,Sa,t.cls||"")
delete this.elementData},observe:fn({target:({elements:e})=>e,handler(e){const t=this.elementData
for(const{target:r,isIntersecting:n}of e){t.has(r)||t.set(r,{cls:se(r,"uk-scrollspy-class")||this.cls})
const e=t.get(r)
!this.repeat&&e.show||(e.show=n)}this.$emit()},options:({margin:e})=>({rootMargin:e}),args:{intersecting:!1}}),update:[{write(e){for(const[t,r]of this.elementData.entries())!r.show||r.inview||r.queued?!r.show&&r.inview&&!r.queued&&this.repeat&&this.toggle(t,!1):(r.queued=!0,e.promise=(e.promise||Promise.resolve()).then(async()=>{await kn(r.show?this.delay:0),this.toggle(t,!0),setTimeout(()=>{r.queued=!1,this.$emit()},300)}))}}],methods:{toggle(e,t){var r,n
const i=null==(r=this.elementData)?void 0:r.get(e)
if(!i)return
let o
if(null==(n=i.off)||n.call(i),ot(e,"opacity",!t&&this.hidden?0:""),te(e,Sa,t),te(e,i.cls),o=i.cls.match(/\buk-animation-[\w-]+/g)){const r=()=>X(e,o)
t?i.off=Qe(e,"animationcancel animationend",r,{self:!0}):r()}Ze(e,t?"inview":"outview"),i.inview=t}}},Ma={props:{cls:String,closest:Boolean,scroll:Boolean,target:String,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,target:'a[href]:not([role="button"])',offset:0},computed:{links:{get:({target:e},t)=>It(e,t).filter(Ae),observe:()=>"*"},targets(){return this.links.map(e=>Ae(e))},elements({closest:e}){return this.links.map(t=>t.closest(e||"*"))}},watch:{links(e){this.scroll&&this.$create("scroll",e,{offset:this.offset})}},observe:[fn(),bn()],update:[{read(){const{targets:e}=this,{length:t}=e
if(!t||!we(this.$el))return!1
const r=Mr(e,!0),{scrollTop:n,scrollHeight:i}=r,o=Ar(r)
let s=!1
if(n>=i-o.height)s=t-1
else{const t=this.offset+$t(jr()).height+.1*o.height
for(let r=0;r<e.length&&!(Ft(e[r]).top-o.top-t>0);r++)s=+r}return{active:s}},write({active:e}){const{elements:t}=this,r=!1!==e&&!ee(t[e],this.cls)
this.links.forEach(e=>e.blur())
for(let n=0;n<t.length;n++)te(t[n],this.cls,+n===e)
r&&Ze(this.$el,"active",[e,t[e]])},events:["scroll","resize"]}]},Ra={mixins:[en,bo],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,offsetEnd:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,offsetEnd:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{target:({selTarget:e},t)=>e&&Nt(e,t)||t},connected(){this.start=ja(this.start||this.top),this.end=ja(this.end||this.bottom),this.placeholder=Nt("+ .uk-sticky-placeholder",this.$el)||Nt('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},beforeDisconnect(){this.isFixed&&(this.hide(),X(this.target,this.clsInactive)),Na(this.$el),Ot(this.placeholder),this.placeholder=null},observe:[vn(),bn({target:()=>document.scrollingElement}),pn({target:({$el:e})=>[e,La(e),document.scrollingElement],handler(e){this.$emit(this._data.resized&&e.some(({target:e})=>e===La(this.$el))?"update":"resize"),this._data.resized=!0}})],events:[{name:"load hashchange popstate",el:()=>window,filter:({targetOffset:e})=>!1!==e,async handler(){const{scrollingElement:e}=document
if(!location.hash||0===e.scrollTop)return
await kn()
const t=Ft(Nt(location.hash)),r=Ft(this.$el)
this.isFixed&&q(t,r)&&(e.scrollTop=Math.ceil(t.top-r.height-Yt(this.targetOffset,"height",this.placeholder)-Yt(this.offset,"height",this.placeholder)))}}],update:[{read({height:e,width:t,margin:r,sticky:n},i){if(this.inactive=!this.matchMedia||!we(this.$el)||!this.$el.offsetHeight,this.inactive)return
const o=zt(window),s=Math.max(0,document.scrollingElement.scrollHeight-o)
if(!s)return void(this.inactive=!0)
const a=this.isFixed&&i.has("update")
a&&(Da(this.target),this.hide()),this.active||(({height:e,width:t}=$t(this.$el)),r=ot(this.$el,"margin")),a&&this.show()
const l=Yt("100vh","height")
let u=this.position
this.overflowFlip&&e>l&&(u="top"===u?"bottom":"top")
const c=this.isFixed?this.placeholder:this.$el
let[d,h]=[this.offset,this.offsetEnd].map(e=>Yt(e,"height",n?this.$el:c))
"bottom"===u&&(e<o||this.overflowFlip)&&(d+=o-e)
const p=e+d+h,f=this.overflowFlip?0:Math.max(0,p-l),m=Ft(c).top-new DOMMatrix(ot(c,"transform")).m42,g=$t(this.$el).height,v=(!1===this.start?m:Aa(this.start,this.$el,m))-d,b=!1===this.end?s:Math.min(s,Aa(this.end,this.$el,m+e,!0)-g-d+f)
return n=!this.showOnUp&&v+d===m&&b===Math.min(s,Aa(!0,this.$el,0,!0)-g-d+f)&&"hidden"!==ot(La(this.$el),"overflowY"),{start:v,end:b,offset:d,overflow:f,height:e,elHeight:g,width:t,margin:r,top:Ht(c)[0],sticky:n,viewport:l,maxScrollHeight:s}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&Na(this.$el),this.inactive)return
i&&(e=t=r=0,ot(this.$el,{position:"sticky",top:n}))
const{placeholder:o}=this
ot(o,{height:e,width:t,margin:r}),(ke(o)!==ke(this.$el)||i^Me(o)<Me(this.$el))&&((i?Et:Ct)(this.$el,o),o.hidden=!0)},events:["resize"]},{read({scroll:e=0,dir:t="down",overflow:r,overflowScroll:n=0,start:i,end:o,elHeight:s,height:a,sticky:l,maxScrollHeight:u}){const c=Math.min(document.scrollingElement.scrollTop,u),d=e<=c?"down":"up",h=this.isFixed?this.placeholder:this.$el
return{dir:d,prevDir:t,scroll:c,prevScroll:e,below:c>Ft(h).top+(l?Math.min(a,s):a),offsetParentTop:Ft(h.offsetParent).top,overflowScroll:z(n+z(c,i,o)-z(e,i,o),0,r)}},write(e,t){const r=t.has("scroll"),{initTimestamp:n=0,dir:i,prevDir:o,scroll:s,prevScroll:a=0,top:l,start:u,below:c}=e
if(s<0||s===a&&r||this.showOnUp&&!r&&!this.isFixed)return
const d=Date.now()
if((d-n>300||i!==o)&&(e.initScroll=s,e.initTimestamp=d),!(this.showOnUp&&!this.isFixed&&Math.abs(e.initScroll-s)<=30&&Math.abs(a-s)<=10))if(this.inactive||s<u||this.showOnUp&&(s<=u||"down"===i&&r||"up"===i&&!this.isFixed&&!c)){if(!this.isFixed)return void(vt.inProgress(this.$el)&&l>s&&(vt.cancel(this.$el),this.hide()))
if(this.animation&&c){if(ee(this.$el,"uk-animation-leave"))return
vt.out(this.$el,this.animation).then(()=>this.hide(),U)}else this.hide()}else this.isFixed?this.update():this.animation&&c?(this.show(),vt.in(this.$el,this.animation).catch(U)):(Da(this.target),this.show())},events:["resize","resizeViewport","scroll"]}],methods:{show(){this.isFixed=!0,this.update(),this.placeholder.hidden=!1},hide(){const{offset:e,sticky:t}=this._data
this.setActive(!1),X(this.$el,this.clsFixed,this.clsBelow),t?ot(this.$el,"top",e):Na(this.$el),this.placeholder.hidden=!0,this.isFixed=!1},update(){let{width:e,scroll:t=0,overflow:r,overflowScroll:n=0,start:i,end:o,offset:s,offsetParentTop:a,sticky:l,below:u}=this._data
const c=0!==i||t>i
if(!l){let i="fixed"
t>o&&(s+=o-a+n-r,i="absolute"),ot(this.$el,{position:i,width:e,marginTop:0},"important")}ot(this.$el,"top",s-n),this.setActive(c),te(this.$el,this.clsBelow,u),K(this.$el,this.clsFixed)},setActive(e){const t=this.active
this.active=e,e?(J(this.target,this.clsInactive,this.clsActive),t!==e&&Ze(this.$el,"active")):(J(this.target,this.clsActive,this.clsInactive),t!==e&&(Da(this.target),Ze(this.$el,"inactive")))}}}
function Aa(e,t,r,n){if(!e)return 0
if(O(e)||C(e)&&e.match(/^-?\d/))return r+Yt(e,"height",t,!0)
{const r=!0===e?La(t):je(e,t)
return Ft(r).bottom-(n&&(null==r?void 0:r.contains(t))?R(ot(r,"paddingBottom"))+R(ot(r,"borderBottomWidth")):0)}}function ja(e){return"true"===e||"false"!==e&&e}function Na(e){ot(e,{position:"",top:"",marginTop:"",width:""})}const Ia="uk-transition-disable"
async function Da(e){ee(e,Ia)||(K(e,Ia),await Cn(),X(e,Ia))}function La(e){for(;e=ke(e);)if(we(e))return e}var $a={mixins:[qs],args:"src",props:{src:String,icon:String,attributes:"list",strokeAnimation:Boolean},data:{strokeAnimation:!1},observe:[mn({async handler(){const e=await this.svg
e&&Fa.call(this,e)},options:{attributes:!0,attributeFilter:["id","class","style"]}})],async connected(){c(this.src,"#")&&([this.src,this.icon]=this.src.split("#",2))
const e=await this.svg
e&&(Fa.call(this,e),this.strokeAnimation&&function(e){const t=yo(e)
t&&ot(e,"--uk-animation-stroke",t)}(e))},methods:{async getSvg(){return bt(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading&&await new Promise(e=>Qe(this.$el,"load",e)),Ys(await Ba(this.src),this.icon)||Promise.reject("SVG not found.")}}}
function Fa(e){const{$el:t}=this
K(e,ne(t,"class"),"uk-svg")
for(let r=0;r<t.style.length;r++){const n=t.style[r]
ot(e,n,ot(t,n))}for(const r in this.attributes){const[t,n]=this.attributes[r].split(":",2)
ne(e,t,n)}e.ariaHidden=this.$el.ariaHidden,this.$el.id||oe(e,"id")}const Ba=Z(async e=>{if(e){const t=await fetch(e)
if("image/svg+xml"===t.headers.get("Content-Type"))return t.text()}return Promise.reject()})
const Ha=".uk-disabled *, .uk-disabled, [disabled]"
var za={mixins:[ai],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number,followFocus:Boolean,swiping:Boolean},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item",selVertical:".uk-nav",followFocus:!1,swiping:!0},computed:{connects:{get:({connect:e},t)=>Ne(e,t),observe:({connect:e})=>e},connectChildren(){return this.connects.map(e=>Pe(e)).flat()},toggles:({toggle:e},t)=>It(e,t),children(e,t){return Pe(t).filter(e=>this.toggles.some(t=>e.contains(t)))}},watch:{connects(e){this.swiping&&ot(e,"touchAction","pan-y pinch-zoom"),this.$emit()},connectChildren(){let e=Math.max(0,this.index())
for(const t of this.connects)Pe(t).forEach((t,r)=>te(t,this.cls,r===e))
this.$emit()},toggles(){this.$emit()
const e=this.index()
this.show(~e?e:this.next(this.active))}},connected(){this.$el.role="tablist"},observe:[gn({targets:({connectChildren:e})=>e}),yn({target:({connects:e})=>e,filter:({swiping:e})=>e})],events:[{name:"click keydown",delegate:({toggle:e})=>e,handler(e){Te(e.current,Ha)||"click"!==e.type&&e.keyCode!==Bn||(Dn(e),this.show(e.current))}},{name:"keydown",delegate:({toggle:e})=>e,handler(e){const{current:t,keyCode:r}=e,n=Te(this.$el,this.selVertical)
let i=r===zn?0:r===Hn?"last":r===Un&&!n||r===qn&&n?"previous":r===Vn&&!n||r===Wn&&n?"next":-1
if(~i){e.preventDefault()
const r=this.toggles[this.next(i,this.toggles.indexOf(t))]
r.focus(),this.followFocus&&this.show(r)}}},{name:"click",el:({$el:e,connects:t,itemNav:r})=>t.concat(r?Ne(r,e):[]),delegate:({attrItem:e})=>`[${e}],[data-${e}]`,handler(e){e.target.closest("a,button")&&(Dn(e),this.show(se(e.current,this.attrItem)))}},{name:"swipeRight swipeLeft",filter:({swiping:e})=>e,el:({connects:e})=>e,handler({type:e}){this.show(u(e,"Left")?"next":"previous")}}],update(){var e
for(const t of this.connects)bt(t,"ul")&&(t.role="presentation")
ne(Pe(this.$el),"role","presentation")
for(const t in this.toggles){const r=this.toggles[t],n=null==(e=this.connects[0])?void 0:e.children[t]
r.role="tab",n&&(r.id=eo(this,r),n.id=eo(this,n),ne(r,"aria-controls",n.id),ne(n,{role:"tabpanel","aria-labelledby":r.id}))}ne(this.$el,"aria-orientation",Te(this.$el,this.selVertical)?"vertical":null)},methods:{index(){return d(this.children,e=>ee(e,this.cls))},next(e,t=this.index()){if(O(e))for(let n=0;n<this.toggles.length;n++){let t=Q(n+ +e,this.toggles)
if(!Te(this.toggles[t],Ha))return t}const r=this.toggles.filter(e=>!Te(e,Ha))
return Q(r[Q(e,r,r.indexOf(this.toggles[t]))],this.toggles)},show(e){const t=this.index(),r=this.next(e)
this.children.forEach((e,t)=>{te(e,this.cls,r===t),ne(this.toggles[t],{"aria-selected":r===t,tabindex:r===t?null:-1})})
const n=t>=0&&t!==r
this.connects.forEach(async({children:e})=>{const t=p(e).filter((e,t)=>t!==r&&ee(e,this.cls))
await this.toggleElement(t,!1,n)&&await this.toggleElement(e[r],!0,n)})}}},Ua={mixins:[en],extends:za,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item",selVertical:".uk-tab-left,.uk-tab-right"},connected(){const e=ee(this.$el,"uk-tab-left")?"uk-tab-left":!!ee(this.$el,"uk-tab-right")&&"uk-tab-right"
e&&this.$create("toggle",this.$el,{cls:e,mode:"media",media:this.media})}},qa={mixins:[bo,ai],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get:({target:e},t)=>(e=Ne(e||t.hash,t)).length?e:[t],observe:({target:e})=>e}},connected(){c(this.mode,"media")||(Ce(this.$el)||(this.$el.tabIndex=0),!this.cls&&bt(this.$el,"a")&&(this.$el.role="button"))},observe:gn({targets:({target:e})=>e}),events:[{name:de,filter:({mode:e})=>c(e,"hover"),handler(e){this._preventClick=null,!rt(e)||E(this._showState)||this.$el.disabled||(Ze(this.$el,"focus"),Qe(document,de,()=>Ze(this.$el,"blur"),!0,e=>!this.$el.contains(e.target)),c(this.mode,"click")&&(this._preventClick=!0))}},{name:`${fe} ${me} focus blur`,filter:({mode:e})=>c(e,"hover"),handler(e){if(rt(e)||this.$el.disabled||"loading"===document.readyState)return
const t=c([fe,"focus"],e.type),r=this.isToggled(this.target)
t||!(!E(this._showState)||e.type===me&&Te(this.$el,":focus")||"blur"===e.type&&Te(this.$el,":hover"))?t&&E(this._showState)&&r!==this._showState||(this._showState=t?r:null,this.toggle("toggle"+(t?"show":"hide"))):r===this._showState&&(this._showState=null)}},{name:"keydown",filter:({$el:e,mode:t})=>c(t,"click")&&!bt(e,"input"),handler(e){e.keyCode!==Bn&&e.keyCode!==$n||(e.preventDefault(),this.$el.click())}},{name:"click",filter:({mode:e})=>["click","hover"].some(t=>c(e,t)),handler(e){if(e.defaultPrevented)return
const t=e.target.closest("a[href]"),r=Re(t)&&(!t.hash||Te(this.target,t.hash));(this._preventClick||r||t&&!this.isToggled(this.target))&&e.preventDefault(),this._preventClick||!c(this.mode,"click")||t&&!r&&!e.defaultPrevented||this.toggle()}},{name:"mediachange",filter:({mode:e})=>c(e,"media"),el:({target:e})=>e,handler(e,t){t.matches^this.isToggled(this.target)&&this.toggle()}}],methods:{async toggle(e){if(!Ze(this.target,e||"toggle",[this]))return
if(ie(this.$el,"aria-expanded")&&(this.$el.ariaExpanded=!this.isToggled(this.target)),!this.queued)return this.toggleElement(this.target)
const t=this.target.filter(e=>ee(e,this.clsLeave))
...
return $(Object.freeze({__proto__:null,Accordion:vs,AccordionIcon:Xs,Alert:ys,Close:oa,Cover:Es,Drop:Os,DropParentIcon:Xs,Dropdown:Os,Dropnav:As,FormCustom:Ns,Grid:Is,HeightMatch:$s,HeightPlaceholder:Hs,HeightViewport:zs,Icon:Ks,Img:Xn,Inverse:ha,Leader:ma,Margin:_n,Marker:sa,Modal:ga,Nav:va,NavParentIcon:Js,Navbar:ya,NavbarParentIcon:Xs,NavbarToggleIcon:ia,Offcanvas:wa,OverflowAuto:xa,OverflowFade:Ea,OverlayIcon:Xs,PaginationNext:la,PaginationPrevious:ua,Responsive:Ca,Scroll:ka,Scrollspy:Pa,ScrollspyNav:Ma,SearchIcon:ea,SlidenavNext:na,SlidenavPrevious:na,Spinner:ta,Sticky:Ra,Svg:$a,Switcher:za,Tab:Ua,Toggle:qa,Totop:aa,Video:_s}),(e,t)=>qi.component(t,e)),function(e){ae&&window.MutationObserver&&(document.body?requestAnimationFrame(()=>hs(e)):new MutationObserver((t,r)=>{document.body&&(hs(e),r.disconnect())}).observe(document.documentElement,{childList:!0}))}(qi),$(ds,(e,t)=>qi.component(t,e)),qi}),/*! UIkit 3.25.21 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */
