/*! For license information please see chunk.582.d372ab43fb672d3cf20b.js.LICENSE.txt */
...
e.setAttribute("role","gridcell"),t.appendChild(e)}e.appendChild(t)}t&&(t.innerHTML="",t.appendChild(e))}}return i.$name=e.CROPPER_GIRD,i.$version="2.1.1",i}(n(670),n(771))},98(t,e,n){t.exports=function(t,e){"use strict"
var n=function(t){return t&&"object"==typeof t&&"default"in t?t:{default:t}}(t)
class i extends n.default{constructor(){super(...arguments),this.$onCanvasCropEnd=null,this.$onCanvasCropStart=null,this.$style=':host{background-color:var(--theme-color);display:block}:host([action=move]),:host([action=select]){height:100%;left:0;position:absolute;top:0;width:100%}:host([action=move]){cursor:move}:host([action=select]){cursor:crosshair}:host([action$=-resize]){background-color:transparent;height:15px;position:absolute;width:15px}:host([action$=-resize]):after{background-color:var(--theme-color);content:"";display:block;height:5px;left:50%;position:absolute;top:50%;transform:translate(-50%,-50%);width:5px}:host([action=n-resize]),:host([action=s-resize]){cursor:ns-resize;left:50%;transform:translateX(-50%);width:100%}:host([action=n-resize]){top:-8px}:host([action=s-resize]){bottom:-8px}:host([action=e-resize]),:host([action=w-resize]){cursor:ew-resize;height:100%;top:50%;transform:translateY(-50%)}:host([action=e-resize]){right:-8px}:host([action=w-resize]){left:-8px}:host([action=ne-resize]){cursor:nesw-resize;right:-8px;top:-8px}:host([action=nw-resize]){cursor:nwse-resize;left:-8px;top:-8px}:host([action=se-resize]){bottom:-8px;cursor:nwse-resize;right:-8px}:host([action=se-resize]):after{height:15px;width:15px}@media (pointer:coarse){:host([action=se-resize]):after{height:10px;width:10px}}@media (pointer:fine){:host([action=se-resize]):after{height:5px;width:5px}}:host([action=sw-resize]){bottom:-8px;cursor:nesw-resize;left:-8px}:host([plain]){background-color:transparent}',this.action=e.ACTION_NONE,this.plain=!1,this.slottable=!1,this.themeColor="rgba(51, 153, 255, 0.5)"}static get observedAttributes(){return super.observedAttributes.concat(["action","plain"])}}return i.$name=e.CROPPER_HANDLE,i.$version="2.1.1",i}(n(670),n(771))},630(t,e,n){t.exports=function(t,e){"use strict"
var n=function(t){return t&&"object"==typeof t&&"default"in t?t:{default:t}}(t)
...
this.$matrix=l,this.style.transform=`matrix(${l.join(", ")})`}return this}$getTransform(){return this.$matrix.slice()}$resetTransform(){return this.$setTransform([1,0,0,1,0,0])}}return o.$name=e.CROPPER_IMAGE,o.$version="2.1.1",o}(n(670),n(771))},636(t,e,n){t.exports=function(t,e){"use strict"
var n=function(t){return t&&"object"==typeof t&&"default"in t?t:{default:t}}(t)
const i=new WeakMap
...
t&&(this.$onWindowResize&&(e.off(window,e.EVENT_RESIZE,this.$onWindowResize),this.$onWindowResize=null),this.$onCanvasActionStart&&(e.off(t,e.EVENT_ACTION_START,this.$onCanvasActionStart),this.$onCanvasActionStart=null),this.$onCanvasActionEnd&&(e.off(t,e.EVENT_ACTION_END,this.$onCanvasActionEnd),this.$onCanvasActionEnd=null),this.$onSelectionChange&&(e.off(t,e.EVENT_CHANGE,this.$onSelectionChange),this.$onSelectionChange=null)),super.disconnectedCallback()}$change(t,n,i=this.width,r=this.height){return e.isNumber(t)&&e.isNumber(n)&&e.isNumber(i)&&e.isNumber(r)&&(t!==this.x||n!==this.y||i!==this.width||r!==this.height)?(this.hidden&&(this.hidden=!1),this.x=t,this.y=n,this.width=i,this.height=r,this.$render()):this}$reset(){return this.$change(0,0,0,0)}$render(){return this.$setStyles({transform:`translate(${this.x}px, ${this.y}px)`,width:this.width,height:this.height,outlineWidth:e.WINDOW.innerWidth*e.WINDOW.devicePixelRatio})}}return r.$name=e.CROPPER_SHADE,r.$version="2.1.1",r}(n(670),n(771))},154(t,e,n){!function(t,e,n){"use strict"
...
e&&(null===(t=e.parentElement)||void 0===t||t.removeChild(e)),this.element&&(this.element.style.display="")}}a.version="2.1.1",t.DEFAULT_TEMPLATE=i,t.default=a,Object.keys(e).forEach(function(n){"default"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),Object.keys(n).forEach(function(e){"default"===e||t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,get:function(){return n[e]}})}),Object.defineProperty(t,"__esModule",{value:!0})}(e,n(771),n(558))},977(t,e,n){"use strict"
