        ...
        "1": {
            "addressFields": [{
              ...
              },
              {
                  "id": "PhoneMobile",
                  "dataType": "telephone",
                  "options": { "autocomplete": "tel-national" }
              },
              {
                  "id": "Birthdate",
                  "dataType": "date",
              ...
              },
              {
                  "id": "Nationality",
                  "dataType": "dropdown",
                  "options": { "dropdownItems": "Nationalities", "required": true }
              },
              {
                  "id": "StayPermit",
                  "dataType": "dropdown",
                  "options": { "dropdownItems": "StayPermits", "required": false }
              },
              {
                "id": "StayPermitExpiry",
                "dataType": "date",
              ...
              },
              {
                  "id": "NativeLanguage",
                  "dataType": "dropdown",
                  "options": { "dropdownItems": "NativeLanguages", "required": true }
              }
          ]
        },
