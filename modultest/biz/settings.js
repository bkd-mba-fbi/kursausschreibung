...
window.kursausschreibung.settings = {
    ...
    "badgeFreeSeats": {
        "enabled": true,
        "intervalSec": 10,
        "subscriptionYellowDisable": true
    },
    ...
    "logoImage": null, // "assets/images/berufsberatung.png",

    // URL to which the logo should link (optional)
    "logoLink": null, //"https://www.berufsberatung.ch/",
    ...
    //if in event designation this sign. Module will add event subtitle as uk-label-warning
    "eventSubtitle": ">"
};