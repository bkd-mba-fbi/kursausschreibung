...
window.kursausschreibung.appConfig = {
    ...
    "webBaseUrl": "https://bkd-mba-fbi.github.io/kursausschreibung/modultest/fbi",
...
//Check lifecycle api works
var data = null;
var apiEvents = window.kursausschreibung.appConfig.apiUrl;
var xhr = new XMLHttpRequest();

xhr.onreadystatechange = function() {
    if (this.readyState === 4 && this.status === 404) {
        console.log(this.status);
        window.kursausschreibung.appConfig.oauthUrl = 'https://eventoapp-test.erz.be.ch/OAuth';
        window.kursausschreibung.appConfig.apiUrl = 'https://eventoapp-test.erz.be.ch/restApi';
    }
};

xhr.open('GET', apiEvents + '/events/');
xhr.send(data);